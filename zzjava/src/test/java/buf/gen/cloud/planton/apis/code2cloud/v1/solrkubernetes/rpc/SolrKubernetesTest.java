package buf.gen.cloud.planton.apis.code2cloud.v1.solrkubernetes.rpc;

import build.buf.gen.cloud.planton.apis.code2cloud.v1.solrkubernetes.model.SolrKubernetes;
...
public final class SolrKubernetesTest {
    ...
    public void testSolrKubernetes_ShouldReturnValidationErrorIfMetadataIsNotPassed() throws ValidationException {
        var solrCloud = SolrKubernetes.newBuilder().build();
        Validator validator = new Validator();
    ...
    public void testSolrKubernetes_ShouldReturnValidationErrorIfVersionMessageIsNotPassed() throws ValidationException {
        var solrCloud = SolrKubernetes.newBuilder().setMetadata(ApiResourceMetadata.newBuilder().build()).build();
        Validator validator = new Validator();
        var result = validator.validate(solrCloud);
        var versionMessageViolation = result.getViolations().stream()
    ...
    public void testSolrKubernetes_ShouldNotReturnValidationErrorIfVersionMessageIsPassed() throws ValidationException {
        var solrCloud= SolrKubernetes.newBuilder()
