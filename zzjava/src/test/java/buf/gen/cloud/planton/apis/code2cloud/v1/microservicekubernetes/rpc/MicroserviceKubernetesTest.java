package buf.gen.cloud.planton.apis.code2cloud.v1.microservicekubernetes.rpc;

import build.buf.gen.cloud.planton.apis.code2cloud.v1.microservicekubernetes.model.MicroserviceKubernetes;
...
public final class MicroserviceKubernetesTest {
    ...
    public void testMicroserviceKubernetes_ShouldReturnValidationErrorIfMetadataIsNotPassed() throws ValidationException {
        var microserviceInstance  = MicroserviceKubernetes.newBuilder().build();
        Validator validator = new Validator();
    ...
    public void testMicroserviceKubernetes_ShouldReturnValidationErrorIfVersionMessageIsNotPassed() throws ValidationException {
        var microserviceInstance  = MicroserviceKubernetes.newBuilder().setMetadata(ApiResourceMetadata.newBuilder().build()).build();
        Validator validator = new Validator();
        var result = validator.validate(microserviceInstance );
        var versionMessageViolation = result.getViolations().stream()
    ...
    public void testMicroserviceKubernetes_ShouldNotReturnValidationErrorIfVersionMessageIsPassed() throws ValidationException {
        var microserviceInstance  = MicroserviceKubernetes.newBuilder()
