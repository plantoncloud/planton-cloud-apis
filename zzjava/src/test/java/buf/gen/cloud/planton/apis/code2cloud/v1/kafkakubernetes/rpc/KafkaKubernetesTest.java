package buf.gen.cloud.planton.apis.code2cloud.v1.kafkakubernetes.rpc;

import build.buf.gen.cloud.planton.apis.code2cloud.v1.kafkakubernetes.model.KafkaKubernetes;
import build.buf.gen.cloud.planton.apis.code2cloud.v1.kafkakubernetes.model.KafkaKubernetesSpec;
import build.buf.gen.cloud.planton.apis.code2cloud.v1.kafkakubernetes.model.KafkaKubernetesSpecBrokerContainerSpec;
import build.buf.gen.cloud.planton.apis.code2cloud.v1.kafkakubernetes.model.KafkaKubernetesSpecZookeeperContainerSpec;
...
public final class KafkaKubernetesTest {
    ...
    public void testKafkaKubernetes_ShouldReturnValidationErrorIfMetadataIsNotPassed() throws ValidationException {
        var kafkaCluster = KafkaKubernetes.newBuilder().build();
        Validator validator = new Validator();
    ...
    public void testKafkaKubernetes_ShouldReturnValidationErrorIfVersionMessageIsNotPassed() throws ValidationException {
        var kafkaCluster = KafkaKubernetes.newBuilder().setMetadata(ApiResourceMetadata.newBuilder().build()).build();
        Validator validator = new Validator();
        var result = validator.validate(kafkaCluster);
        var versionMessageViolation = result.getViolations().stream()
    ...
    public void testKafkaKubernetes_ShouldNotReturnValidationErrorIfVersionMessageIsPassed() throws ValidationException {
        var kafkaCluster = KafkaKubernetes.newBuilder()
