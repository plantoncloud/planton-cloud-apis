package buf.gen.cloud.planton.apis.code2cloud.v1.deploy.azure;

import build.buf.gen.cloud.planton.apis.code2cloud.v1.deploy.azure.akscluster.model.AksCluster;
...
public final class AksClusterTest {
    ...
    public void testAksCluster_ShouldNotThroughProtoValidationException() {
        var input1 = AksCluster.newBuilder().build();
