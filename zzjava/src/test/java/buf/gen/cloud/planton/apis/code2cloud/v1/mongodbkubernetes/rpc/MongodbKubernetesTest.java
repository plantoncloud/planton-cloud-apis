package buf.gen.cloud.planton.apis.code2cloud.v1.mongodbkubernetes.rpc;

import build.buf.gen.cloud.planton.apis.code2cloud.v1.mongodbkubernetes.model.MongodbKubernetes;
import build.buf.gen.cloud.planton.apis.code2cloud.v1.mongodbkubernetes.model.MongodbKubernetesSpec;
import build.buf.gen.cloud.planton.apis.code2cloud.v1.mongodbkubernetes.model.MongodbKubernetesSpecContainerSpec;
...
public final class MongodbKubernetesTest {
    ...
    public void testMongodbKubernetes_ShouldReturnValidationErrorIfMetadataIsNotPassed() throws ValidationException {
        var mongodbCluster  = MongodbKubernetes.newBuilder().build();
        Validator validator = new Validator();
    ...
    public void testMongodbKubernetes_ShouldReturnValidationErrorIfVersionMessageIsNotPassed() throws ValidationException {
        var mongodbCluster  = MongodbKubernetes.newBuilder().setMetadata(ApiResourceMetadata.newBuilder().build()).build();
        Validator validator = new Validator();
        var result = validator.validate(mongodbCluster );
        var versionMessageViolation = result.getViolations().stream()
    ...
    public void testMongodbKubernetes_ShouldNotReturnValidationErrorIfVersionMessageIsPassed() throws ValidationException {
        var mongodbCluster  = MongodbKubernetes.newBuilder()
