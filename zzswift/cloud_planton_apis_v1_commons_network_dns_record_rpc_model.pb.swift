...
/// dns record
public struct Cloud_Planton_Apis_V1_Commons_Network_Dns_Record_Rpc_DnsRecord {
...
extension Cloud_Planton_Apis_V1_Commons_Network_Dns_Record_Rpc_DnsRecord: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "cloud.planton.apis.v1.commons.network.dns.record.rpc"

extension Cloud_Planton_Apis_V1_Commons_Network_Dns_Record_Rpc_DnsRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cloud_Planton_Apis_V1_Commons_Network_Dns_Record_Rpc_DnsRecord, rhs: Cloud_Planton_Apis_V1_Commons_Network_Dns_Record_Rpc_DnsRecord) -> Bool {
