...
///code-server state
public struct Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  ///event-type
  public var eventType: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_Enums_CodeServerEventType {
  ...
  ///spec
  public var spec: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState {
    get {return _storage._spec ?? Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState()}
  ...
  ///status
  public var status: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState {
    get {return _storage._status ?? Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState()}
...
public struct Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var codeServerProvider: String = String()

  ///github spec
  public var github: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState {
    get {return _github ?? Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState()}
  ...
  ///gitlab spec
  public var gitlab: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState {
    get {return _gitlab ?? Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState()}
  ...
  fileprivate var _github: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState? = nil
  fileprivate var _gitlab: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState? = nil
}

///github code-server spec
public struct Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var appInstallOwnerType: String = String()
...
public struct Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerState: @unchecked Sendable {}
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState: @unchecked Sendable {}
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState: @unchecked Sendable {}
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState: @unchecked Sendable {}
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.state"

extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CodeServerState"
  ...
  fileprivate class _StorageClass {
    var _eventType: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_Enums_CodeServerEventType = .unspecified
    var _apiVersion: String = String()
    var _kind: String = String()
    var _metadata: Cloud_Planton_Apis_V1_Commons_Resource_Metadata? = nil
    var _spec: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState? = nil
    var _status: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState? = nil
  ...
  public static func ==(lhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerState, rhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerState) -> Bool {
...
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CodeServerSpecState"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self.codeServerProvider) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.codeServerProvider.isEmpty {
      try visitor.visitSingularStringField(value: self.codeServerProvider, fieldNumber: 4)
    }
  ...
  public static func ==(lhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState, rhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerSpecState) -> Bool {
...
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CodeServerGithubSpecState"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.appInstallOwnerType) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.appInstallOwnerType.isEmpty {
      try visitor.visitSingularStringField(value: self.appInstallOwnerType, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState, rhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGithubSpecState) -> Bool {
...
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CodeServerGitlabSpecState"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState, rhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerGitlabSpecState) -> Bool {
...
extension Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CodeServerStatusState"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState, rhs: Cloud_Planton_Apis_V1_Code2cloud_Develop_Sourcecode_Server_State_CodeServerStatusState) -> Bool {
