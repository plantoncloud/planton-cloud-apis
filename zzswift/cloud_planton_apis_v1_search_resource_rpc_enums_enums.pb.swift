...
public enum Cloud_Planton_Apis_V1_Search_Resource_Rpc_Enums_StatusFilter: SwiftProtobuf.Enum {
...
extension Cloud_Planton_Apis_V1_Search_Resource_Rpc_Enums_StatusFilter: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Cloud_Planton_Apis_V1_Search_Resource_Rpc_Enums_StatusFilter] = [
    .unspecified,
    .activeOnly,
    .inactiveOnly,
    .all,
...
extension Cloud_Planton_Apis_V1_Search_Resource_Rpc_Enums_StatusFilter: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

extension Cloud_Planton_Apis_V1_Search_Resource_Rpc_Enums_StatusFilter: SwiftProtobuf._ProtoNameProviding {
