...
type ProductQueryControllerClient interface {
	...
	FindByCompanyId(ctx context.Context, in *model1.CompanyId, opts ...grpc.CallOption) (*model.Products, error)
}
...
func (c *productQueryControllerClient) FindByCompanyId(ctx context.Context, in *model1.CompanyId, opts ...grpc.CallOption) (*model.Products, error) {
	out := new(model.Products)
...
type ProductQueryControllerServer interface {
	...
	// find products by company id.
	// the response should only include the products that the authenticated user has access to.
	FindByCompanyId(context.Context, *model1.CompanyId) (*model.Products, error)
}
...
func (UnimplementedProductQueryControllerServer) FindByCompanyId(context.Context, *model1.CompanyId) (*model.Products, error) {
...
func _ProductQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductQueryControllerServer).GetById(ctx, req.(*model.ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductQueryController_FindByCompanyId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductQueryControllerServer).FindByCompanyId(ctx, req.(*model1.CompanyId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductQueryController_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "cloud/planton/apis/resourcemanager/v1/product/service/query.proto",
}
