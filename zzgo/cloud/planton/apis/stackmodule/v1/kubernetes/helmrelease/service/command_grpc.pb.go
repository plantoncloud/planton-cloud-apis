...
const (
	HelmReleaseCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/previewCreate"
	HelmReleaseCommandController_Create_FullMethodName         = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/create"
	HelmReleaseCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/previewUpdate"
	HelmReleaseCommandController_Update_FullMethodName         = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/update"
	HelmReleaseCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/previewDelete"
	HelmReleaseCommandController_Delete_FullMethodName         = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/delete"
	HelmReleaseCommandController_PreviewRestore_FullMethodName = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/previewRestore"
	HelmReleaseCommandController_Restore_FullMethodName        = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/restore"
	HelmReleaseCommandController_PreviewRefresh_FullMethodName = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/previewRefresh"
	HelmReleaseCommandController_Refresh_FullMethodName        = "/cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController/refresh"
)
...
var HelmReleaseCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.stackmodule.v1.kubernetes.helmrelease.service.HelmReleaseCommandController",
	...
	Metadata: "cloud/planton/apis/stackmodule/v1/kubernetes/helmrelease/service/command.proto",
}
