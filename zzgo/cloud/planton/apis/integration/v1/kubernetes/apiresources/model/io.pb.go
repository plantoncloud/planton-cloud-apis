...
var file_cloud_planton_apis_integration_v1_kubernetes_apiresources_model_io_proto_rawDesc = []byte{
	...
	0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x42, 0xf1, 0x03, 0x0a, 0x4d, 0x62, 0x75, 0x69,
...
var file_cloud_planton_apis_integration_v1_kubernetes_apiresources_model_io_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_cloud_planton_apis_integration_v1_kubernetes_apiresources_model_io_proto_goTypes = []interface{}{
	...
	nil,                                               // 10: cloud.planton.apis.integration.v1.kubernetes.apiresources.model.WorkloadNamespace.LabelsEntry
	nil,                                               // 11: cloud.planton.apis.integration.v1.kubernetes.apiresources.model.Pod.LabelsEntry
	nil,                                               // 12: cloud.planton.apis.integration.v1.kubernetes.apiresources.model.Certificate.LabelsEntry
}
var file_cloud_planton_apis_integration_v1_kubernetes_apiresources_model_io_proto_depIdxs = []int32{
	10, // 0: cloud.planton.apis.integration.v1.kubernetes.apiresources.model.WorkloadNamespace.labels:type_name -> cloud.planton.apis.integration.v1.kubernetes.apiresources.model.WorkloadNamespace.LabelsEntry
	...
	11, // 2: cloud.planton.apis.integration.v1.kubernetes.apiresources.model.Pod.labels:type_name -> cloud.planton.apis.integration.v1.kubernetes.apiresources.model.Pod.LabelsEntry
	...
	12, // 10: cloud.planton.apis.integration.v1.kubernetes.apiresources.model.Certificate.labels:type_name -> cloud.planton.apis.integration.v1.kubernetes.apiresources.model.Certificate.LabelsEntry
