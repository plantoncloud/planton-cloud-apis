...
const (
	GitlabProxyQueryController_ListProjects_FullMethodName                = "/cloud.planton.apis.integration.v1.gitlab.proxy.service.GitlabProxyQueryController/listProjects"
	GitlabProxyQueryController_GetProject_FullMethodName                  = "/cloud.planton.apis.integration.v1.gitlab.proxy.service.GitlabProxyQueryController/getProject"
	GitlabProxyQueryController_GetGroup_FullMethodName                    = "/cloud.planton.apis.integration.v1.gitlab.proxy.service.GitlabProxyQueryController/getGroup"
	GitlabProxyQueryController_GetGitlabCodeProjectProfile_FullMethodName = "/cloud.planton.apis.integration.v1.gitlab.proxy.service.GitlabProxyQueryController/getGitlabCodeProjectProfile"
)
...
var GitlabProxyQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.integration.v1.gitlab.proxy.service.GitlabProxyQueryController",
	...
	Metadata: "cloud/planton/apis/integration/v1/gitlab/proxy/service/query.proto",
}
