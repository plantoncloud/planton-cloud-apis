...
const (
	CertificateProxyQueryController_GetCertificateByNamespaceByName_FullMethodName = "/cloud.planton.apis.v1.integration.kubernetes.proxy.certificate.CertificateProxyQueryController/getCertificateByNamespaceByName"
	CertificateProxyQueryController_FindCertificates_FullMethodName                = "/cloud.planton.apis.v1.integration.kubernetes.proxy.certificate.CertificateProxyQueryController/findCertificates"
)
...
type CertificateProxyQueryControllerClient interface {
	GetCertificateByNamespaceByName(ctx context.Context, in *GetCertificateByNamespaceByNameQueryInput, opts ...grpc.CallOption) (*resource.Certificate, error)
	FindCertificates(ctx context.Context, in *FindCertificatesQueryInput, opts ...grpc.CallOption) (*resource.Certificates, error)
}
...
func (c *certificateProxyQueryControllerClient) GetCertificateByNamespaceByName(ctx context.Context, in *GetCertificateByNamespaceByNameQueryInput, opts ...grpc.CallOption) (*resource.Certificate, error) {
...
func (c *certificateProxyQueryControllerClient) FindCertificates(ctx context.Context, in *FindCertificatesQueryInput, opts ...grpc.CallOption) (*resource.Certificates, error) {
...
type CertificateProxyQueryControllerServer interface {
	GetCertificateByNamespaceByName(context.Context, *GetCertificateByNamespaceByNameQueryInput) (*resource.Certificate, error)
	FindCertificates(context.Context, *FindCertificatesQueryInput) (*resource.Certificates, error)
}
...
func (UnimplementedCertificateProxyQueryControllerServer) GetCertificateByNamespaceByName(context.Context, *GetCertificateByNamespaceByNameQueryInput) (*resource.Certificate, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCertificateByNamespaceByName not implemented")
}
func (UnimplementedCertificateProxyQueryControllerServer) FindCertificates(context.Context, *FindCertificatesQueryInput) (*resource.Certificates, error) {
...
func _CertificateProxyQueryController_GetCertificateByNamespaceByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCertificateByNamespaceByNameQueryInput)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CertificateProxyQueryControllerServer).GetCertificateByNamespaceByName(ctx, req.(*GetCertificateByNamespaceByNameQueryInput))
	}
...
func _CertificateProxyQueryController_FindCertificates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindCertificatesQueryInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CertificateProxyQueryControllerServer).FindCertificates(ctx, req.(*FindCertificatesQueryInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CertificateProxyQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.integration.kubernetes.proxy.certificate.CertificateProxyQueryController",
