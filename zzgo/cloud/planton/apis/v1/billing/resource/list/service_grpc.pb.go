...
const (
	ResourceListViewQueryController_ListByResourceType_FullMethodName = "/cloud.planton.apis.v1.billing.resource.list.ResourceListViewQueryController/listByResourceType"
)
...
var ResourceListViewQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.billing.resource.list.ResourceListViewQueryController",
	...
	Metadata: "cloud/planton/apis/v1/billing/resource/list/service.proto",
}
