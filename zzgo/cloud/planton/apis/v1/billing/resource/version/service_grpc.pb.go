...
const (
	ResourceVersionQueryController_ListByFilters_FullMethodName          = "/cloud.planton.apis.v1.billing.resource.version.ResourceVersionQueryController/listByFilters"
	ResourceVersionQueryController_GetByIdWithContextSize_FullMethodName = "/cloud.planton.apis.v1.billing.resource.version.ResourceVersionQueryController/getByIdWithContextSize"
)
...
type ResourceVersionQueryControllerClient interface {
	...
	ListByFilters(ctx context.Context, in *version.ListResourceVersionsByFiltersQueryInput, opts ...grpc.CallOption) (*version.ResourceVersionList, error)
...
func (c *resourceVersionQueryControllerClient) ListByFilters(ctx context.Context, in *version.ListResourceVersionsByFiltersQueryInput, opts ...grpc.CallOption) (*version.ResourceVersionList, error) {
...
type ResourceVersionQueryControllerServer interface {
	// list of resource-versions
	ListByFilters(context.Context, *version.ListResourceVersionsByFiltersQueryInput) (*version.ResourceVersionList, error)
	// look up resource-version by version-id
...
func (UnimplementedResourceVersionQueryControllerServer) ListByFilters(context.Context, *version.ListResourceVersionsByFiltersQueryInput) (*version.ResourceVersionList, error) {
...
func _ResourceVersionQueryController_ListByFilters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(version.ListResourceVersionsByFiltersQueryInput)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceVersionQueryControllerServer).ListByFilters(ctx, req.(*version.ListResourceVersionsByFiltersQueryInput))
	}
...
var ResourceVersionQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.billing.resource.version.ResourceVersionQueryController",
	...
	Metadata: "cloud/planton/apis/v1/billing/resource/version/service.proto",
}
