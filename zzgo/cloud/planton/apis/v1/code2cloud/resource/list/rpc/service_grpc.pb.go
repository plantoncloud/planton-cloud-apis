...
const (
	ResourceListViewQueryController_ListByResourceType_FullMethodName = "/cloud.planton.apis.v1.code2cloud.resource.list.rpc.ResourceListViewQueryController/listByResourceType"
)
...
var ResourceListViewQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.resource.list.rpc.ResourceListViewQueryController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/resource/list/rpc/service.proto",
}
