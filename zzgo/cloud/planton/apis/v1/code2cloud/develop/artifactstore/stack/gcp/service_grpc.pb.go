...
const (
	ArtifactStoreGcpStackController_Execute_FullMethodName         = "/cloud.planton.apis.v1.code2cloud.develop.artifactstore.stack.gcp.ArtifactStoreGcpStackController/execute"
	ArtifactStoreGcpStackController_GetStackOutputs_FullMethodName = "/cloud.planton.apis.v1.code2cloud.develop.artifactstore.stack.gcp.ArtifactStoreGcpStackController/getStackOutputs"
)
...
type ArtifactStoreGcpStackControllerClient interface {
	Execute(ctx context.Context, in *ArtifactStoreGcpStackInput, opts ...grpc.CallOption) (ArtifactStoreGcpStackController_ExecuteClient, error)
	GetStackOutputs(ctx context.Context, in *ArtifactStoreGcpStackInput, opts ...grpc.CallOption) (*ArtifactStoreGcpStackOutputs, error)
}
...
func (c *artifactStoreGcpStackControllerClient) Execute(ctx context.Context, in *ArtifactStoreGcpStackInput, opts ...grpc.CallOption) (ArtifactStoreGcpStackController_ExecuteClient, error) {
...
type ArtifactStoreGcpStackController_ExecuteClient interface {
	Recv() (*ArtifactStoreGcpStackResponse, error)
	grpc.ClientStream
}
...
func (x *artifactStoreGcpStackControllerExecuteClient) Recv() (*ArtifactStoreGcpStackResponse, error) {
	m := new(ArtifactStoreGcpStackResponse)
...
func (c *artifactStoreGcpStackControllerClient) GetStackOutputs(ctx context.Context, in *ArtifactStoreGcpStackInput, opts ...grpc.CallOption) (*ArtifactStoreGcpStackOutputs, error) {
	out := new(ArtifactStoreGcpStackOutputs)
...
type ArtifactStoreGcpStackControllerServer interface {
	Execute(*ArtifactStoreGcpStackInput, ArtifactStoreGcpStackController_ExecuteServer) error
	GetStackOutputs(context.Context, *ArtifactStoreGcpStackInput) (*ArtifactStoreGcpStackOutputs, error)
}
...
func (UnimplementedArtifactStoreGcpStackControllerServer) Execute(*ArtifactStoreGcpStackInput, ArtifactStoreGcpStackController_ExecuteServer) error {
	return status.Errorf(codes.Unimplemented, "method Execute not implemented")
}
func (UnimplementedArtifactStoreGcpStackControllerServer) GetStackOutputs(context.Context, *ArtifactStoreGcpStackInput) (*ArtifactStoreGcpStackOutputs, error) {
...
func _ArtifactStoreGcpStackController_Execute_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ArtifactStoreGcpStackInput)
...
type ArtifactStoreGcpStackController_ExecuteServer interface {
	Send(*ArtifactStoreGcpStackResponse) error
	grpc.ServerStream
}
...
func (x *artifactStoreGcpStackControllerExecuteServer) Send(m *ArtifactStoreGcpStackResponse) error {
...
func _ArtifactStoreGcpStackController_GetStackOutputs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArtifactStoreGcpStackInput)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArtifactStoreGcpStackControllerServer).GetStackOutputs(ctx, req.(*ArtifactStoreGcpStackInput))
	}
...
var ArtifactStoreGcpStackController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.develop.artifactstore.stack.gcp.ArtifactStoreGcpStackController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/develop/artifactstore/stack/gcp/service.proto",
}
