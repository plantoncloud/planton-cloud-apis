...
const (
	CodeServerCommandController_Create_FullMethodName                             = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerCommandController/create"
	CodeServerCommandController_Update_FullMethodName                             = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerCommandController/update"
	CodeServerCommandController_Delete_FullMethodName                             = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerCommandController/delete"
	CodeServerCommandController_Restore_FullMethodName                            = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerCommandController/restore"
	CodeServerCommandController_SynchronizeCodeProjects_FullMethodName            = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerCommandController/synchronizeCodeProjects"
	CodeServerCommandController_AttachMachineAccountByCodeServerId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerCommandController/attachMachineAccountByCodeServerId"
)
...
var CodeServerCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerCommandController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/develop/sourcecode/server/rpc/service.proto",
}

const (
	CodeServerQueryController_List_FullMethodName            = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerQueryController/list"
	CodeServerQueryController_GetById_FullMethodName         = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerQueryController/getById"
	CodeServerQueryController_FindByProductId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerQueryController/findByProductId"
)
...
type CodeServerQueryControllerClient interface {
	...
	FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*CodeServers, error)
}
...
func (c *codeServerQueryControllerClient) FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*CodeServers, error) {
	out := new(CodeServers)
...
type CodeServerQueryControllerServer interface {
	...
	// find code servers by product id.
	// response contains only objects that the authenticated user account id has viewer access to.
	FindByProductId(context.Context, *rpc.ProductId) (*CodeServers, error)
}
...
func (UnimplementedCodeServerQueryControllerServer) FindByProductId(context.Context, *rpc.ProductId) (*CodeServers, error) {
...
func _CodeServerQueryController_FindByProductId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CodeServerQueryControllerServer).FindByProductId(ctx, req.(*rpc.ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CodeServerQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.develop.sourcecode.server.rpc.CodeServerQueryController",
