...
const (
	EnvironmentGcpGkeStackController_Execute_FullMethodName         = "/cloud.planton.apis.v1.code2cloud.environment.stack.gcpgke.EnvironmentGcpGkeStackController/execute"
	EnvironmentGcpGkeStackController_GetStackOutputs_FullMethodName = "/cloud.planton.apis.v1.code2cloud.environment.stack.gcpgke.EnvironmentGcpGkeStackController/getStackOutputs"
)
...
type EnvironmentGcpGkeStackControllerClient interface {
	Execute(ctx context.Context, in *EnvironmentGcpGkeStackInput, opts ...grpc.CallOption) (EnvironmentGcpGkeStackController_ExecuteClient, error)
	GetStackOutputs(ctx context.Context, in *EnvironmentGcpGkeStackInput, opts ...grpc.CallOption) (*EnvironmentGcpGkeStackOutputs, error)
}
...
func (c *environmentGcpGkeStackControllerClient) Execute(ctx context.Context, in *EnvironmentGcpGkeStackInput, opts ...grpc.CallOption) (EnvironmentGcpGkeStackController_ExecuteClient, error) {
...
type EnvironmentGcpGkeStackController_ExecuteClient interface {
	Recv() (*EnvironmentGcpGkeStackResponse, error)
	grpc.ClientStream
}
...
func (x *environmentGcpGkeStackControllerExecuteClient) Recv() (*EnvironmentGcpGkeStackResponse, error) {
	m := new(EnvironmentGcpGkeStackResponse)
...
func (c *environmentGcpGkeStackControllerClient) GetStackOutputs(ctx context.Context, in *EnvironmentGcpGkeStackInput, opts ...grpc.CallOption) (*EnvironmentGcpGkeStackOutputs, error) {
	out := new(EnvironmentGcpGkeStackOutputs)
...
type EnvironmentGcpGkeStackControllerServer interface {
	Execute(*EnvironmentGcpGkeStackInput, EnvironmentGcpGkeStackController_ExecuteServer) error
	GetStackOutputs(context.Context, *EnvironmentGcpGkeStackInput) (*EnvironmentGcpGkeStackOutputs, error)
}
...
func (UnimplementedEnvironmentGcpGkeStackControllerServer) Execute(*EnvironmentGcpGkeStackInput, EnvironmentGcpGkeStackController_ExecuteServer) error {
	return status.Errorf(codes.Unimplemented, "method Execute not implemented")
}
func (UnimplementedEnvironmentGcpGkeStackControllerServer) GetStackOutputs(context.Context, *EnvironmentGcpGkeStackInput) (*EnvironmentGcpGkeStackOutputs, error) {
...
func _EnvironmentGcpGkeStackController_Execute_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(EnvironmentGcpGkeStackInput)
...
type EnvironmentGcpGkeStackController_ExecuteServer interface {
	Send(*EnvironmentGcpGkeStackResponse) error
	grpc.ServerStream
}
...
func (x *environmentGcpGkeStackControllerExecuteServer) Send(m *EnvironmentGcpGkeStackResponse) error {
...
func _EnvironmentGcpGkeStackController_GetStackOutputs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnvironmentGcpGkeStackInput)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentGcpGkeStackControllerServer).GetStackOutputs(ctx, req.(*EnvironmentGcpGkeStackInput))
	}
...
var EnvironmentGcpGkeStackController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.environment.stack.gcpgke.EnvironmentGcpGkeStackController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/environment/stack/gcpgke/service.proto",
}
