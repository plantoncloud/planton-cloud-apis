...
const (
	EnvironmentQueryController_List_FullMethodName                                  = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/list"
	EnvironmentQueryController_GetById_FullMethodName                               = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/getById"
	EnvironmentQueryController_FindByProductId_FullMethodName                       = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/findByProductId"
	EnvironmentQueryController_FindByKubeClusterId_FullMethodName                   = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/findByKubeClusterId"
	EnvironmentQueryController_GetByProductIdAndEnvironmentName_FullMethodName      = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/getByProductIdAndEnvironmentName"
	EnvironmentQueryController_GetBuildEngineEnvironmentByProductId_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/getBuildEngineEnvironmentByProductId"
	EnvironmentQueryController_GetSecretsGcpProjectByEnvironmentId_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/getSecretsGcpProjectByEnvironmentId"
	EnvironmentQueryController_FindWorkloadPodsByEnvironmentId_FullMethodName       = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/findWorkloadPodsByEnvironmentId"
	EnvironmentQueryController_FindWorkloadNamespacesByEnvironmentId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController/findWorkloadNamespacesByEnvironmentId"
)
...
type EnvironmentQueryControllerClient interface {
	...
	List(ctx context.Context, in *model.PageInfo, opts ...grpc.CallOption) (*model1.EnvironmentList, error)
	// look up environment using environment id
	GetById(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*model1.Environment, error)
	// find environments by product id
	FindByProductId(ctx context.Context, in *model2.ProductId, opts ...grpc.CallOption) (*model1.Environments, error)
	// find environments by kube-cluster id
	FindByKubeClusterId(ctx context.Context, in *model3.KubeClusterId, opts ...grpc.CallOption) (*model1.Environments, error)
	// look up environment using environment id
	GetByProductIdAndEnvironmentName(ctx context.Context, in *model1.GetByProductIdAndEnvironmentNameQueryInput, opts ...grpc.CallOption) (*model1.Environment, error)
	// look up the build engine environment for the product required for launching the microservice in build engine
	GetBuildEngineEnvironmentByProductId(ctx context.Context, in *model2.ProductId, opts ...grpc.CallOption) (*model1.Environment, error)
	// look up the gcp project details by environment id required for fetching secrets for launching project in build engine.
	GetSecretsGcpProjectByEnvironmentId(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*project.GcpProject, error)
	// find workload pods part of environment
	FindWorkloadPodsByEnvironmentId(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*resource.WorkloadPods, error)
	// find workload namespaces in a environment.
	FindWorkloadNamespacesByEnvironmentId(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*resource.WorkloadNamespaces, error)
}
...
func (c *environmentQueryControllerClient) List(ctx context.Context, in *model.PageInfo, opts ...grpc.CallOption) (*model1.EnvironmentList, error) {
	out := new(model1.EnvironmentList)
...
func (c *environmentQueryControllerClient) GetById(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*model1.Environment, error) {
	out := new(model1.Environment)
...
func (c *environmentQueryControllerClient) FindByProductId(ctx context.Context, in *model2.ProductId, opts ...grpc.CallOption) (*model1.Environments, error) {
	out := new(model1.Environments)
...
func (c *environmentQueryControllerClient) FindByKubeClusterId(ctx context.Context, in *model3.KubeClusterId, opts ...grpc.CallOption) (*model1.Environments, error) {
	out := new(model1.Environments)
...
func (c *environmentQueryControllerClient) GetByProductIdAndEnvironmentName(ctx context.Context, in *model1.GetByProductIdAndEnvironmentNameQueryInput, opts ...grpc.CallOption) (*model1.Environment, error) {
	out := new(model1.Environment)
...
func (c *environmentQueryControllerClient) GetBuildEngineEnvironmentByProductId(ctx context.Context, in *model2.ProductId, opts ...grpc.CallOption) (*model1.Environment, error) {
	out := new(model1.Environment)
...
func (c *environmentQueryControllerClient) GetSecretsGcpProjectByEnvironmentId(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*project.GcpProject, error) {
...
func (c *environmentQueryControllerClient) FindWorkloadPodsByEnvironmentId(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*resource.WorkloadPods, error) {
...
func (c *environmentQueryControllerClient) FindWorkloadNamespacesByEnvironmentId(ctx context.Context, in *model1.EnvironmentId, opts ...grpc.CallOption) (*resource.WorkloadNamespaces, error) {
...
type EnvironmentQueryControllerServer interface {
	// list all environments on planton cloud for the requested page. This is intended for use on portal.
	List(context.Context, *model.PageInfo) (*model1.EnvironmentList, error)
	// look up environment using environment id
	GetById(context.Context, *model1.EnvironmentId) (*model1.Environment, error)
	// find environments by product id
	FindByProductId(context.Context, *model2.ProductId) (*model1.Environments, error)
	// find environments by kube-cluster id
	FindByKubeClusterId(context.Context, *model3.KubeClusterId) (*model1.Environments, error)
	// look up environment using environment id
	GetByProductIdAndEnvironmentName(context.Context, *model1.GetByProductIdAndEnvironmentNameQueryInput) (*model1.Environment, error)
	// look up the build engine environment for the product required for launching the microservice in build engine
	GetBuildEngineEnvironmentByProductId(context.Context, *model2.ProductId) (*model1.Environment, error)
	// look up the gcp project details by environment id required for fetching secrets for launching project in build engine.
	GetSecretsGcpProjectByEnvironmentId(context.Context, *model1.EnvironmentId) (*project.GcpProject, error)
	// find workload pods part of environment
	FindWorkloadPodsByEnvironmentId(context.Context, *model1.EnvironmentId) (*resource.WorkloadPods, error)
	// find workload namespaces in a environment.
	FindWorkloadNamespacesByEnvironmentId(context.Context, *model1.EnvironmentId) (*resource.WorkloadNamespaces, error)
}
...
func (UnimplementedEnvironmentQueryControllerServer) List(context.Context, *model.PageInfo) (*model1.EnvironmentList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) GetById(context.Context, *model1.EnvironmentId) (*model1.Environment, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) FindByProductId(context.Context, *model2.ProductId) (*model1.Environments, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByProductId not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) FindByKubeClusterId(context.Context, *model3.KubeClusterId) (*model1.Environments, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByKubeClusterId not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) GetByProductIdAndEnvironmentName(context.Context, *model1.GetByProductIdAndEnvironmentNameQueryInput) (*model1.Environment, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByProductIdAndEnvironmentName not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) GetBuildEngineEnvironmentByProductId(context.Context, *model2.ProductId) (*model1.Environment, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBuildEngineEnvironmentByProductId not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) GetSecretsGcpProjectByEnvironmentId(context.Context, *model1.EnvironmentId) (*project.GcpProject, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSecretsGcpProjectByEnvironmentId not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) FindWorkloadPodsByEnvironmentId(context.Context, *model1.EnvironmentId) (*resource.WorkloadPods, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindWorkloadPodsByEnvironmentId not implemented")
}
func (UnimplementedEnvironmentQueryControllerServer) FindWorkloadNamespacesByEnvironmentId(context.Context, *model1.EnvironmentId) (*resource.WorkloadNamespaces, error) {
...
func _EnvironmentQueryController_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).List(ctx, req.(*model.PageInfo))
	}
...
func _EnvironmentQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).GetById(ctx, req.(*model1.EnvironmentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentQueryController_FindByProductId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).FindByProductId(ctx, req.(*model2.ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentQueryController_FindByKubeClusterId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).FindByKubeClusterId(ctx, req.(*model3.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentQueryController_GetByProductIdAndEnvironmentName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model1.GetByProductIdAndEnvironmentNameQueryInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).GetByProductIdAndEnvironmentName(ctx, req.(*model1.GetByProductIdAndEnvironmentNameQueryInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentQueryController_GetBuildEngineEnvironmentByProductId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).GetBuildEngineEnvironmentByProductId(ctx, req.(*model2.ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentQueryController_GetSecretsGcpProjectByEnvironmentId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).GetSecretsGcpProjectByEnvironmentId(ctx, req.(*model1.EnvironmentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentQueryController_FindWorkloadPodsByEnvironmentId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).FindWorkloadPodsByEnvironmentId(ctx, req.(*model1.EnvironmentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentQueryController_FindWorkloadNamespacesByEnvironmentId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentQueryControllerServer).FindWorkloadNamespacesByEnvironmentId(ctx, req.(*model1.EnvironmentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EnvironmentQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentQueryController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/environment/service/query.proto",
}

const (
	EnvironmentSecretQueryController_GetById_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentSecretQueryController/getById"
	EnvironmentSecretQueryController_GetValue_FullMethodName = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentSecretQueryController/getValue"
)
...
type EnvironmentSecretQueryControllerClient interface {
	...
	GetById(ctx context.Context, in *model1.GetByEnvironmentSecretIdInput, opts ...grpc.CallOption) (*model1.EnvironmentSecret, error)
	// get value of a product secret
	GetValue(ctx context.Context, in *model1.GetByEnvironmentSecretIdInput, opts ...grpc.CallOption) (*model1.EnvironmentSecretValue, error)
}
...
func (c *environmentSecretQueryControllerClient) GetById(ctx context.Context, in *model1.GetByEnvironmentSecretIdInput, opts ...grpc.CallOption) (*model1.EnvironmentSecret, error) {
	out := new(model1.EnvironmentSecret)
...
func (c *environmentSecretQueryControllerClient) GetValue(ctx context.Context, in *model1.GetByEnvironmentSecretIdInput, opts ...grpc.CallOption) (*model1.EnvironmentSecretValue, error) {
	out := new(model1.EnvironmentSecretValue)
...
type EnvironmentSecretQueryControllerServer interface {
	// lookup product secrets using product secret id
	GetById(context.Context, *model1.GetByEnvironmentSecretIdInput) (*model1.EnvironmentSecret, error)
	// get value of a product secret
	GetValue(context.Context, *model1.GetByEnvironmentSecretIdInput) (*model1.EnvironmentSecretValue, error)
}
...
func (UnimplementedEnvironmentSecretQueryControllerServer) GetById(context.Context, *model1.GetByEnvironmentSecretIdInput) (*model1.EnvironmentSecret, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedEnvironmentSecretQueryControllerServer) GetValue(context.Context, *model1.GetByEnvironmentSecretIdInput) (*model1.EnvironmentSecretValue, error) {
...
func _EnvironmentSecretQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model1.GetByEnvironmentSecretIdInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentSecretQueryControllerServer).GetById(ctx, req.(*model1.GetByEnvironmentSecretIdInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentSecretQueryController_GetValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentSecretQueryControllerServer).GetValue(ctx, req.(*model1.GetByEnvironmentSecretIdInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EnvironmentSecretQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentSecretQueryController",
...
const (
	EnvironmentVariableQueryController_GetById_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentVariableQueryController/getById"
	EnvironmentVariableQueryController_GetValue_FullMethodName = "/cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentVariableQueryController/getValue"
)
...
type EnvironmentVariableQueryControllerClient interface {
	...
	GetById(ctx context.Context, in *model1.GetByEnvironmentVariableIdInput, opts ...grpc.CallOption) (*model1.EnvironmentVariable, error)
	// get value of a environment variable
	GetValue(ctx context.Context, in *model1.GetByEnvironmentVariableIdInput, opts ...grpc.CallOption) (*model1.EnvironmentVariableValue, error)
}
...
func (c *environmentVariableQueryControllerClient) GetById(ctx context.Context, in *model1.GetByEnvironmentVariableIdInput, opts ...grpc.CallOption) (*model1.EnvironmentVariable, error) {
	out := new(model1.EnvironmentVariable)
...
func (c *environmentVariableQueryControllerClient) GetValue(ctx context.Context, in *model1.GetByEnvironmentVariableIdInput, opts ...grpc.CallOption) (*model1.EnvironmentVariableValue, error) {
	out := new(model1.EnvironmentVariableValue)
...
type EnvironmentVariableQueryControllerServer interface {
	// lookup environment variables using environment variable id
	GetById(context.Context, *model1.GetByEnvironmentVariableIdInput) (*model1.EnvironmentVariable, error)
	// get value of a environment variable
	GetValue(context.Context, *model1.GetByEnvironmentVariableIdInput) (*model1.EnvironmentVariableValue, error)
}
...
func (UnimplementedEnvironmentVariableQueryControllerServer) GetById(context.Context, *model1.GetByEnvironmentVariableIdInput) (*model1.EnvironmentVariable, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedEnvironmentVariableQueryControllerServer) GetValue(context.Context, *model1.GetByEnvironmentVariableIdInput) (*model1.EnvironmentVariableValue, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetValue not implemented")
}
...
func _EnvironmentVariableQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model1.GetByEnvironmentVariableIdInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentVariableQueryControllerServer).GetById(ctx, req.(*model1.GetByEnvironmentVariableIdInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EnvironmentVariableQueryController_GetValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvironmentVariableQueryControllerServer).GetValue(ctx, req.(*model1.GetByEnvironmentVariableIdInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EnvironmentVariableQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.environment.service.EnvironmentVariableQueryController",
