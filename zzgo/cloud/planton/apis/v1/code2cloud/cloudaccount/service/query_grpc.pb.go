...
const (
	CloudAccountQueryController_GetById_FullMethodName                              = "/cloud.planton.apis.v1.code2cloud.cloudaccount.service.CloudAccountQueryController/getById"
	CloudAccountQueryController_FindByCompanyId_FullMethodName                      = "/cloud.planton.apis.v1.code2cloud.cloudaccount.service.CloudAccountQueryController/findByCompanyId"
	CloudAccountQueryController_List_FullMethodName                                 = "/cloud.planton.apis.v1.code2cloud.cloudaccount.service.CloudAccountQueryController/list"
	CloudAccountQueryController_FindArtifactStoreCreateCloudAccounts_FullMethodName = "/cloud.planton.apis.v1.code2cloud.cloudaccount.service.CloudAccountQueryController/findArtifactStoreCreateCloudAccounts"
	CloudAccountQueryController_FindKubeClusterCreateCloudAccounts_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.cloudaccount.service.CloudAccountQueryController/findKubeClusterCreateCloudAccounts"
	CloudAccountQueryController_FindDnsZoneCreateCloudAccounts_FullMethodName       = "/cloud.planton.apis.v1.code2cloud.cloudaccount.service.CloudAccountQueryController/findDnsZoneCreateCloudAccounts"
)
...
type CloudAccountQueryControllerClient interface {
	...
	List(ctx context.Context, in *model2.PageInfo, opts ...grpc.CallOption) (*model.CloudAccountList, error)
	// todo: add authorization
...
func (c *cloudAccountQueryControllerClient) List(ctx context.Context, in *model2.PageInfo, opts ...grpc.CallOption) (*model.CloudAccountList, error) {
...
type CloudAccountQueryControllerServer interface {
	...
	// todo: add authorization
	// list all specifications for cloud-accounts  for the requested page. This is intended to be used on back-office portal.
	List(context.Context, *model2.PageInfo) (*model.CloudAccountList, error)
	// todo: add authorization
	// find cloud-accounts by company id to create artifact store.
	// this will be used to populate drop down of cloud-accounts in create artifact store form.
	// the response should only include cloud-accounts that a company is authorised to create artifact stores.
...
func (UnimplementedCloudAccountQueryControllerServer) List(context.Context, *model2.PageInfo) (*model.CloudAccountList, error) {
...
func _CloudAccountQueryController_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudAccountQueryControllerServer).List(ctx, req.(*model2.PageInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CloudAccountQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.cloudaccount.service.CloudAccountQueryController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/cloudaccount/service/query.proto",
}
