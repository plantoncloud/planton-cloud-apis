...
const (
	MicroserviceInstanceCommandController_Create_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController/create"
	MicroserviceInstanceCommandController_Update_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController/update"
	MicroserviceInstanceCommandController_Delete_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController/delete"
	MicroserviceInstanceCommandController_Restore_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController/restore"
	MicroserviceInstanceCommandController_Restart_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController/restart"
	MicroserviceInstanceCommandController_Pause_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController/pause"
	MicroserviceInstanceCommandController_Unpause_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController/unpause"
)
...
var MicroserviceInstanceCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceCommandController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/deploy/microservice/rpc/service.proto",
}

const (
	MicroserviceInstanceQueryController_List_FullMethodName                               = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/list"
	MicroserviceInstanceQueryController_GetById_FullMethodName                            = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/getById"
	MicroserviceInstanceQueryController_FindByProductId_FullMethodName                    = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/findByProductId"
	MicroserviceInstanceQueryController_FindByEnvironmentId_FullMethodName                = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/findByEnvironmentId"
	MicroserviceInstanceQueryController_FindByKubeClusterId_FullMethodName                = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/findByKubeClusterId"
	MicroserviceInstanceQueryController_FindByEnvironmentIdByCodeProjectId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/findByEnvironmentIdByCodeProjectId"
	MicroserviceInstanceQueryController_FindPods_FullMethodName                           = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/findPods"
	MicroserviceInstanceQueryController_GetLogStream_FullMethodName                       = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/getLogStream"
	MicroserviceInstanceQueryController_GetByCodeProjectId_FullMethodName                 = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/getByCodeProjectId"
	MicroserviceInstanceQueryController_FindByCodeProjectUrl_FullMethodName               = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/findByCodeProjectUrl"
	MicroserviceInstanceQueryController_GetEnvVarMap_FullMethodName                       = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController/getEnvVarMap"
)
...
type MicroserviceInstanceQueryControllerClient interface {
	...
	FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*MicroserviceInstances, error)
	// find microservice-instances by environment
	FindByEnvironmentId(ctx context.Context, in *rpc1.EnvironmentId, opts ...grpc.CallOption) (*MicroserviceInstances, error)
	// find microservice-instances by kube-cluster
	FindByKubeClusterId(ctx context.Context, in *rpc2.KubeClusterId, opts ...grpc.CallOption) (*MicroserviceInstances, error)
	...
	GetByCodeProjectId(ctx context.Context, in *rpc3.CodeProjectId, opts ...grpc.CallOption) (*MicroserviceInstance, error)
	// lookup all microservice-instances by code project url
	FindByCodeProjectUrl(ctx context.Context, in *rpc3.CodeProjectUrl, opts ...grpc.CallOption) (*MicroserviceInstances, error)
...
func (c *microserviceInstanceQueryControllerClient) FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*MicroserviceInstances, error) {
...
func (c *microserviceInstanceQueryControllerClient) FindByEnvironmentId(ctx context.Context, in *rpc1.EnvironmentId, opts ...grpc.CallOption) (*MicroserviceInstances, error) {
	out := new(MicroserviceInstances)
...
func (c *microserviceInstanceQueryControllerClient) FindByKubeClusterId(ctx context.Context, in *rpc2.KubeClusterId, opts ...grpc.CallOption) (*MicroserviceInstances, error) {
	out := new(MicroserviceInstances)
...
func (c *microserviceInstanceQueryControllerClient) GetByCodeProjectId(ctx context.Context, in *rpc3.CodeProjectId, opts ...grpc.CallOption) (*MicroserviceInstance, error) {
	out := new(MicroserviceInstance)
...
func (c *microserviceInstanceQueryControllerClient) FindByCodeProjectUrl(ctx context.Context, in *rpc3.CodeProjectUrl, opts ...grpc.CallOption) (*MicroserviceInstances, error) {
	out := new(MicroserviceInstances)
...
type MicroserviceInstanceQueryControllerServer interface {
	...
	// find microservice-instances by product id.
	// response contains only the resources that the authenticated user account has viewer access to.
	FindByProductId(context.Context, *rpc.ProductId) (*MicroserviceInstances, error)
	// find microservice-instances by environment
	FindByEnvironmentId(context.Context, *rpc1.EnvironmentId) (*MicroserviceInstances, error)
	// find microservice-instances by kube-cluster
	FindByKubeClusterId(context.Context, *rpc2.KubeClusterId) (*MicroserviceInstances, error)
	// find microservice-instances in a environment for a code-project
	...
	// lookup a microservice-instance by code project id
	GetByCodeProjectId(context.Context, *rpc3.CodeProjectId) (*MicroserviceInstance, error)
	// lookup all microservice-instances by code project url
	FindByCodeProjectUrl(context.Context, *rpc3.CodeProjectUrl) (*MicroserviceInstances, error)
...
func (UnimplementedMicroserviceInstanceQueryControllerServer) FindByProductId(context.Context, *rpc.ProductId) (*MicroserviceInstances, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByProductId not implemented")
}
func (UnimplementedMicroserviceInstanceQueryControllerServer) FindByEnvironmentId(context.Context, *rpc1.EnvironmentId) (*MicroserviceInstances, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByEnvironmentId not implemented")
}
func (UnimplementedMicroserviceInstanceQueryControllerServer) FindByKubeClusterId(context.Context, *rpc2.KubeClusterId) (*MicroserviceInstances, error) {
...
func (UnimplementedMicroserviceInstanceQueryControllerServer) GetByCodeProjectId(context.Context, *rpc3.CodeProjectId) (*MicroserviceInstance, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByCodeProjectId not implemented")
}
func (UnimplementedMicroserviceInstanceQueryControllerServer) FindByCodeProjectUrl(context.Context, *rpc3.CodeProjectUrl) (*MicroserviceInstances, error) {
...
func _MicroserviceInstanceQueryController_FindByProductId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MicroserviceInstanceQueryControllerServer).FindByProductId(ctx, req.(*rpc.ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MicroserviceInstanceQueryController_FindByEnvironmentId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MicroserviceInstanceQueryControllerServer).FindByEnvironmentId(ctx, req.(*rpc1.EnvironmentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MicroserviceInstanceQueryController_FindByKubeClusterId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MicroserviceInstanceQueryControllerServer).FindByKubeClusterId(ctx, req.(*rpc2.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MicroserviceInstanceQueryController_GetByCodeProjectId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MicroserviceInstanceQueryControllerServer).GetByCodeProjectId(ctx, req.(*rpc3.CodeProjectId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MicroserviceInstanceQueryController_FindByCodeProjectUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MicroserviceInstanceQueryControllerServer).FindByCodeProjectUrl(ctx, req.(*rpc3.CodeProjectUrl))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MicroserviceInstanceQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceQueryController",
...
const (
	MicroserviceInstanceStackController_Preview_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceStackController/preview"
	MicroserviceInstanceStackController_Apply_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceStackController/apply"
)
...
var MicroserviceInstanceStackController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.microservice.rpc.MicroserviceInstanceStackController",
