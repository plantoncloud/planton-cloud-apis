...
const (
	KubeClusterQueryController_List_FullMethodName                                    = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/list"
	KubeClusterQueryController_GetById_FullMethodName                                 = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/getById"
	KubeClusterQueryController_FindByCompanyId_FullMethodName                         = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/findByCompanyId"
	KubeClusterQueryController_FindByCloudAccountId_FullMethodName                    = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/findByCloudAccountId"
	KubeClusterQueryController_FindEnvironmentCreateKubeClusters_FullMethodName       = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/findEnvironmentCreateKubeClusters"
	KubeClusterQueryController_GetKubeClusterComponentsByKubeClusterId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/getKubeClusterComponentsByKubeClusterId"
	KubeClusterQueryController_FindWorkloadNamespacesByKubeClusterId_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/findWorkloadNamespacesByKubeClusterId"
	KubeClusterQueryController_FindWorkloadPodsByKubeClusterId_FullMethodName         = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/findWorkloadPodsByKubeClusterId"
	KubeClusterQueryController_FindSslCertificatesByKubeClusterId_FullMethodName      = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/findSslCertificatesByKubeClusterId"
	KubeClusterQueryController_GetPod_FullMethodName                                  = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/getPod"
	KubeClusterQueryController_GetPodLogStream_FullMethodName                         = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController/getPodLogStream"
)
...
type KubeClusterQueryControllerClient interface {
	...
	List(ctx context.Context, in *model.PageInfo, opts ...grpc.CallOption) (*model1.KubeClusterList, error)
	// lookup kube-cluster using kube-cluster id
	GetById(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*model1.KubeCluster, error)
	// find kube-clusters by company id
	FindByCompanyId(ctx context.Context, in *model2.CompanyId, opts ...grpc.CallOption) (*model1.KubeClusters, error)
	// find kube-clusters in a cloud account.
	FindByCloudAccountId(ctx context.Context, in *model3.CloudAccountId, opts ...grpc.CallOption) (*model1.KubeClusters, error)
	...
	FindEnvironmentCreateKubeClusters(ctx context.Context, in *model2.CompanyId, opts ...grpc.CallOption) (*model1.KubeClusters, error)
	// lookup components in a kube-cluster of a kube-cluster
	GetKubeClusterComponentsByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*model1.KubeClusterComponents, error)
	// find workload namespaces in a kube-cluster.
	FindWorkloadNamespacesByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*resource.WorkloadNamespaces, error)
	// find workload pods part of all environments hosted in a kube-cluster.
	FindWorkloadPodsByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*resource.WorkloadPods, error)
	// find workload pods part of all environments hosted in a kube-cluster.
	FindSslCertificatesByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*resource.Certificates, error)
	// get a pod details
	GetPod(ctx context.Context, in *model1.ByKubeClusterByNamespaceByPodInput, opts ...grpc.CallOption) (*resource.Pod, error)
	// get a log stream for a pod running in a kube-cluster kube-cluster
	GetPodLogStream(ctx context.Context, in *model1.ByKubeClusterByNamespaceByPodInput, opts ...grpc.CallOption) (KubeClusterQueryController_GetPodLogStreamClient, error)
}
...
func (c *kubeClusterQueryControllerClient) List(ctx context.Context, in *model.PageInfo, opts ...grpc.CallOption) (*model1.KubeClusterList, error) {
	out := new(model1.KubeClusterList)
...
func (c *kubeClusterQueryControllerClient) GetById(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*model1.KubeCluster, error) {
	out := new(model1.KubeCluster)
...
func (c *kubeClusterQueryControllerClient) FindByCompanyId(ctx context.Context, in *model2.CompanyId, opts ...grpc.CallOption) (*model1.KubeClusters, error) {
	out := new(model1.KubeClusters)
...
func (c *kubeClusterQueryControllerClient) FindByCloudAccountId(ctx context.Context, in *model3.CloudAccountId, opts ...grpc.CallOption) (*model1.KubeClusters, error) {
	out := new(model1.KubeClusters)
...
func (c *kubeClusterQueryControllerClient) FindEnvironmentCreateKubeClusters(ctx context.Context, in *model2.CompanyId, opts ...grpc.CallOption) (*model1.KubeClusters, error) {
	out := new(model1.KubeClusters)
...
func (c *kubeClusterQueryControllerClient) GetKubeClusterComponentsByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*model1.KubeClusterComponents, error) {
	out := new(model1.KubeClusterComponents)
...
func (c *kubeClusterQueryControllerClient) FindWorkloadNamespacesByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*resource.WorkloadNamespaces, error) {
...
func (c *kubeClusterQueryControllerClient) FindWorkloadPodsByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*resource.WorkloadPods, error) {
...
func (c *kubeClusterQueryControllerClient) FindSslCertificatesByKubeClusterId(ctx context.Context, in *model1.KubeClusterId, opts ...grpc.CallOption) (*resource.Certificates, error) {
...
func (c *kubeClusterQueryControllerClient) GetPod(ctx context.Context, in *model1.ByKubeClusterByNamespaceByPodInput, opts ...grpc.CallOption) (*resource.Pod, error) {
...
func (c *kubeClusterQueryControllerClient) GetPodLogStream(ctx context.Context, in *model1.ByKubeClusterByNamespaceByPodInput, opts ...grpc.CallOption) (KubeClusterQueryController_GetPodLogStreamClient, error) {
...
type KubeClusterQueryControllerServer interface {
	// list all kube-clusters on planton cloud for the requested page. This is intended for use on portal.
	List(context.Context, *model.PageInfo) (*model1.KubeClusterList, error)
	// lookup kube-cluster using kube-cluster id
	GetById(context.Context, *model1.KubeClusterId) (*model1.KubeCluster, error)
	// find kube-clusters by company id
	FindByCompanyId(context.Context, *model2.CompanyId) (*model1.KubeClusters, error)
	// find kube-clusters in a cloud account.
	FindByCloudAccountId(context.Context, *model3.CloudAccountId) (*model1.KubeClusters, error)
	// find kube-clusters by company id to create environment.
	// this will be used to populate drop down of kube-clusters in create environment form.
	// the response should only include kube-clusters that a company is authorised to create environment.
	// the authorization is verified by looking up kube-clusters with `company-environment-creator` relation with the company id provided in input.
	FindEnvironmentCreateKubeClusters(context.Context, *model2.CompanyId) (*model1.KubeClusters, error)
	// lookup components in a kube-cluster of a kube-cluster
	GetKubeClusterComponentsByKubeClusterId(context.Context, *model1.KubeClusterId) (*model1.KubeClusterComponents, error)
	// find workload namespaces in a kube-cluster.
	FindWorkloadNamespacesByKubeClusterId(context.Context, *model1.KubeClusterId) (*resource.WorkloadNamespaces, error)
	// find workload pods part of all environments hosted in a kube-cluster.
	FindWorkloadPodsByKubeClusterId(context.Context, *model1.KubeClusterId) (*resource.WorkloadPods, error)
	// find workload pods part of all environments hosted in a kube-cluster.
	FindSslCertificatesByKubeClusterId(context.Context, *model1.KubeClusterId) (*resource.Certificates, error)
	// get a pod details
	GetPod(context.Context, *model1.ByKubeClusterByNamespaceByPodInput) (*resource.Pod, error)
	// get a log stream for a pod running in a kube-cluster kube-cluster
	GetPodLogStream(*model1.ByKubeClusterByNamespaceByPodInput, KubeClusterQueryController_GetPodLogStreamServer) error
}
...
func (UnimplementedKubeClusterQueryControllerServer) List(context.Context, *model.PageInfo) (*model1.KubeClusterList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) GetById(context.Context, *model1.KubeClusterId) (*model1.KubeCluster, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) FindByCompanyId(context.Context, *model2.CompanyId) (*model1.KubeClusters, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByCompanyId not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) FindByCloudAccountId(context.Context, *model3.CloudAccountId) (*model1.KubeClusters, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByCloudAccountId not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) FindEnvironmentCreateKubeClusters(context.Context, *model2.CompanyId) (*model1.KubeClusters, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindEnvironmentCreateKubeClusters not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) GetKubeClusterComponentsByKubeClusterId(context.Context, *model1.KubeClusterId) (*model1.KubeClusterComponents, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetKubeClusterComponentsByKubeClusterId not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) FindWorkloadNamespacesByKubeClusterId(context.Context, *model1.KubeClusterId) (*resource.WorkloadNamespaces, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindWorkloadNamespacesByKubeClusterId not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) FindWorkloadPodsByKubeClusterId(context.Context, *model1.KubeClusterId) (*resource.WorkloadPods, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindWorkloadPodsByKubeClusterId not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) FindSslCertificatesByKubeClusterId(context.Context, *model1.KubeClusterId) (*resource.Certificates, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindSslCertificatesByKubeClusterId not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) GetPod(context.Context, *model1.ByKubeClusterByNamespaceByPodInput) (*resource.Pod, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPod not implemented")
}
func (UnimplementedKubeClusterQueryControllerServer) GetPodLogStream(*model1.ByKubeClusterByNamespaceByPodInput, KubeClusterQueryController_GetPodLogStreamServer) error {
...
func _KubeClusterQueryController_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).List(ctx, req.(*model.PageInfo))
	}
...
func _KubeClusterQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).GetById(ctx, req.(*model1.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_FindByCompanyId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).FindByCompanyId(ctx, req.(*model2.CompanyId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_FindByCloudAccountId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).FindByCloudAccountId(ctx, req.(*model3.CloudAccountId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_FindEnvironmentCreateKubeClusters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).FindEnvironmentCreateKubeClusters(ctx, req.(*model2.CompanyId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_GetKubeClusterComponentsByKubeClusterId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).GetKubeClusterComponentsByKubeClusterId(ctx, req.(*model1.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_FindWorkloadNamespacesByKubeClusterId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).FindWorkloadNamespacesByKubeClusterId(ctx, req.(*model1.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_FindWorkloadPodsByKubeClusterId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).FindWorkloadPodsByKubeClusterId(ctx, req.(*model1.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_FindSslCertificatesByKubeClusterId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).FindSslCertificatesByKubeClusterId(ctx, req.(*model1.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KubeClusterQueryController_GetPod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model1.ByKubeClusterByNamespaceByPodInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterQueryControllerServer).GetPod(ctx, req.(*model1.ByKubeClusterByNamespaceByPodInput))
	}
	return interceptor(ctx, in, info, handler)
}

func _KubeClusterQueryController_GetPodLogStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(model1.ByKubeClusterByNamespaceByPodInput)
...
var KubeClusterQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterQueryController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/deploy/kubecluster/service/query.proto",
}

const (
	KubeClusterNodePoolGcpQueryController_GetByGcpContainerNodePoolId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterNodePoolGcpQueryController/getByGcpContainerNodePoolId"
)
...
type KubeClusterNodePoolGcpQueryControllerClient interface {
	...
	GetByGcpContainerNodePoolId(ctx context.Context, in *model1.GetByKubeClusterNodePoolGcpIdInput, opts ...grpc.CallOption) (*model1.KubeClusterNodePoolGcp, error)
}
...
func (c *kubeClusterNodePoolGcpQueryControllerClient) GetByGcpContainerNodePoolId(ctx context.Context, in *model1.GetByKubeClusterNodePoolGcpIdInput, opts ...grpc.CallOption) (*model1.KubeClusterNodePoolGcp, error) {
	out := new(model1.KubeClusterNodePoolGcp)
...
type KubeClusterNodePoolGcpQueryControllerServer interface {
	// lookup gcp container node pool env using container-nodepool-id
	GetByGcpContainerNodePoolId(context.Context, *model1.GetByKubeClusterNodePoolGcpIdInput) (*model1.KubeClusterNodePoolGcp, error)
}
...
func (UnimplementedKubeClusterNodePoolGcpQueryControllerServer) GetByGcpContainerNodePoolId(context.Context, *model1.GetByKubeClusterNodePoolGcpIdInput) (*model1.KubeClusterNodePoolGcp, error) {
...
func _KubeClusterNodePoolGcpQueryController_GetByGcpContainerNodePoolId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model1.GetByKubeClusterNodePoolGcpIdInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeClusterNodePoolGcpQueryControllerServer).GetByGcpContainerNodePoolId(ctx, req.(*model1.GetByKubeClusterNodePoolGcpIdInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KubeClusterNodePoolGcpQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.KubeClusterNodePoolGcpQueryController",
...
const (
	GcpQueryController_FindRegions_FullMethodName                 = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.GcpQueryController/findRegions"
	GcpQueryController_FindZonesByRegionIdentifier_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.GcpQueryController/findZonesByRegionIdentifier"
)
...
type GcpQueryControllerClient interface {
	...
	FindRegions(ctx context.Context, in *custom.CustomEmpty, opts ...grpc.CallOption) (*model1.GcpRegions, error)
	// list all zones in a gcp region
	FindZonesByRegionIdentifier(ctx context.Context, in *model1.GcpRegionIdentifier, opts ...grpc.CallOption) (*model1.GcpZones, error)
}
...
func (c *gcpQueryControllerClient) FindRegions(ctx context.Context, in *custom.CustomEmpty, opts ...grpc.CallOption) (*model1.GcpRegions, error) {
	out := new(model1.GcpRegions)
...
func (c *gcpQueryControllerClient) FindZonesByRegionIdentifier(ctx context.Context, in *model1.GcpRegionIdentifier, opts ...grpc.CallOption) (*model1.GcpZones, error) {
	out := new(model1.GcpZones)
...
type GcpQueryControllerServer interface {
	// list all gcp regions
	FindRegions(context.Context, *custom.CustomEmpty) (*model1.GcpRegions, error)
	// list all zones in a gcp region
	FindZonesByRegionIdentifier(context.Context, *model1.GcpRegionIdentifier) (*model1.GcpZones, error)
}
...
func (UnimplementedGcpQueryControllerServer) FindRegions(context.Context, *custom.CustomEmpty) (*model1.GcpRegions, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindRegions not implemented")
}
func (UnimplementedGcpQueryControllerServer) FindZonesByRegionIdentifier(context.Context, *model1.GcpRegionIdentifier) (*model1.GcpZones, error) {
...
func _GcpQueryController_FindZonesByRegionIdentifier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model1.GcpRegionIdentifier)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GcpQueryControllerServer).FindZonesByRegionIdentifier(ctx, req.(*model1.GcpRegionIdentifier))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GcpQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.kubecluster.service.GcpQueryController",
