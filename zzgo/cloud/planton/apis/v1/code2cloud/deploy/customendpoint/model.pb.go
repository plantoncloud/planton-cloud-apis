...
func (x *CreateStackJobInput) Reset() {
	*x = CreateStackJobInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateStackJobInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_rawDescGZIP(), []int{11}
}
...
func (x *CreateStackJobInput) GetStackJobOperationType() operationtype.StackJobOperationType {
	if x != nil {
...
var file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x73, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xbc, 0x01, 0x0a, 0x13,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62, 0x49, 0x6e,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x42, 0xbc, 0x03, 0x0a, 0x44, 0x62,
...
var file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_goTypes = []interface{}{
	...
	(*CreateStackJobInput)(nil),                            // 11: cloud.planton.apis.v1.code2cloud.deploy.customendpoint.CreateStackJobInput
...
var file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_depIdxs = []int32{
	12, // 0: cloud.planton.apis.v1.code2cloud.deploy.customendpoint.CustomEndpoint.metadata:type_name -> cloud.planton.apis.v1.commons.resource.Metadata
	...
	13, // 4: cloud.planton.apis.v1.code2cloud.deploy.customendpoint.CustomEndpointStatus.lifecycle:type_name -> cloud.planton.apis.v1.commons.resource.ResourceLifecycle
	14, // 5: cloud.planton.apis.v1.code2cloud.deploy.customendpoint.CustomEndpointStatus.audit:type_name -> cloud.planton.apis.v1.commons.audit.ResourceAudit
	...
	15, // 9: cloud.planton.apis.v1.code2cloud.deploy.customendpoint.CreateStackJobInput.stack_job_operation_type:type_name -> cloud.planton.apis.v1.stack.job.enums.operationtype.StackJobOperationType
...
func file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cloud_planton_apis_v1_code2cloud_deploy_customendpoint_model_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
