...
const (
	DnsZoneCommandController_Create_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneCommandController/create"
	DnsZoneCommandController_Update_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneCommandController/update"
	DnsZoneCommandController_Delete_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneCommandController/delete"
	DnsZoneCommandController_Restore_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneCommandController/restore"
)
...
var DnsZoneCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneCommandController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/deploy/dnszone/rpc/service.proto",
}

const (
	DnsZoneQueryController_FindByCompanyId_FullMethodName                     = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneQueryController/findByCompanyId"
	DnsZoneQueryController_GetById_FullMethodName                             = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneQueryController/getById"
	DnsZoneQueryController_GetExactOrParentDnsZoneByDomainName_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneQueryController/getExactOrParentDnsZoneByDomainName"
	DnsZoneQueryController_List_FullMethodName                                = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneQueryController/list"
	DnsZoneQueryController_IsNameserversDelegated_FullMethodName              = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneQueryController/isNameserversDelegated"
)
...
type DnsZoneQueryControllerClient interface {
	...
	FindByCompanyId(ctx context.Context, in *rpc.CompanyId, opts ...grpc.CallOption) (*DnsZones, error)
	// todo: add authorization
...
func (c *dnsZoneQueryControllerClient) FindByCompanyId(ctx context.Context, in *rpc.CompanyId, opts ...grpc.CallOption) (*DnsZones, error) {
	out := new(DnsZones)
...
type DnsZoneQueryControllerServer interface {
	...
	// find dns-zones by company id
	// the response should only include dns-zones in a company that the authenticated user account has viewer access to.
	FindByCompanyId(context.Context, *rpc.CompanyId) (*DnsZones, error)
	// todo: add authorization
	// get details of a dns-zone id
...
func (UnimplementedDnsZoneQueryControllerServer) FindByCompanyId(context.Context, *rpc.CompanyId) (*DnsZones, error) {
...
func _DnsZoneQueryController_FindByCompanyId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DnsZoneQueryControllerServer).FindByCompanyId(ctx, req.(*rpc.CompanyId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DnsZoneQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneQueryController",
...
const (
	DnsRecordCommandController_Add_FullMethodName    = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsRecordCommandController/add"
	DnsRecordCommandController_Update_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsRecordCommandController/update"
	DnsRecordCommandController_Delete_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsRecordCommandController/delete"
)
...
var DnsRecordCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsRecordCommandController",
...
const (
	DnsZoneStackController_Preview_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneStackController/preview"
	DnsZoneStackController_Apply_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneStackController/apply"
)
...
var DnsZoneStackController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.dnszone.rpc.DnsZoneStackController",
