...
const (
	DnsZoneQueryController_FindByCompanyId_FullMethodName                     = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.service.DnsZoneQueryController/findByCompanyId"
	DnsZoneQueryController_GetById_FullMethodName                             = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.service.DnsZoneQueryController/getById"
	DnsZoneQueryController_GetExactOrParentDnsZoneByDomainName_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.service.DnsZoneQueryController/getExactOrParentDnsZoneByDomainName"
	DnsZoneQueryController_List_FullMethodName                                = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.service.DnsZoneQueryController/list"
	DnsZoneQueryController_IsNameserversDelegated_FullMethodName              = "/cloud.planton.apis.v1.code2cloud.deploy.dnszone.service.DnsZoneQueryController/isNameserversDelegated"
)
...
type DnsZoneQueryControllerClient interface {
	...
	List(ctx context.Context, in *model2.PageInfo, opts ...grpc.CallOption) (*model1.DnsZoneList, error)
	// todo: add authorization
...
func (c *dnsZoneQueryControllerClient) List(ctx context.Context, in *model2.PageInfo, opts ...grpc.CallOption) (*model1.DnsZoneList, error) {
...
type DnsZoneQueryControllerServer interface {
	...
	// todo: add authorization
	// list all dns-zones for the requested page. This is intended to be used on back-office portal.
	List(context.Context, *model2.PageInfo) (*model1.DnsZoneList, error)
	// todo: add authorization
	// checks if the nameservers for the dns-zone are resolving to the nameservers of the managed zone.
...
func (UnimplementedDnsZoneQueryControllerServer) List(context.Context, *model2.PageInfo) (*model1.DnsZoneList, error) {
...
func _DnsZoneQueryController_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DnsZoneQueryControllerServer).List(ctx, req.(*model2.PageInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DnsZoneQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.dnszone.service.DnsZoneQueryController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/deploy/dnszone/service/query.proto",
}
