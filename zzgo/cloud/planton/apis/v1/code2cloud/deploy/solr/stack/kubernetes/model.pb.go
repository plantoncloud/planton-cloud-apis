...
import (
	state "github.com/plantoncloud/planton-cloud-apis/zzgo/cloud/planton/apis/v1/code2cloud/deploy/solr/state"
...
func (x *SolrCloudKubernetesStackInput) GetStackJob() *rpc.StackJob {
	if x != nil {
		return x.StackJob
	}
	return nil
...
func (x *SolrCloudKubernetesStackCredentialsInput) GetKubernetes() *rpc1.KubernetesProviderCredential {
	if x != nil {
		return x.Kubernetes
	}
	return nil
...
type SolrCloudKubernetesStackResourceInput struct {
	...
	// solr-cloud
	SolrCloud *state.SolrCloudState `protobuf:"bytes,1,opt,name=solr_cloud,json=solrCloud,proto3" json:"solr_cloud,omitempty"`
}
...
func (x *SolrCloudKubernetesStackResourceInput) GetSolrCloud() *state.SolrCloudState {
	if x != nil {
		return x.SolrCloud
	}
	return nil
...
type SolrCloudKubernetesStackOutputs struct {
	...
	SolrCloudStatus *state.SolrCloudStatusState `protobuf:"bytes,1,opt,name=solr_cloud_status,json=solrCloudStatus,proto3" json:"solr_cloud_status,omitempty"`
}
...
func (x *SolrCloudKubernetesStackOutputs) GetSolrCloudStatus() *state.SolrCloudStatusState {
	if x != nil {
...
func (x *SolrCloudKubernetesStackResponse) GetProgressEvent() *rpc.StackJobProgressEvent {
	if x != nil {
...
var file_cloud_planton_apis_v1_code2cloud_deploy_solr_stack_kubernetes_model_proto_rawDesc = []byte{
	...
	0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x1a, 0x3e, 0x63, 0x6c, 0x6f, 0x75,
	...
	0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x3e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x70,
	...
	0x2f, 0x73, 0x6f, 0x6c, 0x72, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2f, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x03, 0x0a, 0x1d, 0x53, 0x6f, 0x6c, 0x72,
	0x43, 0x6c, 0x6f, 0x75, 0x64, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53,
	0x74, 0x61, 0x63, 0x6b, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x46, 0x0a, 0x09, 0x73, 0x74, 0x61,
	0x63, 0x6b, 0x5f, 0x6a, 0x6f, 0x62, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x63,
	...
	0x62, 0x12, 0x94, 0x01, 0x0a, 0x11, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c,
	0x73, 0x5f, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x67, 0x2e,
	...
	0x61, 0x6c, 0x73, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x8b, 0x01, 0x0a, 0x0e, 0x72, 0x65, 0x73,
	...
	0x73, 0x2e, 0x53, 0x6f, 0x6c, 0x72, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x4b, 0x75, 0x62, 0x65, 0x72,
	...
	0x65, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x22, 0x9c, 0x01, 0x0a, 0x28, 0x53, 0x6f, 0x6c, 0x72, 0x43,
	...
	0x70, 0x75, 0x74, 0x12, 0x70, 0x0a, 0x0a, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65,
	...
	0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x4b, 0x75, 0x62,
	...
	0x6e, 0x65, 0x74, 0x65, 0x73, 0x22, 0x8a, 0x01, 0x0a, 0x25, 0x53, 0x6f, 0x6c, 0x72, 0x43, 0x6c,
	...
	0x61, 0x0a, 0x0a, 0x73, 0x6f, 0x6c, 0x72, 0x5f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x18, 0x01, 0x20,
	...
	0x6c, 0x72, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x53, 0x6f, 0x6c, 0x72, 0x43, 0x6c, 0x6f,
	0x75, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x09, 0x73, 0x6f, 0x6c, 0x72, 0x43, 0x6c, 0x6f,
	0x75, 0x64, 0x22, 0x97, 0x01, 0x0a, 0x1f, 0x53, 0x6f, 0x6c, 0x72, 0x43, 0x6c, 0x6f, 0x75, 0x64,
	0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x4f,
	0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x12, 0x74, 0x0a, 0x11, 0x73, 0x6f, 0x6c, 0x72, 0x5f, 0x63,
	0x6c, 0x6f, 0x75, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x0f, 0x73, 0x6f, 0x6c,
	0x72, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xfb, 0x01, 0x0a,
	0x20, 0x53, 0x6f, 0x6c, 0x72, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	0x65, 0x74, 0x65, 0x73, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x5d, 0x0a, 0x0e, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	...
	0x12, 0x78, 0x0a, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x79, 0x2f, 0x73, 0x6f, 0x6c, 0x72, 0x2f, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x2f, 0x6b, 0x75, 0x62,
	0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0xa2, 0x02, 0x09, 0x43, 0x50, 0x41, 0x56, 0x43, 0x44,
	0x53, 0x53, 0x4b, 0xaa, 0x02, 0x3d, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x50, 0x6c, 0x61, 0x6e,
	...
	0x74, 0x65, 0x73, 0xca, 0x02, 0x3d, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x50, 0x6c, 0x61, 0x6e,
	...
	0x6c, 0x72, 0x5c, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x5c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65,
	0x74, 0x65, 0x73, 0xe2, 0x02, 0x49, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x50, 0x6c, 0x61, 0x6e,
	0x74, 0x6f, 0x6e, 0x5c, 0x41, 0x70, 0x69, 0x73, 0x5c, 0x56, 0x31, 0x5c, 0x43, 0x6f, 0x64, 0x65,
	0x32, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x5c, 0x53, 0x6f,
	0x6c, 0x72, 0x5c, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x5c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65,
	...
	0x53, 0x6f, 0x6c, 0x72, 0x3a, 0x3a, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x3a, 0x3a, 0x4b, 0x75, 0x62,
...
var file_cloud_planton_apis_v1_code2cloud_deploy_solr_stack_kubernetes_model_proto_goTypes = []interface{}{
	...
	(*state.SolrCloudState)(nil),                     // 7: cloud.planton.apis.v1.code2cloud.deploy.solr.state.SolrCloudState
	(*state.SolrCloudStatusState)(nil),               // 8: cloud.planton.apis.v1.code2cloud.deploy.solr.state.SolrCloudStatusState
...
var file_cloud_planton_apis_v1_code2cloud_deploy_solr_stack_kubernetes_model_proto_depIdxs = []int32{
	5, // 0: cloud.planton.apis.v1.code2cloud.deploy.solr.stack.kubernetes.SolrCloudKubernetesStackInput.stack_job:type_name -> cloud.planton.apis.v1.stack.rpc.StackJob
	...
	6, // 3: cloud.planton.apis.v1.code2cloud.deploy.solr.stack.kubernetes.SolrCloudKubernetesStackCredentialsInput.kubernetes:type_name -> cloud.planton.apis.v1.commons.pulumi.operation.rpc.KubernetesProviderCredential
	7, // 4: cloud.planton.apis.v1.code2cloud.deploy.solr.stack.kubernetes.SolrCloudKubernetesStackResourceInput.solr_cloud:type_name -> cloud.planton.apis.v1.code2cloud.deploy.solr.state.SolrCloudState
	8, // 5: cloud.planton.apis.v1.code2cloud.deploy.solr.stack.kubernetes.SolrCloudKubernetesStackOutputs.solr_cloud_status:type_name -> cloud.planton.apis.v1.code2cloud.deploy.solr.state.SolrCloudStatusState
	9, // 6: cloud.planton.apis.v1.code2cloud.deploy.solr.stack.kubernetes.SolrCloudKubernetesStackResponse.progress_event:type_name -> cloud.planton.apis.v1.stack.rpc.StackJobProgressEvent
