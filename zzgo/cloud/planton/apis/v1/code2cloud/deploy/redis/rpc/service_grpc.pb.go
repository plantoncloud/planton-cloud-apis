...
const (
	RedisClusterCommandController_Create_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController/create"
	RedisClusterCommandController_Update_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController/update"
	RedisClusterCommandController_Delete_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController/delete"
	RedisClusterCommandController_Restore_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController/restore"
	RedisClusterCommandController_Restart_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController/restart"
	RedisClusterCommandController_Pause_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController/pause"
	RedisClusterCommandController_Unpause_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController/unpause"
)
...
var RedisClusterCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterCommandController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/deploy/redis/rpc/service.proto",
}

const (
	RedisClusterQueryController_List_FullMethodName                = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController/list"
	RedisClusterQueryController_GetById_FullMethodName             = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController/getById"
	RedisClusterQueryController_FindByProductId_FullMethodName     = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController/findByProductId"
	RedisClusterQueryController_FindByEnvironmentId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController/findByEnvironmentId"
	RedisClusterQueryController_FindByKubeClusterId_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController/findByKubeClusterId"
	RedisClusterQueryController_GetPassword_FullMethodName         = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController/getPassword"
	RedisClusterQueryController_FindPods_FullMethodName            = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController/findPods"
)
...
type RedisClusterQueryControllerClient interface {
	...
	FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*RedisClusters, error)
	// find redis-clusters by environment
	FindByEnvironmentId(ctx context.Context, in *rpc1.EnvironmentId, opts ...grpc.CallOption) (*RedisClusters, error)
	FindByKubeClusterId(ctx context.Context, in *rpc2.KubeClusterId, opts ...grpc.CallOption) (*RedisClusters, error)
...
func (c *redisClusterQueryControllerClient) FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*RedisClusters, error) {
...
func (c *redisClusterQueryControllerClient) FindByEnvironmentId(ctx context.Context, in *rpc1.EnvironmentId, opts ...grpc.CallOption) (*RedisClusters, error) {
	out := new(RedisClusters)
...
func (c *redisClusterQueryControllerClient) FindByKubeClusterId(ctx context.Context, in *rpc2.KubeClusterId, opts ...grpc.CallOption) (*RedisClusters, error) {
	out := new(RedisClusters)
...
type RedisClusterQueryControllerServer interface {
	...
	// find redis-clusters by product id.
	// response contains only the resources that the authenticated user account has viewer access to.
	FindByProductId(context.Context, *rpc.ProductId) (*RedisClusters, error)
	// find redis-clusters by environment
	FindByEnvironmentId(context.Context, *rpc1.EnvironmentId) (*RedisClusters, error)
	FindByKubeClusterId(context.Context, *rpc2.KubeClusterId) (*RedisClusters, error)
	// look up redis-cluster sasl password
	// password is retrieved from the kubernetes cluster.
...
func (UnimplementedRedisClusterQueryControllerServer) FindByProductId(context.Context, *rpc.ProductId) (*RedisClusters, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByProductId not implemented")
}
func (UnimplementedRedisClusterQueryControllerServer) FindByEnvironmentId(context.Context, *rpc1.EnvironmentId) (*RedisClusters, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByEnvironmentId not implemented")
}
func (UnimplementedRedisClusterQueryControllerServer) FindByKubeClusterId(context.Context, *rpc2.KubeClusterId) (*RedisClusters, error) {
...
func _RedisClusterQueryController_FindByProductId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RedisClusterQueryControllerServer).FindByProductId(ctx, req.(*rpc.ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RedisClusterQueryController_FindByEnvironmentId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RedisClusterQueryControllerServer).FindByEnvironmentId(ctx, req.(*rpc1.EnvironmentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RedisClusterQueryController_FindByKubeClusterId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RedisClusterQueryControllerServer).FindByKubeClusterId(ctx, req.(*rpc2.KubeClusterId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RedisClusterQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterQueryController",
...
const (
	RedisClusterStackController_Preview_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterStackController/preview"
	RedisClusterStackController_Apply_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterStackController/apply"
)
...
var RedisClusterStackController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.redis.rpc.RedisClusterStackController",
