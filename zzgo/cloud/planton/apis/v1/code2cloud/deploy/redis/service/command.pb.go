...
var file_cloud_planton_apis_v1_code2cloud_deploy_redis_service_command_proto_depIdxs = []int32{
	...
	1,  // 4: cloud.planton.apis.v1.code2cloud.deploy.redis.service.RedisClusterCommandController.previewDelete:input_type -> cloud.planton.apis.v1.commons.resource.model.ApiResourceDeleteCommandInput
	1,  // 5: cloud.planton.apis.v1.code2cloud.deploy.redis.service.RedisClusterCommandController.delete:input_type -> cloud.planton.apis.v1.commons.resource.model.ApiResourceDeleteCommandInput
	...
	6,  // 12: cloud.planton.apis.v1.code2cloud.deploy.redis.service.RedisClusterCommandController.previewRefresh:input_type -> cloud.planton.apis.v1.commons.resource.model.ApiResourceRefreshCommandInput
	6,  // 13: cloud.planton.apis.v1.code2cloud.deploy.redis.service.RedisClusterCommandController.refresh:input_type -> cloud.planton.apis.v1.commons.resource.model.ApiResourceRefreshCommandInput
