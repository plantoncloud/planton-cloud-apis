...
const (
	RedisClusterKubernetesStackController_Execute_FullMethodName         = "/cloud.planton.apis.v1.code2cloud.deploy.redis.stack.kubernetes.RedisClusterKubernetesStackController/execute"
	RedisClusterKubernetesStackController_GetStackOutputs_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.redis.stack.kubernetes.RedisClusterKubernetesStackController/getStackOutputs"
)
...
type RedisClusterKubernetesStackControllerClient interface {
	Execute(ctx context.Context, in *RedisClusterKubernetesStackInput, opts ...grpc.CallOption) (RedisClusterKubernetesStackController_ExecuteClient, error)
	GetStackOutputs(ctx context.Context, in *RedisClusterKubernetesStackInput, opts ...grpc.CallOption) (*RedisClusterKubernetesStackOutputs, error)
}
...
func (c *redisClusterKubernetesStackControllerClient) Execute(ctx context.Context, in *RedisClusterKubernetesStackInput, opts ...grpc.CallOption) (RedisClusterKubernetesStackController_ExecuteClient, error) {
...
type RedisClusterKubernetesStackController_ExecuteClient interface {
	Recv() (*RedisClusterKubernetesStackResponse, error)
	grpc.ClientStream
}
...
func (x *redisClusterKubernetesStackControllerExecuteClient) Recv() (*RedisClusterKubernetesStackResponse, error) {
	m := new(RedisClusterKubernetesStackResponse)
...
func (c *redisClusterKubernetesStackControllerClient) GetStackOutputs(ctx context.Context, in *RedisClusterKubernetesStackInput, opts ...grpc.CallOption) (*RedisClusterKubernetesStackOutputs, error) {
	out := new(RedisClusterKubernetesStackOutputs)
...
type RedisClusterKubernetesStackControllerServer interface {
	Execute(*RedisClusterKubernetesStackInput, RedisClusterKubernetesStackController_ExecuteServer) error
	GetStackOutputs(context.Context, *RedisClusterKubernetesStackInput) (*RedisClusterKubernetesStackOutputs, error)
}
...
func (UnimplementedRedisClusterKubernetesStackControllerServer) Execute(*RedisClusterKubernetesStackInput, RedisClusterKubernetesStackController_ExecuteServer) error {
	return status.Errorf(codes.Unimplemented, "method Execute not implemented")
}
func (UnimplementedRedisClusterKubernetesStackControllerServer) GetStackOutputs(context.Context, *RedisClusterKubernetesStackInput) (*RedisClusterKubernetesStackOutputs, error) {
...
func _RedisClusterKubernetesStackController_Execute_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(RedisClusterKubernetesStackInput)
...
type RedisClusterKubernetesStackController_ExecuteServer interface {
	Send(*RedisClusterKubernetesStackResponse) error
	grpc.ServerStream
}
...
func (x *redisClusterKubernetesStackControllerExecuteServer) Send(m *RedisClusterKubernetesStackResponse) error {
...
func _RedisClusterKubernetesStackController_GetStackOutputs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RedisClusterKubernetesStackInput)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RedisClusterKubernetesStackControllerServer).GetStackOutputs(ctx, req.(*RedisClusterKubernetesStackInput))
	}
...
var RedisClusterKubernetesStackController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.redis.stack.kubernetes.RedisClusterKubernetesStackController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/deploy/redis/stack/kubernetes/service.proto",
}
