...
const (
	StandardEndpointCommandController_Create_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointCommandController/create"
	StandardEndpointCommandController_Update_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointCommandController/update"
	StandardEndpointCommandController_Delete_FullMethodName  = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointCommandController/delete"
	StandardEndpointCommandController_Restore_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointCommandController/restore"
)
...
var StandardEndpointCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointCommandController",
	...
	Metadata: "cloud/planton/apis/v1/code2cloud/deploy/endpoint/standard/rpc/service.proto",
}

const (
	StandardEndpointQueryController_List_FullMethodName                                   = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointQueryController/list"
	StandardEndpointQueryController_GetById_FullMethodName                                = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointQueryController/getById"
	StandardEndpointQueryController_FindByProductId_FullMethodName                        = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointQueryController/findByProductId"
	StandardEndpointQueryController_FindByEnvironmentId_FullMethodName                    = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointQueryController/findByEnvironmentId"
	StandardEndpointQueryController_FindStandardEndpointCertificates_FullMethodName       = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointQueryController/findStandardEndpointCertificates"
	StandardEndpointQueryController_GetStandardEndpointDsnResolutionStatus_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointQueryController/getStandardEndpointDsnResolutionStatus"
)
...
type StandardEndpointQueryControllerClient interface {
	...
	FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*StandardEndpoints, error)
	// find standard-endpoints by environment id.
	// response contains only the endpoint domains that the authenticated user account id as viewer access to.
	FindByEnvironmentId(ctx context.Context, in *rpc1.EnvironmentId, opts ...grpc.CallOption) (*StandardEndpoints, error)
...
func (c *standardEndpointQueryControllerClient) FindByProductId(ctx context.Context, in *rpc.ProductId, opts ...grpc.CallOption) (*StandardEndpoints, error) {
...
func (c *standardEndpointQueryControllerClient) FindByEnvironmentId(ctx context.Context, in *rpc1.EnvironmentId, opts ...grpc.CallOption) (*StandardEndpoints, error) {
	out := new(StandardEndpoints)
...
type StandardEndpointQueryControllerServer interface {
	...
	// find standard-endpoints by product id.
	// response contains only the endpoint domains that the authenticated user account id as viewer access to.
	FindByProductId(context.Context, *rpc.ProductId) (*StandardEndpoints, error)
	// find standard-endpoints by environment id.
	// response contains only the endpoint domains that the authenticated user account id as viewer access to.
	FindByEnvironmentId(context.Context, *rpc1.EnvironmentId) (*StandardEndpoints, error)
	// find certificates for standard-endpoint
...
func (UnimplementedStandardEndpointQueryControllerServer) FindByProductId(context.Context, *rpc.ProductId) (*StandardEndpoints, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByProductId not implemented")
}
func (UnimplementedStandardEndpointQueryControllerServer) FindByEnvironmentId(context.Context, *rpc1.EnvironmentId) (*StandardEndpoints, error) {
...
func _StandardEndpointQueryController_FindByProductId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StandardEndpointQueryControllerServer).FindByProductId(ctx, req.(*rpc.ProductId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StandardEndpointQueryController_FindByEnvironmentId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StandardEndpointQueryControllerServer).FindByEnvironmentId(ctx, req.(*rpc1.EnvironmentId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StandardEndpointQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointQueryController",
...
const (
	StandardEndpointStackController_Preview_FullMethodName = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointStackController/preview"
	StandardEndpointStackController_Apply_FullMethodName   = "/cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointStackController/apply"
)
...
var StandardEndpointStackController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.code2cloud.deploy.endpoint.standard.rpc.StandardEndpointStackController",
