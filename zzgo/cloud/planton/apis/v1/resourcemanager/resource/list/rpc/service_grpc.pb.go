...
const (
	ResourceListViewQueryController_ListByResourceType_FullMethodName = "/cloud.planton.apis.v1.resourcemanager.resource.list.rpc.ResourceListViewQueryController/listByResourceType"
)
...
type ResourceListViewQueryControllerClient interface {
	...
	ListByResourceType(ctx context.Context, in *rpc.GetByResourceTypeInput, opts ...grpc.CallOption) (*rpc.RecordList, error)
}
...
func (c *resourceListViewQueryControllerClient) ListByResourceType(ctx context.Context, in *rpc.GetByResourceTypeInput, opts ...grpc.CallOption) (*rpc.RecordList, error) {
	out := new(rpc.RecordList)
...
type ResourceListViewQueryControllerServer interface {
	...
	// the input search parameters. Each resource in the list should match the specified resource type,
	// and be associated with the specified company and product.
	ListByResourceType(context.Context, *rpc.GetByResourceTypeInput) (*rpc.RecordList, error)
}
...
func (UnimplementedResourceListViewQueryControllerServer) ListByResourceType(context.Context, *rpc.GetByResourceTypeInput) (*rpc.RecordList, error) {
...
func _ResourceListViewQueryController_ListByResourceType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(rpc.GetByResourceTypeInput)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceListViewQueryControllerServer).ListByResourceType(ctx, req.(*rpc.GetByResourceTypeInput))
	}
...
var ResourceListViewQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.resourcemanager.resource.list.rpc.ResourceListViewQueryController",
	...
	Metadata: "cloud/planton/apis/v1/resourcemanager/resource/list/rpc/service.proto",
}
