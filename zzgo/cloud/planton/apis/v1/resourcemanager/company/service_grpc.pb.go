...
const (
	CompanyCommandController_Create_FullMethodName  = "/cloud.planton.apis.v1.resourcemanager.company.CompanyCommandController/create"
	CompanyCommandController_Update_FullMethodName  = "/cloud.planton.apis.v1.resourcemanager.company.CompanyCommandController/update"
	CompanyCommandController_Delete_FullMethodName  = "/cloud.planton.apis.v1.resourcemanager.company.CompanyCommandController/delete"
	CompanyCommandController_Restore_FullMethodName = "/cloud.planton.apis.v1.resourcemanager.company.CompanyCommandController/restore"
)
...
type CompanyCommandControllerClient interface {
	...
	Delete(ctx context.Context, in *resource.ApiResourceDeleteCommandInput, opts ...grpc.CallOption) (*Company, error)
...
func (c *companyCommandControllerClient) Delete(ctx context.Context, in *resource.ApiResourceDeleteCommandInput, opts ...grpc.CallOption) (*Company, error) {
	out := new(Company)
...
type CompanyCommandControllerServer interface {
	...
	// delete an existing company on planton cloud using company id
	Delete(context.Context, *resource.ApiResourceDeleteCommandInput) (*Company, error)
	// restore a previously deleted company.
...
func (UnimplementedCompanyCommandControllerServer) Delete(context.Context, *resource.ApiResourceDeleteCommandInput) (*Company, error) {
...
func _CompanyCommandController_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompanyCommandControllerServer).Delete(ctx, req.(*resource.ApiResourceDeleteCommandInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CompanyCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.resourcemanager.company.CompanyCommandController",
