...
const (
	SearchQueryController_SearchByText_FullMethodName                 = "/cloud.planton.apis.v1.search.resource.rpc.SearchQueryController/searchByText"
	SearchQueryController_SearchByResourceType_FullMethodName         = "/cloud.planton.apis.v1.search.resource.rpc.SearchQueryController/searchByResourceType"
	SearchQueryController_SearchIdentityAccountByEmail_FullMethodName = "/cloud.planton.apis.v1.search.resource.rpc.SearchQueryController/searchIdentityAccountByEmail"
)
...
type SearchQueryControllerClient interface {
	...
	SearchByText(ctx context.Context, in *SearchByTextInput, opts ...grpc.CallOption) (*ResourceList, error)
	...
	SearchByResourceType(ctx context.Context, in *SearchByResourceTypeInput, opts ...grpc.CallOption) (*ResourceList, error)
	...
	SearchIdentityAccountByEmail(ctx context.Context, in *SearchIdentityAccountByEmailInput, opts ...grpc.CallOption) (*ResourceList, error)
}
...
func (c *searchQueryControllerClient) SearchByText(ctx context.Context, in *SearchByTextInput, opts ...grpc.CallOption) (*ResourceList, error) {
...
func (c *searchQueryControllerClient) SearchByResourceType(ctx context.Context, in *SearchByResourceTypeInput, opts ...grpc.CallOption) (*ResourceList, error) {
	out := new(ResourceList)
...
func (c *searchQueryControllerClient) SearchIdentityAccountByEmail(ctx context.Context, in *SearchIdentityAccountByEmailInput, opts ...grpc.CallOption) (*ResourceList, error) {
	out := new(ResourceList)
...
type SearchQueryControllerServer interface {
	...
	// related to the specified company and product, and it returns a response
	// containing the search results.
	SearchByText(context.Context, *SearchByTextInput) (*ResourceList, error)
	// This method returns a `ResourceList` message, which encapsulates a list of resources that match
	// the input search parameters. Each resource in the list should match the specified resource type,
	// and be associated with the specified company and product.
	SearchByResourceType(context.Context, *SearchByResourceTypeInput) (*ResourceList, error)
	// This method returns a `ResourceList` message, which encapsulates a list of identities that match
	// the input search parameters. Each identity in the list should be associated with the specified company
	// and match the specified email or part thereof.
	SearchIdentityAccountByEmail(context.Context, *SearchIdentityAccountByEmailInput) (*ResourceList, error)
}
...
func (UnimplementedSearchQueryControllerServer) SearchByText(context.Context, *SearchByTextInput) (*ResourceList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchByText not implemented")
}
func (UnimplementedSearchQueryControllerServer) SearchByResourceType(context.Context, *SearchByResourceTypeInput) (*ResourceList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchByResourceType not implemented")
}
func (UnimplementedSearchQueryControllerServer) SearchIdentityAccountByEmail(context.Context, *SearchIdentityAccountByEmailInput) (*ResourceList, error) {
...
func _SearchQueryController_SearchByText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchQueryControllerServer).SearchByText(ctx, req.(*SearchByTextInput))
	}
...
func _SearchQueryController_SearchByResourceType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchByResourceTypeInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchQueryControllerServer).SearchByResourceType(ctx, req.(*SearchByResourceTypeInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SearchQueryController_SearchIdentityAccountByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchQueryControllerServer).SearchIdentityAccountByEmail(ctx, req.(*SearchIdentityAccountByEmailInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SearchQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.search.resource.rpc.SearchQueryController",
	...
	Metadata: "cloud/planton/apis/v1/search/resource/rpc/service.proto",
}
