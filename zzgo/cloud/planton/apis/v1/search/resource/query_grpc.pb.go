...
const (
	SearchQueryController_SearchByText_FullMethodName                 = "/cloud.planton.apis.v1.search.resource.SearchQueryController/searchByText"
	SearchQueryController_SearchByResourceType_FullMethodName         = "/cloud.planton.apis.v1.search.resource.SearchQueryController/searchByResourceType"
	SearchQueryController_SearchIdentityAccountByEmail_FullMethodName = "/cloud.planton.apis.v1.search.resource.SearchQueryController/searchIdentityAccountByEmail"
)
...
var SearchQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.search.resource.SearchQueryController",
