...
type IamRoleCommandControllerClient interface {
	...
	// delete iam role
	Delete(ctx context.Context, in *model1.ApiResourceRefreshCommandInput, opts ...grpc.CallOption) (*model.IamRole, error)
}
...
func (c *iamRoleCommandControllerClient) Delete(ctx context.Context, in *model1.ApiResourceRefreshCommandInput, opts ...grpc.CallOption) (*model.IamRole, error) {
	out := new(model.IamRole)
...
type IamRoleCommandControllerServer interface {
	...
	// delete iam role
	Delete(context.Context, *model1.ApiResourceRefreshCommandInput) (*model.IamRole, error)
}
...
func (UnimplementedIamRoleCommandControllerServer) Delete(context.Context, *model1.ApiResourceRefreshCommandInput) (*model.IamRole, error) {
...
func _IamRoleCommandController_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IamRoleCommandControllerServer).Delete(ctx, req.(*model1.ApiResourceRefreshCommandInput))
	}
	return interceptor(ctx, in, info, handler)
}
