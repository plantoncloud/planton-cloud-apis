...
const (
	ResourceVersionQueryController_ListByFilters_FullMethodName          = "/cloud.planton.apis.v1.iam.resource.version.ResourceVersionQueryController/listByFilters"
	ResourceVersionQueryController_GetByIdWithContextSize_FullMethodName = "/cloud.planton.apis.v1.iam.resource.version.ResourceVersionQueryController/getByIdWithContextSize"
)
...
var ResourceVersionQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.iam.resource.version.ResourceVersionQueryController",
