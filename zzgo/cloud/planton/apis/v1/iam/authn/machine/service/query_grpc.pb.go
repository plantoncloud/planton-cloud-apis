...
const (
	MachineAuthenticationQueryController_GetAccessToken_FullMethodName = "/cloud.planton.apis.v1.iam.authn.machine.service.MachineAuthenticationQueryController/getAccessToken"
)
...
type MachineAuthenticationQueryControllerClient interface {
	...
	GetAccessToken(ctx context.Context, in *model.GetMachineAccessTokenQueryInput, opts ...grpc.CallOption) (*model.AccessToken, error)
}
...
func (c *machineAuthenticationQueryControllerClient) GetAccessToken(ctx context.Context, in *model.GetMachineAccessTokenQueryInput, opts ...grpc.CallOption) (*model.AccessToken, error) {
...
type MachineAuthenticationQueryControllerServer interface {
	// get an access token in exchange for a valid machine identity account client credentials
	GetAccessToken(context.Context, *model.GetMachineAccessTokenQueryInput) (*model.AccessToken, error)
}
...
func (UnimplementedMachineAuthenticationQueryControllerServer) GetAccessToken(context.Context, *model.GetMachineAccessTokenQueryInput) (*model.AccessToken, error) {
...
func _MachineAuthenticationQueryController_GetAccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model.GetMachineAccessTokenQueryInput)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineAuthenticationQueryControllerServer).GetAccessToken(ctx, req.(*model.GetMachineAccessTokenQueryInput))
	}
...
var MachineAuthenticationQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.iam.authn.machine.service.MachineAuthenticationQueryController",
	...
	Metadata: "cloud/planton/apis/v1/iam/authn/machine/service/query.proto",
}
