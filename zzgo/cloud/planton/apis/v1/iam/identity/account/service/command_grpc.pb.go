...
const (
	MachineAccountCommandController_Create_FullMethodName  = "/cloud.planton.apis.v1.iam.identity.account.service.MachineAccountCommandController/create"
	MachineAccountCommandController_Update_FullMethodName  = "/cloud.planton.apis.v1.iam.identity.account.service.MachineAccountCommandController/update"
	MachineAccountCommandController_Delete_FullMethodName  = "/cloud.planton.apis.v1.iam.identity.account.service.MachineAccountCommandController/delete"
	MachineAccountCommandController_Restore_FullMethodName = "/cloud.planton.apis.v1.iam.identity.account.service.MachineAccountCommandController/restore"
)
...
var MachineAccountCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.iam.identity.account.service.MachineAccountCommandController",
	...
	Metadata: "cloud/planton/apis/v1/iam/identity/account/service/command.proto",
}
