...
const (
	IdentityConnectionCommandController_Create_FullMethodName  = "/cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionCommandController/create"
	IdentityConnectionCommandController_Update_FullMethodName  = "/cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionCommandController/update"
	IdentityConnectionCommandController_Delete_FullMethodName  = "/cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionCommandController/delete"
	IdentityConnectionCommandController_Restore_FullMethodName = "/cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionCommandController/restore"
)
...
var IdentityConnectionCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionCommandController",
	...
	Metadata: "cloud/planton/apis/v1/iam/identity/connection/rpc/service.proto",
}

const (
	IdentityConnectionQueryController_GetById_FullMethodName         = "/cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionQueryController/getById"
	IdentityConnectionQueryController_FindByCompanyId_FullMethodName = "/cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionQueryController/findByCompanyId"
)
...
var IdentityConnectionQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.v1.iam.identity.connection.rpc.IdentityConnectionQueryController",
