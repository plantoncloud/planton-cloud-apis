...
type StackQueryControllerClient interface {
	...
	GetByResourceId(ctx context.Context, in *model1.ResourceId, opts ...grpc.CallOption) (*model.Stack, error)
}
...
func (c *stackQueryControllerClient) GetByResourceId(ctx context.Context, in *model1.ResourceId, opts ...grpc.CallOption) (*model.Stack, error) {
	out := new(model.Stack)
...
type StackQueryControllerServer interface {
	...
	// lookup a stack by resource-id
	GetByResourceId(context.Context, *model1.ResourceId) (*model.Stack, error)
}
...
func (UnimplementedStackQueryControllerServer) GetByResourceId(context.Context, *model1.ResourceId) (*model.Stack, error) {
...
func _StackQueryController_GetByResourceId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StackQueryControllerServer).GetByResourceId(ctx, req.(*model1.ResourceId))
	}
	return interceptor(ctx, in, info, handler)
}
