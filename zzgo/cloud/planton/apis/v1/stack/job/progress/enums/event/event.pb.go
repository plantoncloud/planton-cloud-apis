...
// 	protoc        (unknown)
// source: cloud/planton/apis/iac/v1/stackjob/progress/enums/event/event.proto
...
var file_cloud_planton_apis_v1_stack_job_progress_enums_event_event_proto_goTypes = []interface{}{
	(StackJobProgressEventType)(0), // 0: cloud.planton.apis.iac.v1.stack.job.progress.enums.event.StackJobProgressEventType
}
