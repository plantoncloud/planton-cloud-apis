...
type PulumiOperationResourceChangesSnapshotRow struct {
	...
	ElapsedDurationSeconds int32  `protobuf:"varint,6,opt,name=elapsed_duration_seconds,json=elapsedDurationSeconds,proto3" json:"elapsed_duration_seconds,omitempty"`
}
...
func (x *PulumiOperationResourceChangesSnapshotRow) GetElapsedDurationSeconds() int32 {
	if x != nil {
