...
// 	protoc        (unknown)
// source: cloud/planton/apis/v1/commons/network/dns/domain/enums/enums.proto
...
var file_cloud_planton_apis_v1_commons_network_dns_domain_enums_enums_proto_goTypes = []interface{}{
	(DnsDomainVisibility)(0), // 0: cloud.planton.apis.v1.commons.network.dns.domain.enums.DnsDomainVisibility
}
