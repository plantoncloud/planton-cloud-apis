...
// 	protoc        (unknown)
// source: cloud/planton/apis/v1/commons/resource/io.proto
...
func (x *ResourceId) Reset() {
	*x = ResourceId{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[0]
...
func (*ResourceId) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescGZIP(), []int{0}
}
...
func (x *ResourceGroupVersionKind) Reset() {
	*x = ResourceGroupVersionKind{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResourceGroupVersionKind) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescGZIP(), []int{1}
}
...
func (x *ApiResourceDeleteCommandInput) Reset() {
	*x = ApiResourceDeleteCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourceDeleteCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescGZIP(), []int{2}
}
...
func (x *ApiResourcePauseCommandInput) Reset() {
	*x = ApiResourcePauseCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourcePauseCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescGZIP(), []int{3}
}
...
func (x *ApiResourceUnPauseCommandInput) Reset() {
	*x = ApiResourceUnPauseCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourceUnPauseCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescGZIP(), []int{4}
}
...
func (x *ApiResourceRefreshCommandInput) Reset() {
	*x = ApiResourceRefreshCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourceRefreshCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescGZIP(), []int{5}
}
...
var File_cloud_planton_apis_v1_commons_resource_io_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_v1_commons_resource_io_proto_rawDesc = []byte{
	...
	0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0x51, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x22, 0x0a, 0x0a,
	...
	0x64, 0x22, 0x69, 0x0a, 0x1d, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x68, 0x0a, 0x1c,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0xd7,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x07, 0x49, 0x6f, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	...
	,
...
var (
	file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescData = file_cloud_planton_apis_v1_commons_resource_io_proto_rawDesc
)

func file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescData)
	})
	return file_cloud_planton_apis_v1_commons_resource_io_proto_rawDescData
}

var file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cloud_planton_apis_v1_commons_resource_io_proto_goTypes = []interface{}{
	(*ResourceId)(nil),                     // 0: cloud.planton.apis.v1.commons.resource.ResourceId
	(*ResourceGroupVersionKind)(nil),       // 1: cloud.planton.apis.v1.commons.resource.ResourceGroupVersionKind
	(*ApiResourceDeleteCommandInput)(nil),  // 2: cloud.planton.apis.v1.commons.resource.ApiResourceDeleteCommandInput
	(*ApiResourcePauseCommandInput)(nil),   // 3: cloud.planton.apis.v1.commons.resource.ApiResourcePauseCommandInput
	(*ApiResourceUnPauseCommandInput)(nil), // 4: cloud.planton.apis.v1.commons.resource.ApiResourceUnPauseCommandInput
	(*ApiResourceRefreshCommandInput)(nil), // 5: cloud.planton.apis.v1.commons.resource.ApiResourceRefreshCommandInput
}
var file_cloud_planton_apis_v1_commons_resource_io_proto_depIdxs = []int32{
...
func init() { file_cloud_planton_apis_v1_commons_resource_io_proto_init() }
func file_cloud_planton_apis_v1_commons_resource_io_proto_init() {
	if File_cloud_planton_apis_v1_commons_resource_io_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_v1_commons_resource_io_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_v1_commons_resource_io_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_v1_commons_resource_io_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_v1_commons_resource_io_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_v1_commons_resource_io_proto = out.File
	file_cloud_planton_apis_v1_commons_resource_io_proto_rawDesc = nil
	file_cloud_planton_apis_v1_commons_resource_io_proto_goTypes = nil
	file_cloud_planton_apis_v1_commons_resource_io_proto_depIdxs = nil
}
