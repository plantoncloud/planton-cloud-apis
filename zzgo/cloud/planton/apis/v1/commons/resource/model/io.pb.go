...
// 	protoc        (unknown)
// source: cloud/planton/apis/v1/commons/resource/model/io.proto
...
func (x *ResourceId) Reset() {
	*x = ResourceId{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[0]
...
func (*ResourceId) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescGZIP(), []int{0}
}
...
func (x *ResourceGroupVersionKind) Reset() {
	*x = ResourceGroupVersionKind{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResourceGroupVersionKind) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescGZIP(), []int{1}
}
...
func (x *ApiResourceDeleteCommandInput) Reset() {
	*x = ApiResourceDeleteCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourceDeleteCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescGZIP(), []int{2}
}
...
func (x *ApiResourcePauseCommandInput) Reset() {
	*x = ApiResourcePauseCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourcePauseCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescGZIP(), []int{3}
}
...
func (x *ApiResourceUnPauseCommandInput) Reset() {
	*x = ApiResourceUnPauseCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourceUnPauseCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescGZIP(), []int{4}
}
...
func (x *ApiResourceRefreshCommandInput) Reset() {
	*x = ApiResourceRefreshCommandInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApiResourceRefreshCommandInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescGZIP(), []int{5}
}
...
var File_cloud_planton_apis_v1_commons_resource_model_io_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0x51, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x70, 0x6c, 0x61,
	...
	0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x22, 0x0a, 0x0a, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x4f, 0x0a, 0x18,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x56, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x70, 0x69, 0x5f,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0x69, 0x0a,
	0x1d, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x1f,
	...
	0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x68, 0x0a, 0x1c, 0x41, 0x70, 0x69, 0x52,
	...
	0x67, 0x65, 0x22, 0x6a, 0x0a, 0x1e, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x6a,
	0x0a, 0x1e, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x66,
	...
	0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0xfd, 0x02, 0x0a, 0x3a, 0x62,
	...
	0x72, 0x63, 0x65, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x42, 0x07, 0x49, 0x6f, 0x50, 0x72, 0x6f,
	...
	0x65, 0x6c, 0xa2, 0x02, 0x07, 0x43, 0x50, 0x41, 0x56, 0x43, 0x52, 0x4d, 0xaa, 0x02, 0x2c, 0x43,
...
var (
	file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescData = file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDesc
)

func file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescData)
	})
	return file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDescData
}

var file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cloud_planton_apis_v1_commons_resource_model_io_proto_goTypes = []interface{}{
	(*ResourceId)(nil),                     // 0: cloud.planton.apis.v1.commons.resource.model.ResourceId
	(*ResourceGroupVersionKind)(nil),       // 1: cloud.planton.apis.v1.commons.resource.model.ResourceGroupVersionKind
	(*ApiResourceDeleteCommandInput)(nil),  // 2: cloud.planton.apis.v1.commons.resource.model.ApiResourceDeleteCommandInput
	(*ApiResourcePauseCommandInput)(nil),   // 3: cloud.planton.apis.v1.commons.resource.model.ApiResourcePauseCommandInput
	(*ApiResourceUnPauseCommandInput)(nil), // 4: cloud.planton.apis.v1.commons.resource.model.ApiResourceUnPauseCommandInput
	(*ApiResourceRefreshCommandInput)(nil), // 5: cloud.planton.apis.v1.commons.resource.model.ApiResourceRefreshCommandInput
}
var file_cloud_planton_apis_v1_commons_resource_model_io_proto_depIdxs = []int32{
...
func init() { file_cloud_planton_apis_v1_commons_resource_model_io_proto_init() }
func file_cloud_planton_apis_v1_commons_resource_model_io_proto_init() {
	if File_cloud_planton_apis_v1_commons_resource_model_io_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_v1_commons_resource_model_io_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_v1_commons_resource_model_io_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_v1_commons_resource_model_io_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_v1_commons_resource_model_io_proto = out.File
	file_cloud_planton_apis_v1_commons_resource_model_io_proto_rawDesc = nil
	file_cloud_planton_apis_v1_commons_resource_model_io_proto_goTypes = nil
	file_cloud_planton_apis_v1_commons_resource_model_io_proto_depIdxs = nil
}
