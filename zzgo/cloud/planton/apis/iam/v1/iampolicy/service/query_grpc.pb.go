...
const (
	...
	IamPolicyQueryController_GetEnvironmentByApiResourceKindAndResourceIdGroupByRole_FullMethodName = "/cloud.planton.apis.iam.v1.iampolicy.service.IamPolicyQueryController/getEnvironmentByApiResourceKindAndResourceIdGroupByRole"
...
type IamPolicyQueryControllerClient interface {
	...
	// retrieve iam policies by type and id grouped by role
	GetEnvironmentByApiResourceKindAndResourceIdGroupByRole(ctx context.Context, in *model.GetIamPolicyByApiResourceKindAndResourceIdInput, opts ...grpc.CallOption) (*model.IamPoliciesByRole, error)
...
func (c *iamPolicyQueryControllerClient) GetEnvironmentByApiResourceKindAndResourceIdGroupByRole(ctx context.Context, in *model.GetIamPolicyByApiResourceKindAndResourceIdInput, opts ...grpc.CallOption) (*model.IamPoliciesByRole, error) {
	out := new(model.IamPoliciesByRole)
	err := c.cc.Invoke(ctx, IamPolicyQueryController_GetEnvironmentByApiResourceKindAndResourceIdGroupByRole_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IamPolicyQueryControllerServer interface {
	...
	// retrieve iam policies by type and id grouped by role
	GetEnvironmentByApiResourceKindAndResourceIdGroupByRole(context.Context, *model.GetIamPolicyByApiResourceKindAndResourceIdInput) (*model.IamPoliciesByRole, error)
	// checkAuthorization evaluates whether a specific action or access described by the AuthorizationInput
	// is authorized based on the configured IAM policies. This RPC is crucial for enforcing access controls
	// and ensuring that operations are performed by appropriately authorized users or services.
	//
...
func (UnimplementedIamPolicyQueryControllerServer) GetEnvironmentByApiResourceKindAndResourceIdGroupByRole(context.Context, *model.GetIamPolicyByApiResourceKindAndResourceIdInput) (*model.IamPoliciesByRole, error) {
...
func _IamPolicyQueryController_GetEnvironmentByApiResourceKindAndResourceIdGroupByRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IamPolicyQueryControllerServer).GetEnvironmentByApiResourceKindAndResourceIdGroupByRole(ctx, req.(*model.GetIamPolicyByApiResourceKindAndResourceIdInput))
	}
	return interceptor(ctx, in, info, handler)
}
