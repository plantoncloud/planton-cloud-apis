...
const (
	PrometheusKubernetesQueryController_GetById_FullMethodName     = "/cloud.planton.apis.code2cloud.v1.prometheuskubernetes.service.PrometheusKubernetesQueryController/getById"
	PrometheusKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.prometheuskubernetes.service.PrometheusKubernetesQueryController/getPassword"
)
...
type PrometheusKubernetesQueryControllerClient interface {
	...
	GetById(ctx context.Context, in *model.PrometheusKubernetesId, opts ...grpc.CallOption) (*model.PrometheusKubernetes, error)
...
func (c *prometheusKubernetesQueryControllerClient) GetById(ctx context.Context, in *model.PrometheusKubernetesId, opts ...grpc.CallOption) (*model.PrometheusKubernetes, error) {
	out := new(model.PrometheusKubernetes)
	err := c.cc.Invoke(ctx, PrometheusKubernetesQueryController_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PrometheusKubernetesQueryControllerServer interface {
	// look up prometheus-kubernetes using prometheus-kubernetes id
	GetById(context.Context, *model.PrometheusKubernetesId) (*model.PrometheusKubernetes, error)
	// look up prometheus-kubernetes sasl password
	// password is retrieved from the kubernetes cluster.
...
func (UnimplementedPrometheusKubernetesQueryControllerServer) GetById(context.Context, *model.PrometheusKubernetesId) (*model.PrometheusKubernetes, error) {
...
func _PrometheusKubernetesQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model.PrometheusKubernetesId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PrometheusKubernetesQueryControllerServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PrometheusKubernetesQueryController_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrometheusKubernetesQueryControllerServer).GetById(ctx, req.(*model.PrometheusKubernetesId))
	}
...
var PrometheusKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.prometheuskubernetes.service.PrometheusKubernetesQueryController",
	HandlerType: (*PrometheusKubernetesQueryControllerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getById",
			Handler:    _PrometheusKubernetesQueryController_GetById_Handler,
		},
		{
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/prometheuskubernetes/service/query.proto",
}
