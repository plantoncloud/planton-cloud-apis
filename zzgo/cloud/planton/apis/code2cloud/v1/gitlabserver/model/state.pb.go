...
type GitLabServerSpecKubernetesSpec struct {
	...
	RedisContainer *GitLabServerSpecKubernetesSpecRedisContainerSpec `protobuf:"bytes,1,opt,name=redis_container,json=redisContainer,proto3" json:"redis_container,omitempty"`
...
func (x *GitLabServerSpecKubernetesSpec) GetRedisContainer() *GitLabServerSpecKubernetesSpecRedisContainerSpec {
	if x != nil {
...
// gitlab-server kubernetes redis-container spec
type GitLabServerSpecKubernetesSpecRedisContainerSpec struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GitLabServerSpecKubernetesSpecRedisContainerSpec) Reset() {
	*x = GitLabServerSpecKubernetesSpecRedisContainerSpec{}
	if protoimpl.UnsafeEnabled {
...
func (x *GitLabServerSpecKubernetesSpecRedisContainerSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GitLabServerSpecKubernetesSpecRedisContainerSpec) ProtoMessage() {}

func (x *GitLabServerSpecKubernetesSpecRedisContainerSpec) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_code2cloud_v1_gitlabserver_model_state_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GitLabServerSpecKubernetesSpecRedisContainerSpec.ProtoReflect.Descriptor instead.
func (*GitLabServerSpecKubernetesSpecRedisContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_gitlabserver_model_state_proto_rawDescGZIP(), []int{4}
}

func (x *GitLabServerSpecKubernetesSpecRedisContainerSpec) GetReplicas() int32 {
	if x != nil {
		return x.Replicas
	}
	return 0
...
func (x *GitLabServerSpecKubernetesSpecRedisContainerSpec) GetResources() *model2.ContainerResources {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *GitLabServerSpecKubernetesSpecRedisContainerSpec) GetIsPersistenceEnabled() bool {
	if x != nil {
...
func (x *GitLabServerSpecKubernetesSpecRedisContainerSpec) GetDiskSize() string {
	if x != nil {
		return x.DiskSize
	}
	return ""
...
type GitLabServerStatusKubernetesStatus struct {
	...
	// running the command from this attribute makes it possible to access gitlab-server using http://localhost:8080/redis
	...
	// ex: https://gls-planton-pcs-dev-main.data.dev.planton.live:6379/redis
...
var file_cloud_planton_apis_code2cloud_v1_gitlabserver_model_state_proto_rawDesc = []byte{
	...
	0x61, 0x29, 0x8a, 0xb5, 0x18, 0x03, 0x67, 0x6c, 0x73, 0x98, 0xb5, 0x18, 0x01, 0x88, 0xa6, 0x1d,
	...
	0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x22, 0xab, 0x02, 0x0a, 0x1e, 0x47, 0x69, 0x74,
	...
	0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x22, 0x93, 0x02, 0x0a, 0x30, 0x47, 0x69, 0x74, 0x4c, 0x61,
	0x62, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x4b, 0x75, 0x62, 0x65, 0x72,
	...
	0x29, 0x47, 0x69, 0x74, 0x4c, 0x61, 0x62, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x70, 0x65,
	...
	0x27, 0x3a, 0x20, 0x27, 0x27, 0x22, 0xde, 0x01, 0x0a, 0x22, 0x47, 0x69, 0x74, 0x4c, 0x61, 0x62,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4b, 0x75, 0x62, 0x65,
	...
	0x6c, 0x61, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0xa2,
	0x02, 0x07, 0x43, 0x50, 0x41, 0x43, 0x56, 0x47, 0x4d, 0xaa, 0x02, 0x33, 0x43, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x50, 0x6c, 0x61, 0x6e, 0x74, 0x6f, 0x6e, 0x2e, 0x41, 0x70, 0x69, 0x73, 0x2e, 0x43,
	0x6f, 0x64, 0x65, 0x32, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x56, 0x31, 0x2e, 0x47, 0x69, 0x74,
	0x6c, 0x61, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xca,
	...
	0x56, 0x31, 0x5c, 0x47, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5c,
	...
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x56, 0x31, 0x5c, 0x47, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x73,
	...
	0x47, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x3a, 0x3a, 0x4d, 0x6f,
...
var file_cloud_planton_apis_code2cloud_v1_gitlabserver_model_state_proto_goTypes = []interface{}{
	...
	(*GitLabServerSpecKubernetesSpecRedisContainerSpec)(nil),         // 4: cloud.planton.apis.code2cloud.v1.gitlabserver.model.GitLabServerSpecKubernetesSpecRedisContainerSpec
...
var file_cloud_planton_apis_code2cloud_v1_gitlabserver_model_state_proto_depIdxs = []int32{
	...
	4,  // 8: cloud.planton.apis.code2cloud.v1.gitlabserver.model.GitLabServerSpecKubernetesSpec.redis_container:type_name -> cloud.planton.apis.code2cloud.v1.gitlabserver.model.GitLabServerSpecKubernetesSpecRedisContainerSpec
	...
	11, // 10: cloud.planton.apis.code2cloud.v1.gitlabserver.model.GitLabServerSpecKubernetesSpecRedisContainerSpec.resources:type_name -> cloud.planton.apis.code2cloud.v1.kubecluster.model.ContainerResources
...
func file_cloud_planton_apis_code2cloud_v1_gitlabserver_model_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cloud_planton_apis_code2cloud_v1_gitlabserver_model_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GitLabServerSpecKubernetesSpecRedisContainerSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
