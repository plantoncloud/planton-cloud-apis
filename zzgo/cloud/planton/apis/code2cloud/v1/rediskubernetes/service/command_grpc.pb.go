...
const (
	RedisKubernetesCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/previewCreate"
	RedisKubernetesCommandController_Create_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/create"
	RedisKubernetesCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/previewUpdate"
	RedisKubernetesCommandController_Update_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/update"
	RedisKubernetesCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/previewDelete"
	RedisKubernetesCommandController_Delete_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/delete"
	RedisKubernetesCommandController_PreviewRestore_FullMethodName = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/previewRestore"
	RedisKubernetesCommandController_Restore_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/restore"
	RedisKubernetesCommandController_Restart_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/restart"
	RedisKubernetesCommandController_Pause_FullMethodName          = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/pause"
	RedisKubernetesCommandController_Unpause_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/unpause"
	RedisKubernetesCommandController_PreviewRefresh_FullMethodName = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/previewRefresh"
	RedisKubernetesCommandController_Refresh_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController/refresh"
)
...
var RedisKubernetesCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesCommandController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/rediskubernetes/service/command.proto",
}
