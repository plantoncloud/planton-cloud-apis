...
const (
	RedisKubernetesQueryController_GetById_FullMethodName     = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesQueryController/getById"
	RedisKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesQueryController/getPassword"
)
...
type RedisKubernetesQueryControllerClient interface {
	...
	GetById(ctx context.Context, in *model.RedisKubernetesId, opts ...grpc.CallOption) (*model.RedisKubernetes, error)
...
func (c *redisKubernetesQueryControllerClient) GetById(ctx context.Context, in *model.RedisKubernetesId, opts ...grpc.CallOption) (*model.RedisKubernetes, error) {
	out := new(model.RedisKubernetes)
	err := c.cc.Invoke(ctx, RedisKubernetesQueryController_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RedisKubernetesQueryControllerServer interface {
	// look up redis-kubernetes using redis-kubernetes id
	GetById(context.Context, *model.RedisKubernetesId) (*model.RedisKubernetes, error)
	// look up redis-kubernetes sasl password
	// password is retrieved from the kubernetes cluster.
...
func (UnimplementedRedisKubernetesQueryControllerServer) GetById(context.Context, *model.RedisKubernetesId) (*model.RedisKubernetes, error) {
...
func _RedisKubernetesQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model.RedisKubernetesId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RedisKubernetesQueryControllerServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RedisKubernetesQueryController_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RedisKubernetesQueryControllerServer).GetById(ctx, req.(*model.RedisKubernetesId))
	}
...
var RedisKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.rediskubernetes.service.RedisKubernetesQueryController",
	HandlerType: (*RedisKubernetesQueryControllerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getById",
			Handler:    _RedisKubernetesQueryController_GetById_Handler,
		},
		{
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/rediskubernetes/service/query.proto",
}
