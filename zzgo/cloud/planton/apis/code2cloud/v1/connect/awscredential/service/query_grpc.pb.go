...
const (
	AwsCredentialQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.connect.awscredential.service.AwsCredentialQueryController/get"
)
...
var AwsCredentialQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.connect.awscredential.service.AwsCredentialQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/connect/awscredential/service/query.proto",
}
