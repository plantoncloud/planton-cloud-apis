...
const (
	AzureCredentialQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.connect.azurecredential.service.AzureCredentialQueryController/get"
)
...
var AzureCredentialQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.connect.azurecredential.service.AzureCredentialQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/connect/azurecredential/service/query.proto",
}
