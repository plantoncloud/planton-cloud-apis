...
type OpenFGAServerSpecKubernetesSpec struct {
	...
	OpenfgaContainer *OpenFGAServerSpecKubernetesSpecRedisContainerSpec `protobuf:"bytes,1,opt,name=openfga_container,json=openfgaContainer,proto3" json:"openfga_container,omitempty"`
...
func (x *OpenFGAServerSpecKubernetesSpec) GetOpenfgaContainer() *OpenFGAServerSpecKubernetesSpecRedisContainerSpec {
	if x != nil {
...
type OpenFGAServerSpecKubernetesSpecRedisContainerSpec struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// number of openfga pods.
	...
	// flag to toggle persistence for openfga data.
	// when enabled, openfga in-memory data will be persisted to a storage volume.
	// the backup data from persistent volume is restored into openfga memory between pod restarts.
	// defaults to false.
	...
	// size of persistent volume attached to each openfga pod
...
func (x *OpenFGAServerSpecKubernetesSpecRedisContainerSpec) Reset() {
	*x = OpenFGAServerSpecKubernetesSpecRedisContainerSpec{}
	if protoimpl.UnsafeEnabled {
...
func (x *OpenFGAServerSpecKubernetesSpecRedisContainerSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpenFGAServerSpecKubernetesSpecRedisContainerSpec) ProtoMessage() {}

func (x *OpenFGAServerSpecKubernetesSpecRedisContainerSpec) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_code2cloud_v1_openfgaserver_model_state_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpenFGAServerSpecKubernetesSpecRedisContainerSpec.ProtoReflect.Descriptor instead.
func (*OpenFGAServerSpecKubernetesSpecRedisContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_openfgaserver_model_state_proto_rawDescGZIP(), []int{4}
}

func (x *OpenFGAServerSpecKubernetesSpecRedisContainerSpec) GetReplicas() int32 {
	if x != nil {
		return x.Replicas
	}
	return 0
...
func (x *OpenFGAServerSpecKubernetesSpecRedisContainerSpec) GetResources() *model2.ContainerResources {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *OpenFGAServerSpecKubernetesSpecRedisContainerSpec) GetIsPersistenceEnabled() bool {
	if x != nil {
...
func (x *OpenFGAServerSpecKubernetesSpecRedisContainerSpec) GetDiskSize() string {
	if x != nil {
		return x.DiskSize
	}
	return ""
...
var file_cloud_planton_apis_code2cloud_v1_openfgaserver_model_state_proto_rawDesc = []byte{
	...
	0x0d, 0x4f, 0x70, 0x65, 0x6e, 0x46, 0x47, 0x41, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x43,
	...
	0x65, 0x6e, 0x46, 0x47, 0x41, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x12,
	...
	0x73, 0x22, 0xf2, 0x02, 0x0a, 0x13, 0x4f, 0x70, 0x65, 0x6e, 0x46, 0x47, 0x41, 0x53, 0x65, 0x72,
	...
	0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x22, 0xb4, 0x02, 0x0a, 0x1f, 0x4f, 0x70, 0x65, 0x6e, 0x46,
	0x47, 0x41, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x4b, 0x75, 0x62, 0x65,
	0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63, 0x12, 0x94, 0x01, 0x0a, 0x11, 0x6f,
	...
	0x65, 0x6e, 0x46, 0x47, 0x41, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x4b,
	...
	0x10, 0x6f, 0x70, 0x65, 0x6e, 0x66, 0x67, 0x61, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65,
	...
	0x41, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x4b, 0x75, 0x62, 0x65, 0x72,
	0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73,
	0x53, 0x70, 0x65, 0x63, 0x52, 0x07, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x22, 0x94, 0x02,
	0x0a, 0x31, 0x4f, 0x70, 0x65, 0x6e, 0x46, 0x47, 0x41, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53,
	...
	0x53, 0x69, 0x7a, 0x65, 0x22, 0xc7, 0x04, 0x0a, 0x2a, 0x4f, 0x70, 0x65, 0x6e, 0x46, 0x47, 0x41,
	...
	0x01, 0x0a, 0x23, 0x4f, 0x70, 0x65, 0x6e, 0x46, 0x47, 0x41, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
...
var file_cloud_planton_apis_code2cloud_v1_openfgaserver_model_state_proto_goTypes = []interface{}{
	...
	(*OpenFGAServerSpecKubernetesSpecRedisContainerSpec)(nil),        // 4: cloud.planton.apis.code2cloud.v1.openfgaserver.model.OpenFGAServerSpecKubernetesSpecRedisContainerSpec
...
var file_cloud_planton_apis_code2cloud_v1_openfgaserver_model_state_proto_depIdxs = []int32{
	...
	4,  // 8: cloud.planton.apis.code2cloud.v1.openfgaserver.model.OpenFGAServerSpecKubernetesSpec.openfga_container:type_name -> cloud.planton.apis.code2cloud.v1.openfgaserver.model.OpenFGAServerSpecKubernetesSpecRedisContainerSpec
	...
	11, // 10: cloud.planton.apis.code2cloud.v1.openfgaserver.model.OpenFGAServerSpecKubernetesSpecRedisContainerSpec.resources:type_name -> cloud.planton.apis.code2cloud.v1.kubecluster.model.ContainerResources
...
func file_cloud_planton_apis_code2cloud_v1_openfgaserver_model_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cloud_planton_apis_code2cloud_v1_openfgaserver_model_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OpenFGAServerSpecKubernetesSpecRedisContainerSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
