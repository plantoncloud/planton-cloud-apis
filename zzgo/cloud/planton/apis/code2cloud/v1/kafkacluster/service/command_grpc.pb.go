...
const (
	KafkaClusterCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController/previewCreate"
	KafkaClusterCommandController_Create_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController/create"
	KafkaClusterCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController/previewUpdate"
	KafkaClusterCommandController_Update_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController/update"
	KafkaClusterCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController/previewDelete"
	...
	KafkaClusterCommandController_PreviewRefresh_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController/previewRefresh"
	KafkaClusterCommandController_Refresh_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController/refresh"
)
...
var KafkaClusterCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaClusterCommandController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/kafkacluster/service/command.proto",
}

const (
	KafkaTopicCommandController_Add_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaTopicCommandController/add"
	KafkaTopicCommandController_AddMultiple_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaTopicCommandController/addMultiple"
	KafkaTopicCommandController_Update_FullMethodName      = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaTopicCommandController/update"
	KafkaTopicCommandController_Delete_FullMethodName      = "/cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaTopicCommandController/delete"
)
...
var KafkaTopicCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kafkacluster.service.KafkaTopicCommandController",
