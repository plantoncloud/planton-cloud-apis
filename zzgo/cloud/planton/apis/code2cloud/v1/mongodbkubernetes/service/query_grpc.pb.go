...
const (
	MongodbKubernetesQueryController_GetById_FullMethodName     = "/cloud.planton.apis.code2cloud.v1.mongodbkubernetes.service.MongodbKubernetesQueryController/getById"
	MongodbKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.mongodbkubernetes.service.MongodbKubernetesQueryController/getPassword"
)
...
type MongodbKubernetesQueryControllerClient interface {
	...
	GetById(ctx context.Context, in *model.MongodbKubernetesId, opts ...grpc.CallOption) (*model.MongodbKubernetes, error)
...
func (c *mongodbKubernetesQueryControllerClient) GetById(ctx context.Context, in *model.MongodbKubernetesId, opts ...grpc.CallOption) (*model.MongodbKubernetes, error) {
	out := new(model.MongodbKubernetes)
	err := c.cc.Invoke(ctx, MongodbKubernetesQueryController_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MongodbKubernetesQueryControllerServer interface {
	// look up mongodb-kubernetes using mongodb-kubernetes id
	GetById(context.Context, *model.MongodbKubernetesId) (*model.MongodbKubernetes, error)
	// look up mongodb-kubernetes sasl password
	// password is retrieved from the kubernetes cluster.
...
func (UnimplementedMongodbKubernetesQueryControllerServer) GetById(context.Context, *model.MongodbKubernetesId) (*model.MongodbKubernetes, error) {
...
func _MongodbKubernetesQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model.MongodbKubernetesId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MongodbKubernetesQueryControllerServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MongodbKubernetesQueryController_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MongodbKubernetesQueryControllerServer).GetById(ctx, req.(*model.MongodbKubernetesId))
	}
...
var MongodbKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.mongodbkubernetes.service.MongodbKubernetesQueryController",
	HandlerType: (*MongodbKubernetesQueryControllerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getById",
			Handler:    _MongodbKubernetesQueryController_GetById_Handler,
		},
		{
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/mongodbkubernetes/service/query.proto",
}
