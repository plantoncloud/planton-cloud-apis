...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/solrkubernetes/enums/apiresourceeventtype/api_resource_event_type.proto
...
func (SolrKubernetesApiResourceEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_enumTypes[0].Descriptor()
}

func (SolrKubernetesApiResourceEventType) Type() protoreflect.EnumType {
	return &file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_enumTypes[0]
}
...
func (SolrKubernetesApiResourceEventType) EnumDescriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescGZIP(), []int{0}
}

var File_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDesc = []byte{
	...
	0x72, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x65, 0x6e, 0x75, 0x6d,
	...
	0x6f, 0x2a, 0x8b, 0x05, 0x0a, 0x22, 0x53, 0x6f, 0x6c, 0x72, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	...
	0x74, 0x74, 0x79, 0x70, 0x65, 0xa2, 0x02, 0x08, 0x43, 0x50, 0x41, 0x43, 0x56, 0x53, 0x45, 0x41,
	...
	0x6c, 0x72, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5c, 0x45, 0x6e, 0x75,
...
var (
	file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescData = file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDesc
)

func file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescData)
	})
	return file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDescData
}

var file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_goTypes = []interface{}{
	(SolrKubernetesApiResourceEventType)(0), // 0: cloud.planton.apis.code2cloud.v1.solrkubernetes.enums.apiresourceeventtype.SolrKubernetesApiResourceEventType
}
var file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_depIdxs = []int32{
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_depIdxs,
		EnumInfos:         file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_enumTypes,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_solrkubernetes_enums_apiresourceeventtype_api_resource_event_type_proto_depIdxs = nil
}
