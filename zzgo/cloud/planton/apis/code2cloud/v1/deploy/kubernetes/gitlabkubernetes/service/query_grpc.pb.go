...
const (
	GitlabKubernetesQueryController_Get_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.gitlabkubernetes.service.GitlabKubernetesQueryController/get"
	GitlabKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.gitlabkubernetes.service.GitlabKubernetesQueryController/getPassword"
)
...
var GitlabKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.gitlabkubernetes.service.GitlabKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/gitlabkubernetes/service/query.proto",
}
