...
const (
	HelmReleaseQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.helmrelease.service.HelmReleaseQueryController/get"
)
...
type HelmReleaseQueryControllerClient interface {
	...
	Get(ctx context.Context, in *model.HelmReleaseId, opts ...grpc.CallOption) (*model.HelmRelease, error)
}
...
func (c *helmReleaseQueryControllerClient) Get(ctx context.Context, in *model.HelmReleaseId, opts ...grpc.CallOption) (*model.HelmRelease, error) {
	out := new(model.HelmRelease)
	err := c.cc.Invoke(ctx, HelmReleaseQueryController_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelmReleaseQueryControllerServer interface {
	// look up helm-release using helm-release id
	Get(context.Context, *model.HelmReleaseId) (*model.HelmRelease, error)
}
...
func (UnimplementedHelmReleaseQueryControllerServer) Get(context.Context, *model.HelmReleaseId) (*model.HelmRelease, error) {
...
func _HelmReleaseQueryController_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model.HelmReleaseId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelmReleaseQueryControllerServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelmReleaseQueryController_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelmReleaseQueryControllerServer).Get(ctx, req.(*model.HelmReleaseId))
	}
...
var HelmReleaseQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.helmrelease.service.HelmReleaseQueryController",
	HandlerType: (*HelmReleaseQueryControllerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "get",
			Handler:    _HelmReleaseQueryController_Get_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/helmrelease/service/query.proto",
}
