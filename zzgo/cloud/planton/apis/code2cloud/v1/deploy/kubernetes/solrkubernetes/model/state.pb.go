...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/deploy/kubernetes/solrkubernetes/model/state.proto
...
func (x *SolrKubernetes) Reset() {
	*x = SolrKubernetes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[0]
...
func (*SolrKubernetes) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP(), []int{0}
}
...
type SolrKubernetesSpec struct {
	...
	SolrContainer                 *SolrKubernetesSpecSolrContainerSpec `protobuf:"bytes,1,opt,name=solr_container,json=solrContainer,proto3" json:"solr_container,omitempty"`
	// zookeeper container spec
	ZookeeperContainer *SolrKubernetesSpecZookeeperContainerSpec `protobuf:"bytes,2,opt,name=zookeeper_container,json=zookeeperContainer,proto3" json:"zookeeper_container,omitempty"`
	// ingress spec
...
func (x *SolrKubernetesSpec) Reset() {
	*x = SolrKubernetesSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolrKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP(), []int{1}
}
...
func (x *SolrKubernetesSpec) GetStackJobSettings() *model2.StackJobSettings {
	if x != nil {
...
func (x *SolrKubernetesSpec) GetKubernetesClusterCredentialId() string {
	if x != nil {
...
func (x *SolrKubernetesSpec) GetIngress() *model3.IngressSpec {
	if x != nil {
		return x.Ingress
	}
	return nil
...
type SolrKubernetesStatus struct {
	...
	// stack-outputs
	StackOutputs *SolrKubernetesStatusStackOutputs `protobuf:"bytes,1,opt,name=stack_outputs,json=stackOutputs,proto3" json:"stack_outputs,omitempty"`
}

func (x *SolrKubernetesStatus) Reset() {
	*x = SolrKubernetesStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolrKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP(), []int{2}
}

func (x *SolrKubernetesStatus) GetLifecycle() *model.ApiResourceLifecycle {
	if x != nil {
		return x.Lifecycle
	}
	return nil
...
func (x *SolrKubernetesStatus) GetStackOutputs() *SolrKubernetesStatusStackOutputs {
	if x != nil {
...
type SolrKubernetesSpecSolrContainerSpec struct {
	...
	Image *model3.ContainerImage `protobuf:"bytes,2,opt,name=image,proto3" json:"image,omitempty"`
...
func (x *SolrKubernetesSpecSolrContainerSpec) Reset() {
	*x = SolrKubernetesSpecSolrContainerSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolrKubernetesSpecSolrContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP(), []int{3}
}
...
func (x *SolrKubernetesSpecSolrContainerSpec) GetImage() *model3.ContainerImage {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *SolrKubernetesSpecSolrContainerSpec) GetResources() *model3.ContainerResources {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *SolrKubernetesSpecConfigSpec) Reset() {
	*x = SolrKubernetesSpecConfigSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolrKubernetesSpecConfigSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP(), []int{4}
}
...
func (x *SolrKubernetesSpecZookeeperContainerSpec) Reset() {
	*x = SolrKubernetesSpecZookeeperContainerSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolrKubernetesSpecZookeeperContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP(), []int{5}
}
...
func (x *SolrKubernetesSpecZookeeperContainerSpec) GetResources() *model3.ContainerResources {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *SolrKubernetesStatusStackOutputs) Reset() {
	*x = SolrKubernetesStatusStackOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolrKubernetesStatusStackOutputs) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP(), []int{6}
}
...
var File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x37, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	...
	0x6c, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x07,
	0x0a, 0x0e, 0x53, 0x6f, 0x6c, 0x72, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x6f, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5b, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70, 0x6c,
	...
	0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x73, 0x6f, 0x6c, 0x72, 0x6b,
	...
	,
	...
	0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x47,
	0x0a, 0x20, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5f, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x5f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x5f,
	0x69, 0x64, 0x18, 0x61, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1d, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	0x65, 0x74, 0x65, 0x73, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x72, 0x65, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x9b, 0x01, 0x0a, 0x0e, 0x73, 0x6f, 0x6c, 0x72,
	...
	0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x73, 0x6f, 0x6c, 0x72, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	...
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0xaa, 0x01, 0x0a, 0x13, 0x7a, 0x6f, 0x6f, 0x6b, 0x65, 0x65,
	...
	0x6c, 0x72, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63,
	0x5a, 0x6f, 0x6f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x12,
	0x7a, 0x6f, 0x6f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x12, 0x52, 0x0a, 0x07, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20,
	...
	0x6c, 0x2e, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x53, 0x70, 0x65, 0x63, 0x52, 0x07, 0x69,
	0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x22, 0x81, 0x03, 0x0a, 0x14, 0x53, 0x6f, 0x6c, 0x72, 0x4b,
	...
	0x74, 0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x8e, 0x01, 0x0a, 0x0d, 0x73, 0x74,
	...
	0x61, 0x63, 0x6b, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x22, 0xd3, 0x04, 0x0a, 0x23, 0x53,
	...
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x12, 0x51, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3b, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70, 0x6c,
	...
	0x67, 0x65, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x65, 0x0a, 0x09, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3f, 0x2e, 0x63,
	...
	0x12, 0xce, 0x01, 0x0a, 0x09, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x04,
	...
	0x65, 0x12, 0x7d, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	,
	...
	0xce, 0x01, 0x0a, 0x09, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x42, 0xb0, 0x01, 0xba, 0x48, 0xa5, 0x01, 0xba, 0x01, 0xa1, 0x01, 0x0a, 0x2c,
	...
	0x20, 0x73, 0x69, 0x7a, 0x65, 0x28, 0x74, 0x68, 0x69, 0x73, 0x29, 0x20, 0x3e, 0x20, 0x30, 0xfa,
	0xb8, 0x18, 0x03, 0x31, 0x47, 0x69, 0x52, 0x08, 0x64, 0x69, 0x73, 0x6b, 0x53, 0x69, 0x7a, 0x65,
	0x22, 0x8b, 0x02, 0x0a, 0x20, 0x53, 0x6f, 0x6c, 0x72, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65,
	...
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x48, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0xa6,
	0x04, 0x0a, 0x55, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x67, 0x65, 0x6e,
	0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x6f, 0x6e, 0x2e, 0x61,
	...
	0x74, 0x65, 0x73, 0x2e, 0x73, 0x6f, 0x6c, 0x72, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74,
	...
	0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2f, 0x73, 0x6f, 0x6c, 0x72, 0x6b,
	0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0xa2,
	0x02, 0x09, 0x43, 0x50, 0x41, 0x43, 0x56, 0x44, 0x4b, 0x53, 0x4d, 0xaa, 0x02, 0x47, 0x43, 0x6c,
	...
	0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xca, 0x02, 0x47, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x50, 0x6c,
	...
	0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5c, 0x53, 0x6f, 0x6c, 0x72, 0x6b,
	0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5c, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xe2,
	0x02, 0x53, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x50, 0x6c, 0x61, 0x6e, 0x74, 0x6f, 0x6e, 0x5c,
	0x41, 0x70, 0x69, 0x73, 0x5c, 0x43, 0x6f, 0x64, 0x65, 0x32, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x5c,
	0x56, 0x31, 0x5c, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x5c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	...
	0x3a, 0x3a, 0x53, 0x6f, 0x6c, 0x72, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73,
	0x3a, 0x3a, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescData = file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDesc
)

func file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescData)
	})
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDescData
}

var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_goTypes = []interface{}{
	(*SolrKubernetes)(nil),                           // 0: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetes
	(*SolrKubernetesSpec)(nil),                       // 1: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpec
	(*SolrKubernetesStatus)(nil),                     // 2: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesStatus
	(*SolrKubernetesSpecSolrContainerSpec)(nil),      // 3: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecSolrContainerSpec
	(*SolrKubernetesSpecConfigSpec)(nil),             // 4: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecConfigSpec
	(*SolrKubernetesSpecZookeeperContainerSpec)(nil), // 5: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecZookeeperContainerSpec
	(*SolrKubernetesStatusStackOutputs)(nil),         // 6: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesStatusStackOutputs
	(*model.ApiResourceMetadata)(nil),                // 7: cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	(*model1.ApiResourceEnvironmentInfo)(nil),        // 8: cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
	(*model2.StackJobSettings)(nil),                  // 9: cloud.planton.apis.iac.v1.stackjob.model.StackJobSettings
	(*model3.IngressSpec)(nil),                       // 10: cloud.planton.apis.commons.kubernetes.model.IngressSpec
...
var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_depIdxs = []int32{
	7,  // 0: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetes.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	1,  // 1: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetes.spec:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpec
	2,  // 2: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetes.status:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesStatus
	8,  // 3: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpec.environment_info:type_name -> cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
	9,  // 4: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpec.stack_job_settings:type_name -> cloud.planton.apis.iac.v1.stackjob.model.StackJobSettings
	3,  // 5: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpec.solr_container:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecSolrContainerSpec
	5,  // 6: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpec.zookeeper_container:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecZookeeperContainerSpec
	10, // 7: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpec.ingress:type_name -> cloud.planton.apis.commons.kubernetes.model.IngressSpec
	11, // 8: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesStatus.lifecycle:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceLifecycle
	12, // 9: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesStatus.audit:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceAudit
	6,  // 10: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesStatus.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesStatusStackOutputs
	13, // 11: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecSolrContainerSpec.image:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerImage
	14, // 12: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecSolrContainerSpec.resources:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerResources
	4,  // 13: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecSolrContainerSpec.config:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecConfigSpec
	14, // 14: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.solrkubernetes.model.SolrKubernetesSpecZookeeperContainerSpec.resources:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerResources
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_solrkubernetes_model_state_proto_depIdxs = nil
}
