...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/deploy/kubernetes/keycloakkubernetes/model/state.proto
...
func (x *KeycloakKubernetes) Reset() {
	*x = KeycloakKubernetes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[0]
...
func (*KeycloakKubernetes) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeycloakKubernetes) GetMetadata() *model.ApiResourceMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type KeycloakKubernetesSpec struct {
	...
	Container *KeycloakKubernetesContainerSpec `protobuf:"bytes,1,opt,name=container,proto3" json:"container,omitempty"`
...
func (x *KeycloakKubernetesSpec) Reset() {
	*x = KeycloakKubernetesSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeycloakKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescGZIP(), []int{1}
}

func (x *KeycloakKubernetesSpec) GetEnvironmentInfo() *model1.ApiResourceEnvironmentInfo {
	if x != nil {
...
func (x *KeycloakKubernetesSpec) GetStackJobSettings() *model2.StackJobSettings {
	if x != nil {
...
func (x *KeycloakKubernetesSpec) GetKubernetesClusterCredentialId() string {
	if x != nil {
...
func (x *KeycloakKubernetesSpec) GetContainer() *KeycloakKubernetesContainerSpec {
	if x != nil {
		return x.Container
	}
	return nil
...
func (x *KeycloakKubernetesSpec) GetIngress() *model3.IngressSpec {
	if x != nil {
		return x.Ingress
	}
	return nil
...
type KeycloakKubernetesStatus struct {
	...
	// stack-outputs
	StackOutputs *KeycloakKubernetesStatusStackOutputs `protobuf:"bytes,1,opt,name=stack_outputs,json=stackOutputs,proto3" json:"stack_outputs,omitempty"`
}

func (x *KeycloakKubernetesStatus) Reset() {
	*x = KeycloakKubernetesStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeycloakKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescGZIP(), []int{2}
}

func (x *KeycloakKubernetesStatus) GetLifecycle() *model.ApiResourceLifecycle {
	if x != nil {
		return x.Lifecycle
	}
	return nil
...
func (x *KeycloakKubernetesStatus) GetAudit() *model.ApiResourceAudit {
	if x != nil {
		return x.Audit
	}
	return nil
...
func (x *KeycloakKubernetesStatus) GetStackJobId() string {
	if x != nil {
		return x.StackJobId
	}
	return ""
...
func (x *KeycloakKubernetesStatus) GetStackOutputs() *KeycloakKubernetesStatusStackOutputs {
	if x != nil {
...
type KeycloakKubernetesContainerSpec struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *KeycloakKubernetesContainerSpec) Reset() {
	*x = KeycloakKubernetesContainerSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *KeycloakKubernetesContainerSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KeycloakKubernetesContainerSpec) ProtoMessage() {}

func (x *KeycloakKubernetesContainerSpec) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KeycloakKubernetesContainerSpec.ProtoReflect.Descriptor instead.
func (*KeycloakKubernetesContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescGZIP(), []int{3}
}

func (x *KeycloakKubernetesContainerSpec) GetResources() *model3.ContainerResources {
	if x != nil {
		return x.Resources
	}
	return nil
...
type KeycloakKubernetesStatusStackOutputs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *KeycloakKubernetesStatusStackOutputs) Reset() {
	*x = KeycloakKubernetesStatusStackOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *KeycloakKubernetesStatusStackOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KeycloakKubernetesStatusStackOutputs) ProtoMessage() {}

func (x *KeycloakKubernetesStatusStackOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KeycloakKubernetesStatusStackOutputs.ProtoReflect.Descriptor instead.
func (*KeycloakKubernetesStatusStackOutputs) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescGZIP(), []int{4}
}

func (x *KeycloakKubernetesStatusStackOutputs) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *KeycloakKubernetesStatusStackOutputs) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *KeycloakKubernetesStatusStackOutputs) GetPortForwardCommand() string {
	if x != nil {
...
func (x *KeycloakKubernetesStatusStackOutputs) GetKubeEndpoint() string {
	if x != nil {
...
func (x *KeycloakKubernetesStatusStackOutputs) GetExternalHostname() string {
	if x != nil {
...
func (x *KeycloakKubernetesStatusStackOutputs) GetInternalHostname() string {
	if x != nil {
...
var File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc1, 0x07, 0x0a, 0x12, 0x4b, 0x65, 0x79, 0x63,
	0x6c, 0x6f, 0x61, 0x6b, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x12, 0x1f,
	...
	0x63, 0x6c, 0x6f, 0x61, 0x6b, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a, 0x2c, 0x90,
	0xb5, 0x18, 0x01, 0x88, 0xa6, 0x1d, 0x18, 0x92, 0xa6, 0x1d, 0x20, 0x08, 0x0a, 0x12, 0x1c, 0x73,
	0x70, 0x65, 0x63, 0x2e, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x65, 0x6e, 0x76, 0x5f, 0x69, 0x64, 0x22, 0xac, 0x04, 0x0a, 0x16,
	...
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x6c, 0x2e,
	...
	0x6c, 0x6f, 0x61, 0x6b, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x43, 0x6f,
	...
	0x63, 0x52, 0x07, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x22, 0x8d, 0x03, 0x0a, 0x18, 0x4b,
	...
	0x64, 0x12, 0x96, 0x01, 0x0a, 0x0d, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x5f, 0x6f, 0x75, 0x74, 0x70,
	0x75, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x71, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	...
	0x61, 0x63, 0x6b, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x22, 0x88, 0x01, 0x0a, 0x1f, 0x4b,
	0x65, 0x79, 0x63, 0x6c, 0x6f, 0x61, 0x6b, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65,
	0x73, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x12, 0x65,
	...
	0x75, 0x72, 0x63, 0x65, 0x73, 0x22, 0x8f, 0x02, 0x0a, 0x24, 0x4b, 0x65, 0x79, 0x63, 0x6c, 0x6f,
	0x61, 0x6b, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74,
	...
	0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0xbe, 0x04, 0x0a, 0x59, 0x62, 0x75, 0x69, 0x6c,
	...
	0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	0xa2, 0x02, 0x09, 0x43, 0x50, 0x41, 0x43, 0x56, 0x44, 0x4b, 0x4b, 0x4d, 0xaa, 0x02, 0x4b, 0x43,
	...
	0x65, 0x74, 0x65, 0x73, 0x2e, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xca, 0x02, 0x4b, 0x43, 0x6c, 0x6f,
	...
	0x65, 0x73, 0x5c, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xe2, 0x02, 0x57, 0x43, 0x6c, 0x6f, 0x75, 0x64,
	...
	0x6f, 0x79, 0x5c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5c, 0x4b, 0x65,
	0x79, 0x63, 0x6c, 0x6f, 0x61, 0x6b, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73,
...
var (
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescData = file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDesc
)

func file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescData)
	})
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDescData
}

var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_goTypes = []interface{}{
	(*KeycloakKubernetes)(nil),                   // 0: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetes
	(*KeycloakKubernetesSpec)(nil),               // 1: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesSpec
	(*KeycloakKubernetesStatus)(nil),             // 2: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStatus
	(*KeycloakKubernetesContainerSpec)(nil),      // 3: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesContainerSpec
	(*KeycloakKubernetesStatusStackOutputs)(nil), // 4: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStatusStackOutputs
...
var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_depIdxs = []int32{
	5,  // 0: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetes.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	1,  // 1: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetes.spec:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesSpec
	2,  // 2: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetes.status:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStatus
	6,  // 3: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesSpec.environment_info:type_name -> cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
	7,  // 4: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesSpec.stack_job_settings:type_name -> cloud.planton.apis.iac.v1.stackjob.model.StackJobSettings
	3,  // 5: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesSpec.container:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesContainerSpec
	8,  // 6: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesSpec.ingress:type_name -> cloud.planton.apis.commons.kubernetes.model.IngressSpec
	9,  // 7: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStatus.lifecycle:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceLifecycle
	10, // 8: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStatus.audit:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceAudit
	4,  // 9: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStatus.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStatusStackOutputs
	11, // 10: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.keycloakkubernetes.model.KeycloakKubernetesContainerSpec.resources:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerResources
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KeycloakKubernetes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KeycloakKubernetesStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KeycloakKubernetesContainerSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KeycloakKubernetesStatusStackOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_keycloakkubernetes_model_state_proto_depIdxs = nil
}
