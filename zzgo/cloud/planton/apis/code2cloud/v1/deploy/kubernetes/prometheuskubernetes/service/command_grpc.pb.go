...
const (
	PrometheusKubernetesCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/previewCreate"
	PrometheusKubernetesCommandController_Create_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/create"
	PrometheusKubernetesCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/previewUpdate"
	PrometheusKubernetesCommandController_Update_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/update"
	PrometheusKubernetesCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/previewDelete"
	PrometheusKubernetesCommandController_Delete_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/delete"
	PrometheusKubernetesCommandController_PreviewRestore_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/previewRestore"
	PrometheusKubernetesCommandController_Restore_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/restore"
	PrometheusKubernetesCommandController_Restart_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/restart"
	PrometheusKubernetesCommandController_Pause_FullMethodName          = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/pause"
	PrometheusKubernetesCommandController_Unpause_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/unpause"
	PrometheusKubernetesCommandController_PreviewRefresh_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/previewRefresh"
	PrometheusKubernetesCommandController_Refresh_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController/refresh"
)
...
func _PrometheusKubernetesCommandController_PreviewRefresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(PrometheusKubernetesCommandControllerServer).PreviewRefresh(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _PrometheusKubernetesCommandController_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(PrometheusKubernetesCommandControllerServer).Refresh(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var PrometheusKubernetesCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesCommandController",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PrometheusKubernetesCommandController_PreviewRefresh_Handler,
		},
		{
			MethodName: "refresh",
			Handler:    _PrometheusKubernetesCommandController_Refresh_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/prometheuskubernetes/service/command.proto",
}
