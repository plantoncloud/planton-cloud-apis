...
const (
	LocustKubernetesCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/previewCreate"
	LocustKubernetesCommandController_Create_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/create"
	LocustKubernetesCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/previewUpdate"
	LocustKubernetesCommandController_Update_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/update"
	LocustKubernetesCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/previewDelete"
	LocustKubernetesCommandController_Delete_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/delete"
	LocustKubernetesCommandController_PreviewRestore_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/previewRestore"
	LocustKubernetesCommandController_Restore_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/restore"
	LocustKubernetesCommandController_Restart_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/restart"
	LocustKubernetesCommandController_Pause_FullMethodName          = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/pause"
	LocustKubernetesCommandController_Unpause_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/unpause"
	LocustKubernetesCommandController_PreviewRefresh_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/previewRefresh"
	LocustKubernetesCommandController_Refresh_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController/refresh"
)
...
func _LocustKubernetesCommandController_PreviewRefresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(LocustKubernetesCommandControllerServer).PreviewRefresh(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _LocustKubernetesCommandController_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(LocustKubernetesCommandControllerServer).Refresh(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var LocustKubernetesCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesCommandController",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LocustKubernetesCommandController_PreviewRefresh_Handler,
		},
		{
			MethodName: "refresh",
			Handler:    _LocustKubernetesCommandController_Refresh_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/locustkubernetes/service/command.proto",
}
