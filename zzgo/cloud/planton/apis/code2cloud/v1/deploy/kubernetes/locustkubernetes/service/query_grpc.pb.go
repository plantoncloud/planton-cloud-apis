...
const (
	LocustKubernetesQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesQueryController/get"
)
...
var LocustKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.service.LocustKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/locustkubernetes/service/query.proto",
}
