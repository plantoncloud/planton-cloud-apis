...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/deploy/kubernetes/locustkubernetes/model/state.proto
...
func (x *LocustKubernetes) Reset() {
	*x = LocustKubernetes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[0]
...
func (*LocustKubernetes) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescGZIP(), []int{0}
}
...
type LocustKubernetesSpec struct {
	...
	MasterContainer *LocustKubernetesSpecContainerSpec `protobuf:"bytes,2,opt,name=master_container,json=masterContainer,proto3" json:"master_container,omitempty"`
	// worker-locust-container spec
	WorkerContainer *LocustKubernetesSpecContainerSpec `protobuf:"bytes,3,opt,name=worker_container,json=workerContainer,proto3" json:"worker_container,omitempty"`
	...
	LoadTest *LocustKubernetesSpecLoadTestSpec `protobuf:"bytes,5,opt,name=load_test,json=loadTest,proto3" json:"load_test,omitempty"`
	...
	HelmValues map[string]string `protobuf:"bytes,6,rep,name=helm_values,json=helmValues,proto3" json:"helm_values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *LocustKubernetesSpec) Reset() {
	*x = LocustKubernetesSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LocustKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescGZIP(), []int{1}
}
...
func (x *LocustKubernetesSpec) GetIngress() *model2.IngressSpec {
	if x != nil {
		return x.Ingress
	}
	return nil
...
type LocustKubernetesStatus struct {
	...
	// stack-outputs
	StackOutputs *LocustKubernetesStatusStackOutputs `protobuf:"bytes,1,opt,name=stack_outputs,json=stackOutputs,proto3" json:"stack_outputs,omitempty"`
}

func (x *LocustKubernetesStatus) Reset() {
	*x = LocustKubernetesStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LocustKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescGZIP(), []int{2}
}
...
func (x *LocustKubernetesStatus) GetStackOutputs() *LocustKubernetesStatusStackOutputs {
	if x != nil {
...
func (x *LocustKubernetesSpecContainerSpec) Reset() {
	*x = LocustKubernetesSpecContainerSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LocustKubernetesSpecContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescGZIP(), []int{3}
}

func (x *LocustKubernetesSpecContainerSpec) GetResources() *model2.ContainerResources {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *LocustKubernetesSpecLoadTestSpec) Reset() {
	*x = LocustKubernetesSpecLoadTestSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LocustKubernetesSpecLoadTestSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescGZIP(), []int{4}
}
...
type LocustKubernetesStatusStackOutputs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LocustKubernetesStatusStackOutputs) Reset() {
	*x = LocustKubernetesStatusStackOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LocustKubernetesStatusStackOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LocustKubernetesStatusStackOutputs) ProtoMessage() {}

func (x *LocustKubernetesStatusStackOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LocustKubernetesStatusStackOutputs.ProtoReflect.Descriptor instead.
func (*LocustKubernetesStatusStackOutputs) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescGZIP(), []int{5}
}

func (x *LocustKubernetesStatusStackOutputs) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *LocustKubernetesStatusStackOutputs) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *LocustKubernetesStatusStackOutputs) GetPortForwardCommand() string {
	if x != nil {
...
func (x *LocustKubernetesStatusStackOutputs) GetKubeEndpoint() string {
	if x != nil {
...
func (x *LocustKubernetesStatusStackOutputs) GetExternalHostname() string {
	if x != nil {
...
func (x *LocustKubernetesStatusStackOutputs) GetInternalHostname() string {
	if x != nil {
...
var File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDesc = []byte{
	...
	0x2f, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2f, 0x65, 0x6e, 0x75, 0x6d,
	...
	0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb7, 0x07,
	0x0a, 0x10, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74,
	0x65, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x70, 0x69, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
	...
	0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x73, 0x0a, 0x04, 0x73, 0x70, 0x65,
	0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5f, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e,
	...
	0x79, 0x2e, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x6c, 0x6f, 0x63,
	0x75, 0x73, 0x74, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x6d, 0x6f,
	0x64, 0x65, 0x6c, 0x2e, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x79,
	0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x61,
	...
	0x74, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a, 0x2c, 0x90, 0xb5, 0x18, 0x01, 0x88,
	0xa6, 0x1d, 0x1d, 0x92, 0xa6, 0x1d, 0x20, 0x08, 0x0a, 0x12, 0x1c, 0x73, 0x70, 0x65, 0x63, 0x2e,
	0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f,
	0x2e, 0x65, 0x6e, 0x76, 0x5f, 0x69, 0x64, 0x22, 0x8b, 0x07, 0x0a, 0x14, 0x4c, 0x6f, 0x63, 0x75,
	...
	0x12, 0x9f, 0x01, 0x0a, 0x10, 0x6d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x6c, 0x2e, 0x63, 0x6c,
	...
	0x73, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b, 0x75,
	...
	0x01, 0x52, 0x0f, 0x6d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x12, 0x9f, 0x01, 0x0a, 0x10, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x5f, 0x63, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x6c, 0x2e,
	...
	0x74, 0x65, 0x73, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74,
	...
	0xc8, 0x01, 0x01, 0x52, 0x0f, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	0x69, 0x6e, 0x65, 0x72, 0x12, 0x52, 0x0a, 0x07, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70, 0x6c,
	...
	0x64, 0x65, 0x6c, 0x2e, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x53, 0x70, 0x65, 0x63, 0x52,
	0x07, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x88, 0x01, 0x0a, 0x09, 0x6c, 0x6f, 0x61,
	0x64, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x6b, 0x2e, 0x63,
	...
	0x65, 0x73, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b,
	0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63, 0x4c, 0x6f, 0x61,
	0x64, 0x54, 0x65, 0x73, 0x74, 0x53, 0x70, 0x65, 0x63, 0x52, 0x08, 0x6c, 0x6f, 0x61, 0x64, 0x54,
	0x65, 0x73, 0x74, 0x12, 0x90, 0x01, 0x0a, 0x0b, 0x68, 0x65, 0x6c, 0x6d, 0x5f, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x6f, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	...
	0x6c, 0x6f, 0x79, 0x2e, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x6c,
	...
	0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x48, 0x65, 0x6c, 0x6d, 0x56,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x87, 0x03, 0x0a, 0x16, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74,
	...
	0x73, 0x74, 0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x92, 0x01, 0x0a, 0x0d, 0x73,
	...
	0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53,
	...
	0xae, 0x01, 0x0a, 0x21, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65,
	0x72, 0x53, 0x70, 0x65, 0x63, 0x12, 0x65, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3f, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	...
	0x01, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x22, 0x0a, 0x08,
	...
	0x22, 0x8d, 0x03, 0x0a, 0x20, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b, 0x75, 0x62, 0x65, 0x72,
	0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63, 0x4c, 0x6f, 0x61, 0x64, 0x54, 0x65, 0x73,
	0x74, 0x53, 0x70, 0x65, 0x63, 0x12, 0x1a, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	...
	,
	...
	0x22, 0x8d, 0x02, 0x0a, 0x22, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x4b, 0x75, 0x62, 0x65, 0x72,
	...
	0x42, 0xb2, 0x04, 0x0a, 0x57, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x67,
	...
	0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x79, 0x67, 0x69, 0x74, 0x68,
	...
	0x6c, 0x6f, 0x79, 0x2f, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2f, 0x6c,
	0x6f, 0x63, 0x75, 0x73, 0x74, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2f,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0xa2, 0x02, 0x09, 0x43, 0x50, 0x41, 0x43, 0x56, 0x44, 0x4b, 0x4c,
	0x4d, 0xaa, 0x02, 0x49, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x50, 0x6c, 0x61, 0x6e, 0x74, 0x6f,
	...
	0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xca, 0x02, 0x49,
	...
	0x65, 0x73, 0x5c, 0x4c, 0x6f, 0x63, 0x75, 0x73, 0x74, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65,
	0x74, 0x65, 0x73, 0x5c, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xe2, 0x02, 0x55, 0x43, 0x6c, 0x6f, 0x75,
	...
	0x6c, 0x6f, 0x79, 0x5c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5c, 0x4c,
	...
	0x61, 0xea, 0x02, 0x51, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x3a, 0x3a, 0x50, 0x6c, 0x61, 0x6e, 0x74,
	...
	0x3a, 0x3a, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x3a, 0x3a, 0x4c, 0x6f,
	0x63, 0x75, 0x73, 0x74, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x3a, 0x3a,
	0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescData = file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDesc
)

func file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescData)
	})
	return file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDescData
}

var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_goTypes = []interface{}{
	(*LocustKubernetes)(nil),                   // 0: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetes
	(*LocustKubernetesSpec)(nil),               // 1: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec
	(*LocustKubernetesStatus)(nil),             // 2: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesStatus
	(*LocustKubernetesSpecContainerSpec)(nil),  // 3: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecContainerSpec
	(*LocustKubernetesSpecLoadTestSpec)(nil),   // 4: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecLoadTestSpec
	(*LocustKubernetesStatusStackOutputs)(nil), // 5: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesStatusStackOutputs
	nil,                               // 6: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.HelmValuesEntry
	nil,                               // 7: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecLoadTestSpec.LibFilesContentEntry
	...
	(*model2.IngressSpec)(nil),                // 10: cloud.planton.apis.commons.kubernetes.model.IngressSpec
	...
	(*model2.ContainerResources)(nil),         // 13: cloud.planton.apis.commons.kubernetes.model.ContainerResources
}
var file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_depIdxs = []int32{
	8,  // 0: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetes.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	1,  // 1: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetes.spec:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec
	2,  // 2: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetes.status:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesStatus
	9,  // 3: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.environment_info:type_name -> cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
	3,  // 4: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.master_container:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecContainerSpec
	3,  // 5: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.worker_container:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecContainerSpec
	10, // 6: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.ingress:type_name -> cloud.planton.apis.commons.kubernetes.model.IngressSpec
	4,  // 7: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.load_test:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecLoadTestSpec
	6,  // 8: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.helm_values:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpec.HelmValuesEntry
	11, // 9: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesStatus.lifecycle:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceLifecycle
	12, // 10: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesStatus.audit:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceAudit
	5,  // 11: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesStatus.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesStatusStackOutputs
	13, // 12: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecContainerSpec.resources:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerResources
	7,  // 13: cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecLoadTestSpec.lib_files_content:type_name -> cloud.planton.apis.code2cloud.v1.deploy.kubernetes.locustkubernetes.model.LocustKubernetesSpecLoadTestSpec.LibFilesContentEntry
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LocustKubernetesStatusStackOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_deploy_kubernetes_locustkubernetes_model_state_proto_depIdxs = nil
}
