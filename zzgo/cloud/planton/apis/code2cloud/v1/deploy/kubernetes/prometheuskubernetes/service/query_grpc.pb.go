...
const (
	PrometheusKubernetesQueryController_Get_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesQueryController/get"
	PrometheusKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesQueryController/getPassword"
)
...
var PrometheusKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.prometheuskubernetes.service.PrometheusKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/prometheuskubernetes/service/query.proto",
}
