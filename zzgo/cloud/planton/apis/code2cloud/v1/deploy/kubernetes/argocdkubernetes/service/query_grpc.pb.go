...
const (
	ArgocdKubernetesQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.argocdkubernetes.service.ArgocdKubernetesQueryController/get"
)
...
var ArgocdKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.argocdkubernetes.service.ArgocdKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/argocdkubernetes/service/query.proto",
}
