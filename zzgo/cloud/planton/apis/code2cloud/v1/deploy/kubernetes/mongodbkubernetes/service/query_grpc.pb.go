...
const (
	MongodbKubernetesQueryController_Get_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.mongodbkubernetes.service.MongodbKubernetesQueryController/get"
	MongodbKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.kubernetes.mongodbkubernetes.service.MongodbKubernetesQueryController/getPassword"
)
...
var MongodbKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.kubernetes.mongodbkubernetes.service.MongodbKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/kubernetes/mongodbkubernetes/service/query.proto",
}
