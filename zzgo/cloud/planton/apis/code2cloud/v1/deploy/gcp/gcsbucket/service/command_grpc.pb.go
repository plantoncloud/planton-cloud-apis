...
const (
	GcsBucketCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/previewCreate"
	GcsBucketCommandController_Create_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/create"
	GcsBucketCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/previewUpdate"
	GcsBucketCommandController_Update_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/update"
	GcsBucketCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/previewDelete"
	GcsBucketCommandController_Delete_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/delete"
	GcsBucketCommandController_PreviewRestore_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/previewRestore"
	GcsBucketCommandController_Restore_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/restore"
	GcsBucketCommandController_PreviewRefresh_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/previewRefresh"
	GcsBucketCommandController_Refresh_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController/refresh"
)
...
var GcsBucketCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.gcp.gcsbucket.service.GcsBucketCommandController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/gcp/gcsbucket/service/command.proto",
}
