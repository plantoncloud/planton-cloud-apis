...
const (
	GcpArtifactRegistryQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.gcp.gcpartifactregistry.service.GcpArtifactRegistryQueryController/get"
)
...
var GcpArtifactRegistryQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.gcp.gcpartifactregistry.service.GcpArtifactRegistryQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/gcp/gcpartifactregistry/service/query.proto",
}
