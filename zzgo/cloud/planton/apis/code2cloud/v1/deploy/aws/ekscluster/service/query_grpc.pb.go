...
const (
	EksClusterQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.deploy.aws.ekscluster.service.EksClusterQueryController/get"
)
...
var EksClusterQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.deploy.aws.ekscluster.service.EksClusterQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/deploy/aws/ekscluster/service/query.proto",
}
