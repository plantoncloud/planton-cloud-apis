...
type ArgocdKubernetesStackResponse struct {
	...
	// stack outputs
	Outputs *model1.ArgocdKubernetesStatusStackOutputs `protobuf:"bytes,3,opt,name=outputs,proto3" json:"outputs,omitempty"`
}
...
func (x *ArgocdKubernetesStackResponse) GetOutputs() *model1.ArgocdKubernetesStatusStackOutputs {
	if x != nil {
		return x.Outputs
	}
	return nil
...
var file_cloud_planton_apis_code2cloud_v1_argocdkubernetes_stack_model_io_proto_rawDesc = []byte{
	...
	0x22, 0x87, 0x02, 0x0a, 0x1d, 0x41, 0x72, 0x67, 0x6f, 0x63, 0x64, 0x4b, 0x75, 0x62, 0x65, 0x72,
	...
	0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x72, 0x67, 0x6f, 0x63, 0x64, 0x6b, 0x75,
...
var file_cloud_planton_apis_code2cloud_v1_argocdkubernetes_stack_model_io_proto_goTypes = []interface{}{
	...
	(*model1.ArgocdKubernetesStatusStackOutputs)(nil), // 6: cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetesStatusStackOutputs
}
var file_cloud_planton_apis_code2cloud_v1_argocdkubernetes_stack_model_io_proto_depIdxs = []int32{
	...
	6, // 4: cloud.planton.apis.code2cloud.v1.argocdkubernetes.stack.model.ArgocdKubernetesStackResponse.outputs:type_name -> cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetesStatusStackOutputs
