...
func (x *ArgocdKubernetesStatus) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *ArgocdKubernetesStatus) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *ArgocdKubernetesStatus) GetPortForwardCommand() string {
	if x != nil {
...
func (x *ArgocdKubernetesStatus) GetKubeEndpoint() string {
	if x != nil {
...
func (x *ArgocdKubernetesStatus) GetExternalHostname() string {
	if x != nil {
...
func (x *ArgocdKubernetesStatus) GetInternalHostname() string {
	if x != nil {
...
var file_cloud_planton_apis_code2cloud_v1_argocdkubernetes_model_state_proto_rawDesc = []byte{
	...
	0x53, 0x70, 0x65, 0x63, 0x52, 0x07, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x22, 0xe3, 0x03,
	...
	0x61, 0x6d, 0x65, 0x22, 0x91, 0x01, 0x0a, 0x21, 0x41, 0x72, 0x67, 0x6f, 0x63, 0x64, 0x4b, 0x75,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0xc2, 0x03, 0x0a, 0x45, 0x62, 0x75, 0x69, 0x6c,
...
var file_cloud_planton_apis_code2cloud_v1_argocdkubernetes_model_state_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_cloud_planton_apis_code2cloud_v1_argocdkubernetes_model_state_proto_depIdxs = []int32{
	4, // 0: cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetes.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	...
	5, // 3: cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetesSpec.environment_info:type_name -> cloud.planton.apis.code2cloud.v1.environment.model.ApiResourceEnvironmentInfo
	...
	6, // 5: cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetesSpec.ingress:type_name -> cloud.planton.apis.code2cloud.v1.kubecluster.model.IngressSpec
	7, // 6: cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetesStatus.lifecycle:type_name -> cloud.planton.apis.commons.apiresource.model.RunnableApiResourceLifecycle
	8, // 7: cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetesStatus.audit:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceAudit
	9, // 8: cloud.planton.apis.code2cloud.v1.argocdkubernetes.model.ArgocdKubernetesSpecContainerSpec.resources:type_name -> cloud.planton.apis.code2cloud.v1.kubecluster.model.ContainerResources
