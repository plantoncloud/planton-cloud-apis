...
func (c *microserviceKubernetesQueryControllerClient) GetById(ctx context.Context, in *model.MicroserviceKubernetesId, opts ...grpc.CallOption) (*model.MicroserviceKubernetes, error) {
	out := new(model.MicroserviceKubernetes)
	err := c.cc.Invoke(ctx, MicroserviceKubernetesQueryController_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MicroserviceKubernetesQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model.MicroserviceKubernetesId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MicroserviceKubernetesQueryControllerServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MicroserviceKubernetesQueryController_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MicroserviceKubernetesQueryControllerServer).GetById(ctx, req.(*model.MicroserviceKubernetesId))
	}
...
func _MicroserviceKubernetesQueryController_GetByCodeProjectId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(MicroserviceKubernetesQueryControllerServer).GetByCodeProjectId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MicroserviceKubernetesQueryController_GetByCodeProjectId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MicroserviceKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.microservicekubernetes.service.MicroserviceKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/microservicekubernetes/service/query.proto",
}
