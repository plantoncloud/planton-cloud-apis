...
const (
	KafkaKubernetesQueryController_Get_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.kubernetes.kafkakubernetes.service.KafkaKubernetesQueryController/get"
	KafkaKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kubernetes.kafkakubernetes.service.KafkaKubernetesQueryController/getPassword"
)
...
var KafkaKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kubernetes.kafkakubernetes.service.KafkaKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/kubernetes/kafkakubernetes/service/query.proto",
}

const (
	KafkaTopicQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kubernetes.kafkakubernetes.service.KafkaTopicQueryController/get"
)
...
var KafkaTopicQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kubernetes.kafkakubernetes.service.KafkaTopicQueryController",
