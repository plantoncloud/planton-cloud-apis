...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/kubernetes/microservicekubernetes/model/io.proto
...
func (x *MicroserviceKubernetesId) Reset() {
	*x = MicroserviceKubernetesId{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes[0]
...
func (*MicroserviceKubernetesId) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescGZIP(), []int{0}
}
...
func (x *MicroserviceKubernetesEnvVarMap) Reset() {
	*x = MicroserviceKubernetesEnvVarMap{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MicroserviceKubernetesEnvVarMap) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetMicroserviceKubernetesEnvVarMapInput) Reset() {
	*x = GetMicroserviceKubernetesEnvVarMapInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetMicroserviceKubernetesEnvVarMapInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescGZIP(), []int{2}
}
...
var File_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDesc = []byte{
	...
	,
	...
	0xa6, 0x04, 0x0a, 0x27, 0x47, 0x65, 0x74, 0x4d, 0x69, 0x63, 0x72, 0x6f, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x45, 0x6e, 0x76,
	0x56, 0x61, 0x72, 0x4d, 0x61, 0x70, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x44, 0x0a, 0x1a, 0x6d,
	...
	0x64, 0x12, 0x9f, 0x01, 0x0a, 0x09, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x80, 0x01, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70,
	...
	0x6c, 0x65, 0x73, 0x12, 0x98, 0x01, 0x0a, 0x07, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x7e, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70, 0x6c,
	...
	0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x45, 0x6e, 0x76, 0x56, 0x61, 0x72,
	0x4d, 0x61, 0x70, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0xa7, 0x04, 0x0a, 0x56, 0x62, 0x75, 0x69,
...
var (
	file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescData = file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDesc
)

func file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescData)
	})
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDescData
}

var file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_goTypes = []interface{}{
	(*MicroserviceKubernetesId)(nil),                // 0: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.MicroserviceKubernetesId
	(*MicroserviceKubernetesEnvVarMap)(nil),         // 1: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.MicroserviceKubernetesEnvVarMap
	(*GetMicroserviceKubernetesEnvVarMapInput)(nil), // 2: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.GetMicroserviceKubernetesEnvVarMapInput
	nil, // 3: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.MicroserviceKubernetesEnvVarMap.ValueEntry
	nil, // 4: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.GetMicroserviceKubernetesEnvVarMapInput.VariablesEntry
	nil, // 5: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.GetMicroserviceKubernetesEnvVarMapInput.SecretsEntry
}
var file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_depIdxs = []int32{
	3, // 0: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.MicroserviceKubernetesEnvVarMap.value:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.MicroserviceKubernetesEnvVarMap.ValueEntry
	4, // 1: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.GetMicroserviceKubernetesEnvVarMapInput.variables:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.GetMicroserviceKubernetesEnvVarMapInput.VariablesEntry
	5, // 2: cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.GetMicroserviceKubernetesEnvVarMapInput.secrets:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.model.GetMicroserviceKubernetesEnvVarMapInput.SecretsEntry
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_microservicekubernetes_model_io_proto_depIdxs = nil
}
