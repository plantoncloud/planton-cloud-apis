...
const (
	MicroserviceKubernetesQueryController_Get_FullMethodName          = "/cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.service.MicroserviceKubernetesQueryController/get"
	MicroserviceKubernetesQueryController_GetEnvVarMap_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.service.MicroserviceKubernetesQueryController/getEnvVarMap"
)
...
var MicroserviceKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kubernetes.microservicekubernetes.service.MicroserviceKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/kubernetes/microservicekubernetes/service/query.proto",
}
