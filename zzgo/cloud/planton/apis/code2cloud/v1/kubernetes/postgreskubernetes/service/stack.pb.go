...
var File_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x21, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x4b, 0x75, 0x62, 0x65, 0x72,
...
var file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_goTypes = []interface{}{
	(*model.PostgresKubernetesStackInput)(nil),    // 0: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStackInput
	(*model.PostgresKubernetesStackResponse)(nil), // 1: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStackResponse
}
var file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_depIdxs = []int32{
	0, // 0: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.service.PostgresKubernetesStackController.execute:input_type -> cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStackInput
	1, // 1: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.service.PostgresKubernetesStackController.execute:output_type -> cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStackResponse
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_depIdxs,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_service_stack_proto_depIdxs = nil
}
