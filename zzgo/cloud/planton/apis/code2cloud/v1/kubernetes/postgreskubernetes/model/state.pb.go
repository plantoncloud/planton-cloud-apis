...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/kubernetes/postgreskubernetes/model/state.proto
...
func (x *PostgresKubernetes) Reset() {
	*x = PostgresKubernetes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[0]
...
func (*PostgresKubernetes) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescGZIP(), []int{0}
}
...
func (x *PostgresKubernetesSpec) Reset() {
	*x = PostgresKubernetesSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PostgresKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescGZIP(), []int{1}
}
...
func (x *PostgresKubernetesStatus) Reset() {
	*x = PostgresKubernetesStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PostgresKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescGZIP(), []int{2}
}
...
func (x *PostgresKubernetesSpecContainerSpec) Reset() {
	*x = PostgresKubernetesSpecContainerSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PostgresKubernetesSpecContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescGZIP(), []int{3}
}
...
func (x *PostgresKubernetesStatusStackOutputs) Reset() {
	*x = PostgresKubernetesStatusStackOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PostgresKubernetesStatusStackOutputs) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescGZIP(), []int{4}
}
...
var File_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb3, 0x07, 0x0a, 0x12, 0x50, 0x6f,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x70, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5c, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70, 0x6c,
	...
	0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x76, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5e, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	...
	0x73, 0x3a, 0x2c, 0x90, 0xb5, 0x18, 0x01, 0x88, 0xa6, 0x1d, 0x21, 0x92, 0xa6, 0x1d, 0x20, 0x08,
	...
	0xb1, 0x04, 0x0a, 0x16, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x4b, 0x75, 0x62, 0x65,
	...
	0x72, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x8f, 0x01,
	...
	0x65, 0x73, 0x73, 0x22, 0x86, 0x03, 0x0a, 0x18, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73,
	...
	0x73, 0x74, 0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x8f, 0x01, 0x0a, 0x0d, 0x73,
	...
	0x65, 0x73, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x52, 0x0c,
	0x73, 0x74, 0x61, 0x63, 0x6b, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x22, 0x81, 0x03, 0x0a,
	...
	0x22, 0x8f, 0x02, 0x0a, 0x24, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x4b, 0x75, 0x62,
	...
	0x6d, 0x65, 0x42, 0x92, 0x04, 0x0a, 0x52, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x75, 0x66,
	...
	0x43, 0x50, 0x41, 0x43, 0x56, 0x4b, 0x50, 0x4d, 0xaa, 0x02, 0x44, 0x43, 0x6c, 0x6f, 0x75, 0x64,
...
var (
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescData = file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDesc
)

func file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescData)
	})
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDescData
}

var file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_goTypes = []interface{}{
	(*PostgresKubernetes)(nil),                   // 0: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetes
	(*PostgresKubernetesSpec)(nil),               // 1: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpec
	(*PostgresKubernetesStatus)(nil),             // 2: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStatus
	(*PostgresKubernetesSpecContainerSpec)(nil),  // 3: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpecContainerSpec
	(*PostgresKubernetesStatusStackOutputs)(nil), // 4: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStatusStackOutputs
...
var file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_depIdxs = []int32{
	5,  // 0: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetes.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	1,  // 1: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetes.spec:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpec
	2,  // 2: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetes.status:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStatus
	6,  // 3: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpec.environment_info:type_name -> cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
	7,  // 4: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpec.stack_job_settings:type_name -> cloud.planton.apis.iac.v1.stackjob.model.StackJobSettings
	3,  // 5: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpec.container:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpecContainerSpec
	8,  // 6: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpec.ingress:type_name -> cloud.planton.apis.commons.kubernetes.model.IngressSpec
	9,  // 7: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStatus.lifecycle:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceLifecycle
	10, // 8: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStatus.audit:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceAudit
	4,  // 9: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStatus.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesStatusStackOutputs
	11, // 10: cloud.planton.apis.code2cloud.v1.kubernetes.postgreskubernetes.model.PostgresKubernetesSpecContainerSpec.resources:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerResources
...
func file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_postgreskubernetes_model_state_proto_depIdxs = nil
}
