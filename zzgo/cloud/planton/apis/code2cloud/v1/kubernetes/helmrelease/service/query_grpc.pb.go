...
const (
	HelmReleaseQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kubernetes.helmrelease.service.HelmReleaseQueryController/get"
)
...
var HelmReleaseQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kubernetes.helmrelease.service.HelmReleaseQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/kubernetes/helmrelease/service/query.proto",
}
