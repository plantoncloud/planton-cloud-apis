...
const (
	RedisKubernetesQueryController_Get_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.kubernetes.rediskubernetes.service.RedisKubernetesQueryController/get"
	RedisKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kubernetes.rediskubernetes.service.RedisKubernetesQueryController/getPassword"
)
...
var RedisKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kubernetes.rediskubernetes.service.RedisKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/kubernetes/rediskubernetes/service/query.proto",
}
