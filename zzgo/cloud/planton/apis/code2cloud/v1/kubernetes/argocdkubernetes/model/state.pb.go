...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/kubernetes/argocdkubernetes/model/state.proto
...
func (x *ArgocdKubernetes) Reset() {
	*x = ArgocdKubernetes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[0]
...
func (*ArgocdKubernetes) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescGZIP(), []int{0}
}
...
func (x *ArgocdKubernetesSpec) Reset() {
	*x = ArgocdKubernetesSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ArgocdKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescGZIP(), []int{1}
}
...
type ArgocdKubernetesStatus struct {
	...
	StackOutputs *ArgocdKubernetesStackOutputs `protobuf:"bytes,1,opt,name=stack_outputs,json=stackOutputs,proto3" json:"stack_outputs,omitempty"`
}

func (x *ArgocdKubernetesStatus) Reset() {
	*x = ArgocdKubernetesStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ArgocdKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescGZIP(), []int{2}
}
...
func (x *ArgocdKubernetesStatus) GetStackOutputs() *ArgocdKubernetesStackOutputs {
	if x != nil {
...
func (x *ArgocdKubernetesSpecContainerSpec) Reset() {
	*x = ArgocdKubernetesSpecContainerSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ArgocdKubernetesSpecContainerSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescGZIP(), []int{3}
}
...
func (x *ArgocdKubernetesStackOutputs) Reset() {
	*x = ArgocdKubernetesStackOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ArgocdKubernetesStackOutputs) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescGZIP(), []int{4}
}
...
var File_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x07, 0x0a, 0x10, 0x41,
	0x72, 0x67, 0x6f, 0x63, 0x64, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x12,
	...
	0x1d, 0x03, 0x92, 0xa6, 0x1d, 0x20, 0x08, 0x0a, 0x12, 0x1c, 0x73, 0x70, 0x65, 0x63, 0x2e, 0x65,
	0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x2e,
	0x65, 0x6e, 0x76, 0x5f, 0x69, 0x64, 0x22, 0xab, 0x04, 0x0a, 0x14, 0x41, 0x72, 0x67, 0x6f, 0x63,
	...
	0x63, 0x64, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x70, 0x65, 0x63,
	...
	0x72, 0x65, 0x73, 0x73, 0x22, 0xfa, 0x02, 0x0a, 0x16, 0x41, 0x72, 0x67, 0x6f, 0x63, 0x64, 0x4b,
	...
	0xc8, 0x01, 0x01, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x22, 0x87,
	0x02, 0x0a, 0x1c, 0x41, 0x72, 0x67, 0x6f, 0x63, 0x64, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65,
	...
	0x48, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x86, 0x04, 0x0a, 0x50, 0x62, 0x75, 0x69,
	...
	0x74, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x72, 0x67, 0x69, 0x74,
	...
	0x02, 0x08, 0x43, 0x50, 0x41, 0x43, 0x56, 0x4b, 0x41, 0x4d, 0xaa, 0x02, 0x42, 0x43, 0x6c, 0x6f,
	...
	0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x41, 0x72, 0x67, 0x6f, 0x63, 0x64, 0x6b,
	...
	0x56, 0x31, 0x5c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5c, 0x41, 0x72,
	0x67, 0x6f, 0x63, 0x64, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5c, 0x4d,
	0x6f, 0x64, 0x65, 0x6c, 0xe2, 0x02, 0x4e, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x50, 0x6c, 0x61,
...
var (
	file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescOnce sync.Once
	file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescData = file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDesc
)

func file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescGZIP() []byte {
	file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescOnce.Do(func() {
		file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescData)
	})
	return file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDescData
}

var file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_goTypes = []interface{}{
	(*ArgocdKubernetes)(nil),                  // 0: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetes
	(*ArgocdKubernetesSpec)(nil),              // 1: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpec
	(*ArgocdKubernetesStatus)(nil),            // 2: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesStatus
	(*ArgocdKubernetesSpecContainerSpec)(nil), // 3: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpecContainerSpec
	(*ArgocdKubernetesStackOutputs)(nil),      // 4: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesStackOutputs
...
var file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_depIdxs = []int32{
	5,  // 0: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetes.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	1,  // 1: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetes.spec:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpec
	2,  // 2: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetes.status:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesStatus
	6,  // 3: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpec.environment_info:type_name -> cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
	7,  // 4: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpec.stack_job_settings:type_name -> cloud.planton.apis.iac.v1.stackjob.model.StackJobSettings
	3,  // 5: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpec.container:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpecContainerSpec
	8,  // 6: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpec.ingress:type_name -> cloud.planton.apis.commons.kubernetes.model.IngressSpec
	9,  // 7: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesStatus.lifecycle:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceLifecycle
	10, // 8: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesStatus.audit:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceAudit
	4,  // 9: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesStatus.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesStackOutputs
	11, // 10: cloud.planton.apis.code2cloud.v1.kubernetes.argocdkubernetes.model.ArgocdKubernetesSpecContainerSpec.resources:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerResources
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ArgocdKubernetesStackOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_depIdxs,
		MessageInfos:      file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_msgTypes,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_argocdkubernetes_model_state_proto_depIdxs = nil
}
