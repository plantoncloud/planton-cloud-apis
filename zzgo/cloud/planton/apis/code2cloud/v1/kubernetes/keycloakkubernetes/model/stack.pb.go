...
type KeycloakKubernetesStackInput struct {
	...
	// api-resource
	ApiResource *KeycloakKubernetes `protobuf:"bytes,97,opt,name=api_resource,json=apiResource,proto3" json:"api_resource,omitempty"`
...
func (x *KeycloakKubernetesStackInput) GetPulumiBackendCredential() *model1.PulumiBackendCredential {
	if x != nil {
...
// keycloak-kubernetes stack-response
...
var file_cloud_planton_apis_code2cloud_v1_kubernetes_keycloakkubernetes_model_stack_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa2, 0x04, 0x0a, 0x1c, 0x4b, 0x65, 0x79, 0x63, 0x6c, 0x6f, 0x61, 0x6b, 0x4b,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x9e, 0x02, 0x0a, 0x1f, 0x4b, 0x65, 0x79, 0x63,
	...
	0x31, 0x2e, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x4b, 0x65, 0x79,
...
var file_cloud_planton_apis_code2cloud_v1_kubernetes_keycloakkubernetes_model_stack_proto_goTypes = []interface{}{
	...
	(*KeycloakKubernetes)(nil),                 // 4: cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetes
	...
	(*KeycloakKubernetesStackOutputs)(nil),     // 7: cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStackOutputs
}
var file_cloud_planton_apis_code2cloud_v1_kubernetes_keycloakkubernetes_model_stack_proto_depIdxs = []int32{
	...
	3, // 1: cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStackInput.pulumi_backend_credential:type_name -> cloud.planton.apis.connect.v1.pulumibackendcredential.model.PulumiBackendCredential
	4, // 2: cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStackInput.api_resource:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetes
	5, // 3: cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStackInput.kubernetes_cluster_credential:type_name -> cloud.planton.apis.connect.v1.kubernetesclustercredential.model.KubernetesClusterCredential
	6, // 4: cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStackResponse.progress_event:type_name -> cloud.planton.apis.iac.v1.stackjob.model.progress.StackJobProgressEvent
	7, // 5: cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStackResponse.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.kubernetes.keycloakkubernetes.model.KeycloakKubernetesStackOutputs
