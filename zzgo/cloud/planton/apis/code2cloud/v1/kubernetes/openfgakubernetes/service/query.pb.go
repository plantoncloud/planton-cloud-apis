...
// 	protoc        (unknown)
// source: cloud/planton/apis/code2cloud/v1/kubernetes/openfgakubernetes/service/query.proto
...
var File_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto protoreflect.FileDescriptor

var file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xb1, 0x04, 0x0a, 0x20, 0x4f, 0x70, 0x65, 0x6e, 0x66, 0x67, 0x61, 0x4b, 0x75, 0x62,
	...
	0x22, 0x3e, 0xc2, 0xb8, 0x18, 0x36, 0x08, 0x02, 0x10, 0x20, 0x1a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x22, 0x29, 0x75, 0x6e, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x64, 0x20,
	0x74, 0x6f, 0x20, 0x6c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x20, 0x6f, 0x70, 0x65, 0x6e, 0x66, 0x67,
	...
	0x08, 0x04, 0x10, 0x20, 0x1a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x32, 0x75, 0x6e, 0x61,
	...
	0x04, 0xa0, 0xff, 0x2b, 0x20, 0x42, 0x98, 0x04, 0x0a, 0x53, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e,
	...
	0x63, 0x65, 0xa2, 0x02, 0x08, 0x43, 0x50, 0x41, 0x43, 0x56, 0x4b, 0x4f, 0x53, 0xaa, 0x02, 0x45,
	...
	0x66, 0x67, 0x61, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x53, 0x65,
...
var file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_goTypes = []interface{}{
	(*model.OpenfgaKubernetesId)(nil),       // 0: cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.model.OpenfgaKubernetesId
	(*model.OpenfgaKubernetes)(nil),         // 1: cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.model.OpenfgaKubernetes
	(*model.OpenfgaKubernetesPassword)(nil), // 2: cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.model.OpenfgaKubernetesPassword
}
var file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_depIdxs = []int32{
	0, // 0: cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.service.OpenfgaKubernetesQueryController.get:input_type -> cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.model.OpenfgaKubernetesId
	0, // 1: cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.service.OpenfgaKubernetesQueryController.getPassword:input_type -> cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.model.OpenfgaKubernetesId
	1, // 2: cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.service.OpenfgaKubernetesQueryController.get:output_type -> cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.model.OpenfgaKubernetes
	2, // 3: cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.service.OpenfgaKubernetesQueryController.getPassword:output_type -> cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.model.OpenfgaKubernetesPassword
...
func init() {
	file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_init()
}
func file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_init() {
	if File_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_goTypes,
		DependencyIndexes: file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_depIdxs,
	}.Build()
	File_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto = out.File
	file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_rawDesc = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_goTypes = nil
	file_cloud_planton_apis_code2cloud_v1_kubernetes_openfgakubernetes_service_query_proto_depIdxs = nil
}
