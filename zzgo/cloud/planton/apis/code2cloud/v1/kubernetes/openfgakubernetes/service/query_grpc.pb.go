...
const (
	OpenfgaKubernetesQueryController_Get_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.service.OpenfgaKubernetesQueryController/get"
	OpenfgaKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.service.OpenfgaKubernetesQueryController/getPassword"
)
...
var OpenfgaKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.kubernetes.openfgakubernetes.service.OpenfgaKubernetesQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/kubernetes/openfgakubernetes/service/query.proto",
}
