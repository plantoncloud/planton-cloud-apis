...
const (
	CustomEndpointCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointCommandController/previewCreate"
	CustomEndpointCommandController_Create_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointCommandController/create"
	CustomEndpointCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointCommandController/previewUpdate"
	CustomEndpointCommandController_Update_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointCommandController/update"
	CustomEndpointCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointCommandController/previewDelete"
...
var CustomEndpointCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointCommandController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/customendpoint/service/command.proto",
}

const (
	CustomEndpointRouteCommandController_Add_FullMethodName    = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointRouteCommandController/add"
	CustomEndpointRouteCommandController_Update_FullMethodName = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointRouteCommandController/update"
	CustomEndpointRouteCommandController_Delete_FullMethodName = "/cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointRouteCommandController/delete"
)
...
var CustomEndpointRouteCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.customendpoint.service.CustomEndpointRouteCommandController",
