...
const (
	ElasticsearchKubernetesQueryController_GetById_FullMethodName     = "/cloud.planton.apis.code2cloud.v1.elasticsearchkubernetes.service.ElasticsearchKubernetesQueryController/getById"
	ElasticsearchKubernetesQueryController_GetPassword_FullMethodName = "/cloud.planton.apis.code2cloud.v1.elasticsearchkubernetes.service.ElasticsearchKubernetesQueryController/getPassword"
)
...
type ElasticsearchKubernetesQueryControllerClient interface {
	...
	GetById(ctx context.Context, in *model.ElasticsearchKubernetesId, opts ...grpc.CallOption) (*model.ElasticsearchKubernetes, error)
...
func (c *elasticsearchKubernetesQueryControllerClient) GetById(ctx context.Context, in *model.ElasticsearchKubernetesId, opts ...grpc.CallOption) (*model.ElasticsearchKubernetes, error) {
	out := new(model.ElasticsearchKubernetes)
	err := c.cc.Invoke(ctx, ElasticsearchKubernetesQueryController_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ElasticsearchKubernetesQueryControllerServer interface {
	// look up elasticsearch-kubernetes using elasticsearch-kubernetes id
	GetById(context.Context, *model.ElasticsearchKubernetesId) (*model.ElasticsearchKubernetes, error)
	// look up elasticsearch-kubernetes sasl password
	// password is retrieved from the kubernetes cluster.
...
func (UnimplementedElasticsearchKubernetesQueryControllerServer) GetById(context.Context, *model.ElasticsearchKubernetesId) (*model.ElasticsearchKubernetes, error) {
...
func _ElasticsearchKubernetesQueryController_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(model.ElasticsearchKubernetesId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ElasticsearchKubernetesQueryControllerServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ElasticsearchKubernetesQueryController_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ElasticsearchKubernetesQueryControllerServer).GetById(ctx, req.(*model.ElasticsearchKubernetesId))
	}
...
var ElasticsearchKubernetesQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.elasticsearchkubernetes.service.ElasticsearchKubernetesQueryController",
	HandlerType: (*ElasticsearchKubernetesQueryControllerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getById",
			Handler:    _ElasticsearchKubernetesQueryController_GetById_Handler,
		},
		{
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/elasticsearchkubernetes/service/query.proto",
}
