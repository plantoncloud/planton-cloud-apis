...
const (
	GcpSecretSetCommandController_PreviewCreate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/previewCreate"
	GcpSecretSetCommandController_Create_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/create"
	GcpSecretSetCommandController_PreviewUpdate_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/previewUpdate"
	GcpSecretSetCommandController_Update_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/update"
	GcpSecretSetCommandController_PreviewDelete_FullMethodName  = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/previewDelete"
	GcpSecretSetCommandController_Delete_FullMethodName         = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/delete"
	GcpSecretSetCommandController_PreviewRestore_FullMethodName = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/previewRestore"
	GcpSecretSetCommandController_Restore_FullMethodName        = "/cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController/restore"
)
...
type GcpSecretSetCommandControllerClient interface {
	...
	PreviewDelete(ctx context.Context, in *model1.ApiResourceDeleteInput, opts ...grpc.CallOption) (*model.GcpSecretSet, error)
	// delete an existing gcp-secret-set
	Delete(ctx context.Context, in *model1.ApiResourceDeleteInput, opts ...grpc.CallOption) (*model.GcpSecretSet, error)
...
func (c *gcpSecretSetCommandControllerClient) PreviewDelete(ctx context.Context, in *model1.ApiResourceDeleteInput, opts ...grpc.CallOption) (*model.GcpSecretSet, error) {
	out := new(model.GcpSecretSet)
...
func (c *gcpSecretSetCommandControllerClient) Delete(ctx context.Context, in *model1.ApiResourceDeleteInput, opts ...grpc.CallOption) (*model.GcpSecretSet, error) {
	out := new(model.GcpSecretSet)
...
type GcpSecretSetCommandControllerServer interface {
	...
	// preview delete an existing gcp-secret-set
	PreviewDelete(context.Context, *model1.ApiResourceDeleteInput) (*model.GcpSecretSet, error)
	// delete an existing gcp-secret-set
	Delete(context.Context, *model1.ApiResourceDeleteInput) (*model.GcpSecretSet, error)
	// preview restore a deleted gcp-secret-set
...
func (UnimplementedGcpSecretSetCommandControllerServer) PreviewDelete(context.Context, *model1.ApiResourceDeleteInput) (*model.GcpSecretSet, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PreviewDelete not implemented")
}
func (UnimplementedGcpSecretSetCommandControllerServer) Delete(context.Context, *model1.ApiResourceDeleteInput) (*model.GcpSecretSet, error) {
...
func _GcpSecretSetCommandController_PreviewDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GcpSecretSetCommandControllerServer).PreviewDelete(ctx, req.(*model1.ApiResourceDeleteInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GcpSecretSetCommandController_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GcpSecretSetCommandControllerServer).Delete(ctx, req.(*model1.ApiResourceDeleteInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GcpSecretSetCommandController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.gcp.gcpsecretset.service.GcpSecretSetCommandController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/gcp/gcpsecretset/service/command.proto",
}
