...
const (
	GkeClusterQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.gcp.gkecluster.service.GkeClusterQueryController/get"
)
...
var GkeClusterQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.gcp.gkecluster.service.GkeClusterQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/gcp/gkecluster/service/query.proto",
}
...
var GkeClusterNodePoolQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.gcp.gkecluster.service.GkeClusterNodePoolQueryController",
...
const (
	GcpQueryController_FindRegions_FullMethodName                 = "/cloud.planton.apis.code2cloud.v1.gcp.gkecluster.service.GcpQueryController/findRegions"
	GcpQueryController_FindZonesByRegionIdentifier_FullMethodName = "/cloud.planton.apis.code2cloud.v1.gcp.gkecluster.service.GcpQueryController/findZonesByRegionIdentifier"
)
...
var GcpQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.gcp.gkecluster.service.GcpQueryController",
