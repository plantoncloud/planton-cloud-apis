...
const (
	S3BucketQueryController_Get_FullMethodName = "/cloud.planton.apis.code2cloud.v1.aws.s3bucket.service.S3BucketQueryController/get"
)
...
var S3BucketQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.code2cloud.v1.aws.s3bucket.service.S3BucketQueryController",
	...
	Metadata: "cloud/planton/apis/code2cloud/v1/aws/s3bucket/service/query.proto",
}
