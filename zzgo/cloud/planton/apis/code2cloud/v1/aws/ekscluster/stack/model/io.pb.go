...
type EksClusterStackResponse struct {
	...
	// stack outputs
	StackOutputs *model1.EksClusterStackOutputs `protobuf:"bytes,2,opt,name=stack_outputs,json=stackOutputs,proto3" json:"stack_outputs,omitempty"`
}
...
func (x *EksClusterStackResponse) GetStackOutputs() *model1.EksClusterStackOutputs {
	if x != nil {
...
var file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_stack_model_io_proto_rawDesc = []byte{
	...
	0x22, 0xfe, 0x01, 0x0a, 0x17, 0x45, 0x6b, 0x73, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53,
	...
	0x45, 0x53, 0x4d, 0xaa, 0x02, 0x3b, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x50, 0x6c, 0x61, 0x6e,
	0x74, 0x6f, 0x6e, 0x2e, 0x41, 0x70, 0x69, 0x73, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x32, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x2e, 0x56, 0x31, 0x2e, 0x41, 0x77, 0x73, 0x2e, 0x45, 0x6b, 0x73, 0x63, 0x6c,
...
var file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_stack_model_io_proto_goTypes = []interface{}{
	...
	(*model1.EksClusterStackOutputs)(nil),  // 6: cloud.planton.apis.code2cloud.v1.aws.ekscluster.model.EksClusterStackOutputs
}
var file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_stack_model_io_proto_depIdxs = []int32{
	...
	6, // 4: cloud.planton.apis.code2cloud.v1.aws.ekscluster.stack.model.EksClusterStackResponse.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.aws.ekscluster.model.EksClusterStackOutputs
