...
type EksClusterStatus struct {
	...
	StackOutputs *EksClusterStackOutputs `protobuf:"bytes,1,opt,name=stack_outputs,json=stackOutputs,proto3" json:"stack_outputs,omitempty"`
}
...
func (x *EksClusterStatus) GetStackOutputs() *EksClusterStackOutputs {
	if x != nil {
...
// eks-cluster stack-outputs
type EksClusterStackOutputs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *EksClusterStackOutputs) Reset() {
	*x = EksClusterStackOutputs{}
	if protoimpl.UnsafeEnabled {
...
func (x *EksClusterStackOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EksClusterStackOutputs) ProtoMessage() {}

func (x *EksClusterStackOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_model_state_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EksClusterStackOutputs.ProtoReflect.Descriptor instead.
func (*EksClusterStackOutputs) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_model_state_proto_rawDescGZIP(), []int{3}
}

func (x *EksClusterStackOutputs) GetClusterVpcId() string {
	if x != nil {
...
func (x *EksClusterStackOutputs) GetClusterEndpoint() string {
	if x != nil {
...
func (x *EksClusterStackOutputs) GetClusterCaData() string {
	if x != nil {
...
var file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_model_state_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x9d, 0x07, 0x0a, 0x0a, 0x45, 0x6b, 0x73, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a, 0x28, 0x88, 0xa6, 0x1d, 0x08, 0x92, 0xa6,
	...
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0xe0, 0x02,
	...
	0x52, 0x0a, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x72, 0x0a, 0x0d,
	...
	0x22, 0x91, 0x01, 0x0a, 0x16, 0x45, 0x6b, 0x73, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53,
	...
	0x44, 0x61, 0x74, 0x61, 0x42, 0xb8, 0x03, 0x0a, 0x43, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62,
...
var file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_model_state_proto_goTypes = []interface{}{
	...
	(*EksClusterStackOutputs)(nil),                         // 3: cloud.planton.apis.code2cloud.v1.aws.ekscluster.model.EksClusterStackOutputs
...
var file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_model_state_proto_depIdxs = []int32{
	...
	3, // 8: cloud.planton.apis.code2cloud.v1.aws.ekscluster.model.EksClusterStatus.stack_outputs:type_name -> cloud.planton.apis.code2cloud.v1.aws.ekscluster.model.EksClusterStackOutputs
...
func file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_model_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cloud_planton_apis_code2cloud_v1_aws_ekscluster_model_state_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EksClusterStackOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
