...
const (
	KubernetesClusterKubernetesObjectQueryController_Get_FullMethodName                     = "/cloud.planton.apis.connect.v1.kubernetesclustercredential.service.KubernetesClusterKubernetesObjectQueryController/get"
	KubernetesClusterKubernetesObjectQueryController_FindNamespaces_FullMethodName          = "/cloud.planton.apis.connect.v1.kubernetesclustercredential.service.KubernetesClusterKubernetesObjectQueryController/findNamespaces"
	KubernetesClusterKubernetesObjectQueryController_StreamKubernetesObjects_FullMethodName = "/cloud.planton.apis.connect.v1.kubernetesclustercredential.service.KubernetesClusterKubernetesObjectQueryController/streamKubernetesObjects"
	KubernetesClusterKubernetesObjectQueryController_FindPods_FullMethodName                = "/cloud.planton.apis.connect.v1.kubernetesclustercredential.service.KubernetesClusterKubernetesObjectQueryController/findPods"
	KubernetesClusterKubernetesObjectQueryController_GetPod_FullMethodName                  = "/cloud.planton.apis.connect.v1.kubernetesclustercredential.service.KubernetesClusterKubernetesObjectQueryController/getPod"
	KubernetesClusterKubernetesObjectQueryController_StreamPodLogs_FullMethodName           = "/cloud.planton.apis.connect.v1.kubernetesclustercredential.service.KubernetesClusterKubernetesObjectQueryController/streamPodLogs"
)
...
var KubernetesClusterKubernetesObjectQueryController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.planton.apis.connect.v1.kubernetesclustercredential.service.KubernetesClusterKubernetesObjectQueryController",
