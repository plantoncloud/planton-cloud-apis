...
type EnvironmentApiResourceNameTestWithOutEnvironmentInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *EnvironmentApiResourceNameTestWithOutEnvironmentInfo) Reset() {
	*x = EnvironmentApiResourceNameTestWithOutEnvironmentInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *EnvironmentApiResourceNameTestWithOutEnvironmentInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnvironmentApiResourceNameTestWithOutEnvironmentInfo) ProtoMessage() {}

func (x *EnvironmentApiResourceNameTestWithOutEnvironmentInfo) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnvironmentApiResourceNameTestWithOutEnvironmentInfo.ProtoReflect.Descriptor instead.
func (*EnvironmentApiResourceNameTestWithOutEnvironmentInfo) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_rawDescGZIP(), []int{7}
}

func (x *EnvironmentApiResourceNameTestWithOutEnvironmentInfo) GetApiVersion() string {
	if x != nil {
		return x.ApiVersion
	}
	return ""
...
func (x *EnvironmentApiResourceNameTestWithOutEnvironmentInfo) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *EnvironmentApiResourceNameTestWithOutEnvironmentInfo) GetMetadata() *model.ApiResourceMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type EnvironmentApiResourceNameTestWithEnvironmentInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Kind       string                                                 `protobuf:"bytes,2,opt,name=kind,proto3" json:"kind,omitempty"`
	Metadata   *model.ApiResourceMetadata                             `protobuf:"bytes,3,opt,name=metadata,proto3" json:"metadata,omitempty"`
	Spec       *EnvironmentApiResourceNameTestWithEnvironmentInfoSpec `protobuf:"bytes,4,opt,name=spec,proto3" json:"spec,omitempty"`
}

func (x *EnvironmentApiResourceNameTestWithEnvironmentInfo) Reset() {
	*x = EnvironmentApiResourceNameTestWithEnvironmentInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *EnvironmentApiResourceNameTestWithEnvironmentInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnvironmentApiResourceNameTestWithEnvironmentInfo) ProtoMessage() {}

func (x *EnvironmentApiResourceNameTestWithEnvironmentInfo) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnvironmentApiResourceNameTestWithEnvironmentInfo.ProtoReflect.Descriptor instead.
func (*EnvironmentApiResourceNameTestWithEnvironmentInfo) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_rawDescGZIP(), []int{8}
}

func (x *EnvironmentApiResourceNameTestWithEnvironmentInfo) GetApiVersion() string {
	if x != nil {
		return x.ApiVersion
	}
	return ""
...
func (x *EnvironmentApiResourceNameTestWithEnvironmentInfo) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *EnvironmentApiResourceNameTestWithEnvironmentInfo) GetMetadata() *model.ApiResourceMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *EnvironmentApiResourceNameTestWithEnvironmentInfo) GetSpec() *EnvironmentApiResourceNameTestWithEnvironmentInfoSpec {
	if x != nil {
		return x.Spec
	}
	return nil
...
type EnvironmentApiResourceNameTestWithEnvironmentInfoSpec struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *EnvironmentApiResourceNameTestWithEnvironmentInfoSpec) Reset() {
	*x = EnvironmentApiResourceNameTestWithEnvironmentInfoSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *EnvironmentApiResourceNameTestWithEnvironmentInfoSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnvironmentApiResourceNameTestWithEnvironmentInfoSpec) ProtoMessage() {}

func (x *EnvironmentApiResourceNameTestWithEnvironmentInfoSpec) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnvironmentApiResourceNameTestWithEnvironmentInfoSpec.ProtoReflect.Descriptor instead.
func (*EnvironmentApiResourceNameTestWithEnvironmentInfoSpec) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_rawDescGZIP(), []int{9}
}

func (x *EnvironmentApiResourceNameTestWithEnvironmentInfoSpec) GetEnvironmentInfo() *model1.ApiResourceEnvironmentInfo {
	if x != nil {
		return x.EnvironmentInfo
	}
	return nil
...
var file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6e, 0x67, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x1b, 0x62, 0x75,
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x40, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x70,
	...
	0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6d, 0x6f,
	0x64, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x43, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0xcf, 0x04, 0x0a,
	...
	0x74, 0x61, 0x42, 0xef, 0x03, 0xba, 0x48, 0xeb, 0x03, 0xba, 0x01, 0x6c, 0x0a, 0x0d, 0x6d, 0x65,
	...
	0x29, 0xc8, 0x01, 0x01, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x69,
	0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x55, 0x2e, 0x63,
	0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x6f, 0x6e, 0x2e, 0x61, 0x70, 0x69,
	0x73, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x54, 0x65, 0x73, 0x74, 0x53,
	...
	0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x54, 0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a, 0x28, 0x88, 0xa6, 0x1d, 0x00,
	...
	0x76, 0x5f, 0x69, 0x64, 0x22, 0xfa, 0x02, 0x0a, 0x1d, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x54, 0x65,
	0x73, 0x74, 0x53, 0x70, 0x65, 0x63, 0x12, 0x7e, 0x0a, 0x10, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f,
	...
	0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x84, 0x01, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x74, 0x61,
	0x69, 0x6e, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5e, 0x2e, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x6f, 0x6e, 0x2e, 0x61, 0x70, 0x69, 0x73, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x2e, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4b,
	...
	0x01, 0x01, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x52, 0x0a,
	0x07, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38,
	...
	0x73, 0x22, 0x82, 0x04, 0x0a, 0x1f, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x54, 0x65, 0x73, 0x74, 0x53,
	...
	,
	...
	0x01, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0xce, 0x01, 0x0a,
	0x09, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x42, 0xb0, 0x01, 0xba, 0x48, 0xa5, 0x01, 0xba, 0x01, 0xa1, 0x01, 0x0a, 0x2c, 0x73, 0x70, 0x65,
	...
	0x7a, 0x65, 0x28, 0x74, 0x68, 0x69, 0x73, 0x29, 0x20, 0x3e, 0x20, 0x30, 0xfa, 0xb8, 0x18, 0x03,
	0x31, 0x47, 0x69, 0x52, 0x08, 0x64, 0x69, 0x73, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xca, 0x01,
	0x0a, 0x34, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x70, 0x69,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x54, 0x65, 0x73, 0x74,
	0x57, 0x69, 0x74, 0x68, 0x4f, 0x75, 0x74, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65,
	0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x70, 0x69, 0x5f, 0x76, 0x65,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x5d, 0x0a, 0x08, 0x6d,
	...
	0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xcb, 0x02, 0x0a, 0x31, 0x45,
	0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x54, 0x65, 0x73, 0x74, 0x57, 0x69, 0x74,
	0x68, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	...
	,
	...
	0x66, 0x6f, 0x42, 0xbc, 0x03, 0x0a, 0x44, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x62, 0x75, 0x66,
	...
	0x69, 0x6e, 0x67, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x0a, 0x4d, 0x6f, 0x64,
	0x65, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x66, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x2f, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0xa2, 0x02, 0x07, 0x43, 0x50, 0x41, 0x43, 0x41, 0x54, 0x4d, 0xaa, 0x02, 0x36, 0x43, 0x6c,
	...
	0x75, 0x72, 0x63, 0x65, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0xca, 0x02, 0x36, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x50, 0x6c, 0x61,
	0x6e, 0x74, 0x6f, 0x6e, 0x5c, 0x41, 0x70, 0x69, 0x73, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x73, 0x5c, 0x41, 0x70, 0x69, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5c, 0x54, 0x65,
	0x73, 0x74, 0x69, 0x6e, 0x67, 0x5c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0xe2, 0x02, 0x42,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5c, 0x54, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x5c, 0x4d,
	...
	0x3a, 0x54, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x3a, 0x3a, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
...
var file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_goTypes = []interface{}{
	...
	(*EnvironmentApiResourceNameTestWithOutEnvironmentInfo)(nil),  // 7: cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithOutEnvironmentInfo
	(*EnvironmentApiResourceNameTestWithEnvironmentInfo)(nil),     // 8: cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithEnvironmentInfo
	(*EnvironmentApiResourceNameTestWithEnvironmentInfoSpec)(nil), // 9: cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithEnvironmentInfoSpec
	(enums.CloudProviderTest)(0),                                  // 10: cloud.planton.apis.commons.apiresource.testing.enums.CloudProviderTest
...
var file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_depIdxs = []int32{
	10, // 0: cloud.planton.apis.commons.apiresource.testing.message.MessageLevelProtoValidateConditionalTest.cloud_provider:type_name -> cloud.planton.apis.commons.apiresource.testing.enums.CloudProviderTest
	...
	11, // 3: cloud.planton.apis.commons.apiresource.testing.message.ApiResourceKubernetesTest.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	...
	12, // 6: cloud.planton.apis.commons.apiresource.testing.message.ApiResourceKubernetesTestSpec.environment_info:type_name -> cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
	...
	13, // 8: cloud.planton.apis.commons.apiresource.testing.message.ApiResourceKubernetesTestSpec.ingress:type_name -> cloud.planton.apis.commons.kubernetes.model.IngressSpec
	14, // 9: cloud.planton.apis.commons.apiresource.testing.message.ApiResourceKubernetesTestStatus.lifecycle:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceLifecycle
	15, // 10: cloud.planton.apis.commons.apiresource.testing.message.ApiResourceKubernetesTestStatus.audit:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceAudit
	16, // 11: cloud.planton.apis.commons.apiresource.testing.message.ApiResourceKubernetesSpecContainerSpec.resources:type_name -> cloud.planton.apis.commons.kubernetes.model.ContainerResources
	11, // 12: cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithOutEnvironmentInfo.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	11, // 13: cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithEnvironmentInfo.metadata:type_name -> cloud.planton.apis.commons.apiresource.model.ApiResourceMetadata
	9,  // 14: cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithEnvironmentInfo.spec:type_name -> cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithEnvironmentInfoSpec
	12, // 15: cloud.planton.apis.commons.apiresource.testing.message.EnvironmentApiResourceNameTestWithEnvironmentInfoSpec.environment_info:type_name -> cloud.planton.apis.resourcemanager.v1.environment.model.ApiResourceEnvironmentInfo
...
func file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnvironmentApiResourceNameTestWithOutEnvironmentInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnvironmentApiResourceNameTestWithEnvironmentInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cloud_planton_apis_commons_apiresource_testing_message_model_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnvironmentApiResourceNameTestWithEnvironmentInfoSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
