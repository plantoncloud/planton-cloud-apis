...
// and planning.
type GetResourceCountByOrgIdInput struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetResourceCountByOrgIdInput) Reset() {
	*x = GetResourceCountByOrgIdInput{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetResourceCountByOrgIdInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetResourceCountByOrgIdInput) ProtoMessage() {}

func (x *GetResourceCountByOrgIdInput) ProtoReflect() protoreflect.Message {
	mi := &file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetResourceCountByOrgIdInput.ProtoReflect.Descriptor instead.
func (*GetResourceCountByOrgIdInput) Descriptor() ([]byte, []int) {
	return file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_rawDescGZIP(), []int{9}
}

func (x *GetResourceCountByOrgIdInput) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
func (x *GetResourceCountByContextInput) GetEnvId() string {
	if x != nil {
		return x.EnvId
	}
	return ""
...
var file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x35, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x79, 0x4f, 0x72, 0x67, 0x49, 0x64,
	0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x6f, 0x72, 0x67, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x72, 0x67, 0x49, 0x64, 0x22, 0x4e, 0x0a, 0x1e,
	0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74,
	0x42, 0x79, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x15,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6e, 0x76, 0x49, 0x64, 0x42, 0xad, 0x03, 0x0a,
	...
	0x6f, 0x64, 0x65, 0x6c, 0xa2, 0x02, 0x07, 0x43, 0x50, 0x41, 0x41, 0x56, 0x41, 0x4d, 0xaa, 0x02,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5c, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0xe2, 0x02, 0x40, 0x43,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5c, 0x4d, 0x6f,
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x3a, 0x3a, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_goTypes = []interface{}{
	...
	(*GetResourceCountByOrgIdInput)(nil),           // 9: cloud.planton.apis.audit.v1.apiresourceversion.model.GetResourceCountByOrgIdInput
...
func file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetResourceCountByOrgIdInput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
