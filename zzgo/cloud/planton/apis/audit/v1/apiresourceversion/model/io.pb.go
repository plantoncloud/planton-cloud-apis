...
var file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0xad, 0x03, 0x0a,
...
var file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_goTypes = []interface{}{
	...
	(*ApiResourceVersion)(nil),                     // 8: cloud.planton.apis.audit.v1.apiresourceversion.model.ApiResourceVersion
}
var file_cloud_planton_apis_audit_v1_apiresourceversion_model_io_proto_depIdxs = []int32{
	6, // 0: cloud.planton.apis.audit.v1.apiresourceversion.model.ListApiResourceVersionsInput.page_info:type_name -> cloud.planton.apis.commons.rpc.PageInfo
	7, // 1: cloud.planton.apis.audit.v1.apiresourceversion.model.ListApiResourceVersionsInput.kind:type_name -> cloud.planton.apis.commons.apiresource.enums.apiresourcekind.ApiResourceKind
	8, // 2: cloud.planton.apis.audit.v1.apiresourceversion.model.ApiResourceVersionList.entries:type_name -> cloud.planton.apis.audit.v1.apiresourceversion.model.ApiResourceVersion
	7, // 3: cloud.planton.apis.audit.v1.apiresourceversion.model.GetApiResourceVersionCountInput.kind:type_name -> cloud.planton.apis.commons.apiresource.enums.apiresourcekind.ApiResourceKind
