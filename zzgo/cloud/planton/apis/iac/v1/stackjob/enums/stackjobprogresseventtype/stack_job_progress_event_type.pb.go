...
const (
	...
	// this event is used to indicate that a specific pulumi operation has been transitioned from one status to another status during the execution of the stack-job.
	// this event is created by planton-cloud's pulumi-stack-job-runner sdk.
	StackJobProgressEventType_pulumi_operation_status_event StackJobProgressEventType = 1
	...
	StackJobProgressEventType_pulumi_engine_event StackJobProgressEventType = 2
	// this event is created by planton-cloud's pulumi-stack-job-runner sdk.
	...
	// this event is created by stack-job listener kafka processor after the completion of the stack-job.
	// this event is used to mark the end of stream in redis.
	// any subscriptions for the stack-job progress stream can use this event to decide to stop reading from the stream.
	StackJobProgressEventType_stack_job_completed_event StackJobProgressEventType = 5
)
...
var (
	StackJobProgressEventType_name = map[int32]string{
		...
		1: "pulumi_operation_status_event",
		2: "pulumi_engine_event",
		4: "stack_job_outputs_event",
		5: "stack_job_completed_event",
	}
	StackJobProgressEventType_value = map[string]int32{
		"STACK_JOB_PROGRESS_EVENT_TYPE_UNSPECIFIED": 0,
		"pulumi_operation_status_event":             1,
		"pulumi_engine_event":                       2,
		"stack_job_outputs_event":                   4,
		"stack_job_completed_event":                 5,
	}
)
...
var file_cloud_planton_apis_iac_v1_stackjob_enums_stackjobprogresseventtype_stack_job_progress_event_type_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x74, 0x79, 0x70, 0x65, 0x2a, 0xc2, 0x01, 0x0a,
	...
	,
	...
	0x6e, 0x74, 0x74, 0x79, 0x70, 0x65, 0x42, 0x1e, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62,
	...
	0x65, 0x73, 0x73, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x74, 0x79, 0x70, 0x65, 0xa2, 0x02, 0x08, 0x43,
	0x50, 0x41, 0x49, 0x56, 0x53, 0x45, 0x53, 0xaa, 0x02, 0x42, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x2e,
	...
	0x6d, 0x73, 0x2e, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x6a, 0x6f, 0x62, 0x70, 0x72, 0x6f, 0x67, 0x72,
	0x65, 0x73, 0x73, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x74, 0x79, 0x70, 0x65, 0xca, 0x02, 0x42, 0x43,
	...
	0x65, 0xe2, 0x02, 0x4e, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x5c, 0x50, 0x6c, 0x61, 0x6e, 0x74, 0x6f,
	...
	0x56, 0x31, 0x3a, 0x3a, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x6a, 0x6f, 0x62, 0x3a, 0x3a, 0x45, 0x6e,
	0x75, 0x6d, 0x73, 0x3a, 0x3a, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x6a, 0x6f, 0x62, 0x70, 0x72, 0x6f,
	0x67, 0x72, 0x65, 0x73, 0x73, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x74, 0x79, 0x70, 0x65, 0x62, 0x06,
